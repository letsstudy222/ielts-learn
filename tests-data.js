// =================== TESTS DATA ===================
// Mỗi test = 3 Reading Passages + 40 câu hỏi (chuẩn Cambridge IELTS Academic Reading)
// Passage tăng dần độ khó (P1 dễ → P3 khó); ~700-900 từ/passage
...
const TESTS_DATA = {
    ...
    passages: [
      {
        ...
        title: 'The Story of Glass',
        content: `<p><span class="para-num">A</span> Glass is one of the most fascinating substances ever created by human hands. Its origins can be traced back over 4,000 years to ancient Mesopotamia and Egypt, where craftsmen first discovered that sand, when heated to extreme temperatures, could be transformed into a <span class="vocab" data-word="transparent" data-def="trong suốt">transparent</span> material with extraordinary properties. However, the earliest natural form of glass — obsidian — had already been used by prehistoric peoples for over 100,000 years. Formed when volcanic lava cooled rapidly, obsidian was prized for its exceptionally sharp edges and was crafted into implements for hunting and cutting long before anyone learned to make glass deliberately.</p>

        <p><span class="para-num">B</span> The deliberate manufacture of glass began with small decorative objects. Early Egyptian glassmakers produced beads and <span class="vocab" data-word="amulets" data-def="bùa hộ mệnh">amulets</span> by wrapping molten glass around clay cores, which were later removed to leave hollow vessels. This labour-intensive method limited production to elite households and religious purposes for many centuries. It was not until the first century BCE that a revolutionary innovation transformed the craft: the invention of glassblowing in the Syro-Palestinian region. By inserting a hollow iron tube into molten glass and blowing through it, <span class="vocab" data-word="artisans" data-def="thợ thủ công lành nghề">artisans</span> could produce vessels far more quickly, and in a far greater variety of shapes, than had ever before been possible.</p>

        <p><span class="para-num">C</span> The Romans embraced glassblowing with remarkable enthusiasm, and within decades glass production had spread across the entire empire. Roman glass became so common that even modest households possessed drinking cups, bottles, and window panes — items that had previously been luxuries reserved for the wealthy. Archaeological evidence suggests that by the second century CE, glass factories operated from Britain to the Middle East, producing <span class="vocab" data-word="standardised" data-def="được tiêu chuẩn hóa">standardised</span> products for long-distance trade. Roman engineers also pioneered the use of glass in architecture, installing windows in public baths and wealthy villas, though these early windows were typically small, thick, and irregular by modern standards.</p>

        <p><span class="para-num">D</span> After the fall of the Roman Empire, glassmaking knowledge was preserved primarily in the Byzantine Empire and the Islamic world. Venetian craftsmen, who learned from Byzantine sources, eventually established a glass industry on the island of Murano in 1291 — a deliberate relocation designed to prevent fires in Venice itself and to protect valuable trade secrets. For centuries, Murano glass dominated European markets, and revealing the techniques to outsiders was punishable by death. Despite such drastic measures, knowledge gradually leaked to other European centres, particularly Bohemia and England.</p>

        <p><span class="para-num">E</span> In Britain, the modern glass industry only truly emerged after the <span class="vocab" data-word="repeal" data-def="sự bãi bỏ (luật)">repeal</span> of the Excise Act in 1845. From 1745 onwards, heavy taxes had been imposed on the weight of glass produced, severely restricting innovation and forcing manufacturers to favour thin, lightweight designs. Once these taxes were finally lifted, British glassmakers rapidly developed new techniques, and the Crystal Palace, built for the Great Exhibition of 1851, became a stunning symbol of glass's architectural potential, using nearly 300,000 panes in a single vast structure.</p>
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> When archaeologists examine ice cores drilled from <span class="vocab" data-word="glaciers" data-def="sông băng">glaciers</span> in Greenland and the Arctic, they can read a remarkable record of human industrial activity stretching back thousands of years. Trapped within the layers of ancient ice are tiny amounts of metals and other <span class="vocab" data-word="pollutants" data-def="chất ô nhiễm">pollutants</span> that drifted through the atmosphere in distant times and settled onto the ice. Lead, in particular, leaves a distinctive chemical signature that has allowed scientists to reconstruct the rise and fall of ancient mining industries in ways that no written record could ever provide.</p>

        <p><span class="para-num">B</span> The Roman Empire was responsible for one of the most intensive periods of lead production in pre-industrial history. Lead was essential to Roman civilisation in ways that modern readers may find surprising. The empire's famous water systems depended on lead pipes — the Latin word "plumbum", meaning lead, gives us the modern word "plumbing". Lead was also used extensively in roofing, cooking vessels, cosmetics, and even as a sweetener in wine, where lead <span class="vocab" data-word="acetate" data-def="axetat (muối/este của axit axetic)">acetate</span> produced a pleasant flavour. The empire's enormous appetite for lead drove mining operations across Britain, Spain, and the Balkans.</p>

        <p><span class="para-num">C</span> Ice core analysis has revealed striking patterns in Roman lead production. From about 250 BCE through the second century CE, lead concentrations in the atmospheric record rose steadily, eventually reaching levels that would not be matched again until the Industrial Revolution nearly two thousand years later. The peak corresponded almost exactly with the period of maximum Roman territorial extent and economic activity. Then, beginning around 165 CE, lead concentrations began a <span class="vocab" data-word="precipitous" data-def="dốc đứng, đột ngột">precipitous</span> decline that the ice has preserved in remarkable detail.</p>

        <p><span class="para-num">D</span> The cause of this decline has been a subject of intense scholarly debate. Some researchers have linked it to the Antonine Plague, a devastating epidemic that struck the empire in 165 CE and killed between 5 and 10 percent of the population. Others have pointed to political instability, with frequent civil wars disrupting mining operations and trade networks. A third explanation focuses on the <span class="vocab" data-word="exhaustion" data-def="sự cạn kiệt">exhaustion</span> of accessible ore deposits — the easily mined surface deposits had been worked for centuries by the height of Roman activity, and reaching deeper deposits would have required investment that the unstable political conditions made impossible.</p>

        <p><span class="para-num">E</span> Recent archaeological work has added important detail to this picture. Studies of abandoned Roman mining sites in Britain and Spain reveal complex underground workings, evidence of sophisticated water-management systems for draining mines, and the ruined housing for what must have been substantial workforces. The scale of these operations demonstrates that Roman lead production was not just casual extraction but a major industrial undertaking. When this infrastructure was abandoned in the third century, the techniques and organisational knowledge required to operate at such a scale were largely lost.</p>

        <p><span class="para-num">F</span> The consequences of declining lead production extended well beyond economics. Roman public health, while terrible by modern standards, depended heavily on the urban water systems that the lead industry had made possible. As maintenance of these systems lapsed and supplies of new pipes became unavailable, urban water quality deteriorated. Some historians believe this contributed to the gradual depopulation of Roman cities during late <span class="vocab" data-word="antiquity" data-def="thời cổ đại">antiquity</span>, as urban environments became less healthy and rural alternatives correspondingly more attractive.</p>

        <p><span class="para-num">G</span> The recovery of large-scale lead production took far longer than might be expected. Significant new mining operations did not develop until well into the medieval period, and lead production levels comparable to those of the Roman peak were not reached again in Europe until the seventeenth century. The ice core records show clearly the long industrial decline of medieval Europe, followed by the gradual recovery of mining activity in the early modern period and the dramatic expansion of the Industrial Revolution. Ancient lead, captured in ice, has thus become one of our most precise records of the rhythms of human civilisation.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Of all the senses, smell is perhaps the most poorly understood. While vision and hearing have been studied intensively for centuries, leading to detailed models of how these senses work, the sense of smell — formally known as <span class="vocab" data-word="olfaction" data-def="khứu giác">olfaction</span> — has long resisted scientific explanation. Even today, despite considerable progress, basic questions about how smell works remain contested. Why are some odours pleasant and others <span class="vocab" data-word="repulsive" data-def="gây ghê tởm, khó chịu">repulsive</span>? How can humans distinguish among thousands of different scents? And why do smells trigger such intense emotional and memory responses, often without any conscious effort?</p>

        <p><span class="para-num">B</span> The biological mechanism of smell begins when odour molecules — typically small, light molecules called volatiles — enter the nose through breathing or sniffing. These molecules bind to <span class="vocab" data-word="receptors" data-def="thụ thể">receptors</span> on specialised cells in a small region of tissue called the olfactory epithelium, located high in the nasal cavity. Signals from these receptors travel directly to the olfactory bulb of the brain, which connects to areas involved in emotion and memory more directly than any other sensory system. This direct neural pathway explains the remarkable ability of smells to evoke powerful memories and feelings — sometimes called the Proust effect, after the French novelist who described how a single smell from his childhood could trigger detailed memories from decades earlier.</p>

        <p><span class="para-num">C</span> For most of the twentieth century, scientists believed that humans possessed relatively few types of smell receptor, perhaps a few hundred at most. This view was decisively challenged in 1991 by the American researchers Linda Buck and Richard Axel, who discovered that mammals actually have hundreds of different receptor types. The human genome contains approximately 400 functional olfactory receptor genes, although humans have lost many that remain functional in other mammals — domestic dogs, for example, have nearly twice as many functional receptors as we do. Buck and Axel's discovery, which won them the Nobel Prize in 2004, opened up the modern era of smell research.</p>

        <p><span class="para-num">D</span> The <span class="vocab" data-word="combinatorial" data-def="thuộc tổ hợp">combinatorial</span> nature of smell explains how a relatively small number of receptors can distinguish such a vast array of scents. Each individual odour activates a unique combination of receptors rather than any single type. Much as the 26 letters of the alphabet can combine to produce countless different words, hundreds of olfactory receptors can combine to encode an essentially unlimited variety of smells. Some researchers estimate that humans may be able to distinguish over a trillion different odours, although this striking number remains controversial and certainly varies dramatically between individuals.</p>

        <p><span class="para-num">E</span> Individual differences in smell <span class="vocab" data-word="perception" data-def="sự cảm nhận, tri giác">perception</span> are remarkably large. About 1 percent of people experience anosmia — a complete inability to smell — either from birth or following injury or illness. Many more people experience reduced sensitivity to specific smells without even realising it; about 50 percent of people, for example, cannot detect the distinctive musky odour of androstenone, while others find the very same smell overwhelming. Genetic studies have identified specific variations in receptor genes that cause these differences. Two people may genuinely live in different sensory worlds when it comes to smell.</p>

        <p><span class="para-num">F</span> The cultural and emotional dimensions of smell are equally fascinating. Different cultures find different odours appealing, and what registers as pleasant in one society may be experienced as offensive in another. Body odours that some Western cultures view as unacceptable are tolerated or even valued elsewhere. Food preferences depend heavily on smell, and people often dislike unfamiliar cuisines initially because of unfamiliar scents rather than tastes. These cultural variations interact with biological differences to produce the rich variation in smell experience seen between individuals and communities.</p>

        <p><span class="para-num">G</span> The consequences of smell loss extend far beyond simple inconvenience. People who lose their sense of smell — most dramatically demonstrated by the millions affected by COVID-19 — often report significant decreases in their quality of life. Eating becomes joyless, as much of what we experience as taste actually depends on smell. The detection of warning signals like smoke, spoiled food, or gas leaks becomes impossible. Emotional connections to memories and people can become <span class="vocab" data-word="diminished" data-def="giảm sút, suy giảm">diminished</span>. Despite these substantial impacts, anosmia still receives far less medical attention and research funding than vision and hearing loss. The remarkable progress in olfactory science over the past three decades may eventually change this neglect, but for now smell remains the forgotten sense.</p>`,
      ...
      [
        {
          ...
          instruction: 'Reading Passage 3 has seven paragraphs, A-G. Which paragraph contains the following information? NB You may use any letter more than once.',
    ...
    passages: [
      {
        ...
        content: `<p><span class="para-num">A</span> When we consider intelligent animals, we typically think of mammals — chimpanzees, dolphins, elephants — creatures whose evolutionary history is closely intertwined with our own. Yet some of the most remarkable minds on Earth belong to creatures separated from humans by over 600 million years of evolution: octopuses. These eight-armed <span class="vocab" data-word="cephalopods" data-def="động vật chân đầu (mực, bạch tuộc)">cephalopods</span>, along with their cousins the cuttlefish and squid, have developed sophisticated cognitive abilities through a path entirely independent of the vertebrate line that produced human intelligence.</p>

        <p><span class="para-num">B</span> The octopus nervous system is unlike anything else in the animal kingdom. While humans concentrate their <span class="vocab" data-word="neurons" data-def="tế bào thần kinh">neurons</span> in a single centralised brain, an octopus distributes roughly two-thirds of its 500 million neurons throughout its eight arms. Each arm contains its own neural cluster capable of processing information and initiating movement without direct instructions from the central brain. This means that an octopus arm can, in a meaningful sense, "think" for itself. Researchers have observed severed octopus arms continuing to react to stimuli for hours after separation — recoiling from harmful substances and reaching toward food.</p>

        <p><span class="para-num">C</span> This distributed intelligence creates remarkable capabilities. An octopus can simultaneously open a jar with one arm, hunt prey with another, and explore its environment with the remaining six — all without any obvious conscious coordination. Dr Jennifer Mather, a leading researcher in cephalopod behaviour, compares the experience to having eight semi-independent assistants, each handling its own tasks while sharing information with a central coordinator. Exactly how an octopus integrates this <span class="vocab" data-word="dispersed" data-def="phân tán">dispersed</span> activity into unified behaviour remains one of neuroscience's most intriguing puzzles.</p>

        <p><span class="para-num">D</span> Octopuses demonstrate problem-solving abilities that rival those of many vertebrates. In laboratory experiments, they have learned to navigate mazes, open childproof medicine bottles, and even distinguish between individual human caretakers — sometimes squirting water at researchers they apparently dislike. One famous octopus at the Seattle Aquarium, named Otto, repeatedly extinguished the lights by squirting water at them after closing time, prompting staff to disconnect the tank's electrical system at night. Such behaviour suggests not just learning but a degree of mischief and individual personality previously thought impossible in <span class="vocab" data-word="invertebrates" data-def="động vật không xương sống">invertebrates</span>.</p>

        <p><span class="para-num">E</span> Perhaps the most astonishing cognitive feat displayed by octopuses involves <span class="vocab" data-word="camouflage" data-def="sự ngụy trang">camouflage</span>. Despite being colourblind, octopuses can match the colours, patterns, and even textures of their surroundings with extraordinary precision. They achieve this through millions of specialised skin cells called chromatophores, controlled directly by the nervous system rather than through any central decision. Recent research suggests that octopus skin itself may contain light-sensitive proteins, effectively allowing the animal to "see" with its entire body. This would help explain how a colourblind creature can produce such accurate colour matches.</p>

        <p><span class="para-num">F</span> Despite these remarkable abilities, octopus intelligence presents a profound puzzle: octopuses live extraordinarily short lives. Most species survive only one to two years, with females typically dying shortly after their eggs hatch. This <span class="vocab" data-word="brevity" data-def="sự ngắn ngủi">brevity</span> is particularly strange given that intelligence in vertebrates usually correlates with long lifespans, allowing time to learn from experience and to pass knowledge on to offspring. Octopuses, by contrast, are largely solitary and receive no parental teaching whatsoever. Each generation must rediscover the world entirely independently, raising fundamental questions about why such sophisticated cognition evolved at all.</p>

        <p><span class="para-num">G</span> Some researchers suggest that octopus intelligence may have evolved primarily for hunting and predator avoidance rather than for social interaction — the driver behind much vertebrate intelligence. Whatever its true origins, the octopus mind represents a fundamentally different way of being intelligent, one that challenges our human-centred assumptions about what cognition must look like. As the philosopher Peter Godfrey-Smith has written, encountering an octopus may be the closest we will ever come to meeting an intelligent alien — a creature whose mind evolved on a parallel but utterly distinct path from our own.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Few aspects of human interaction have received more practical attention than the art of negotiation. From international <span class="vocab" data-word="diplomacy" data-def="ngoại giao">diplomacy</span> to commercial dealmaking to ordinary domestic compromises, the ability to reach mutually acceptable agreements with others is among the most valuable skills a person can possess. Yet research in psychology and economics over the past several decades has revealed that human negotiation involves systematic patterns and biases that are often entirely invisible to the participants themselves — patterns that can be exploited by skilled negotiators or guarded against through careful preparation.</p>

        <p><span class="para-num">B</span> One of the most well-documented findings concerns what researchers call the anchoring effect. The first number mentioned in a negotiation tends to exert a powerful gravitational pull on the final outcome, regardless of whether that initial figure has any rational basis at all. In controlled experiments, even obviously arbitrary numbers — such as the last two digits of a participant's social security number — can influence their subsequent estimates of values or prices. Skilled negotiators understand this effect and use it deliberately, opening with ambitious initial positions that anchor the entire subsequent discussion in their favour.</p>

        <p><span class="para-num">C</span> A second crucial pattern involves what psychologists call loss aversion. People consistently react more strongly to losing something than to gaining something of equivalent value. This <span class="vocab" data-word="asymmetry" data-def="sự bất đối xứng">asymmetry</span> has profound implications for negotiation. Framing the very same outcome as either a gain or a loss can produce dramatically different responses. A negotiator who emphasises what the other party stands to lose by failing to agree will often achieve better results than one who emphasises what could be gained by agreeing — even when the two descriptions refer to exactly the same deal.</p>

        <p><span class="para-num">D</span> The classical economic view of negotiation assumed that participants were rational actors who would coolly calculate their own interests and propose mutually beneficial agreements. Behavioural economics has thoroughly demolished this comfortable picture. Real negotiators are influenced by emotions, social pressures, perceptions of fairness, and various <span class="vocab" data-word="cognitive" data-def="thuộc nhận thức">cognitive</span> biases that they may not even recognise in themselves. The ultimatum game, one of the most famous experiments in behavioural economics, demonstrates how powerfully these factors operate. In this game, one player proposes how to divide a sum of money with a second player, who can either accept the proposal or reject it, in which case neither player receives anything. Rational players should accept any non-zero offer, yet real people consistently reject offers they perceive as unfair, even at considerable cost to themselves.</p>

        <p><span class="para-num">E</span> Cultural differences in negotiation behaviour are substantial and often badly underappreciated. Research comparing American and Chinese negotiation styles has shown that Americans typically focus on the immediate <span class="vocab" data-word="transactional" data-def="thuộc giao dịch">transactional</span> details, while Chinese negotiators often place greater emphasis on building long-term relationships before discussing specifics. Japanese negotiators frequently use silence in ways that Western participants find distinctly uncomfortable, while many Middle Eastern traditions expect extensive preliminary courtesies that Western negotiators may impatiently regard as inefficient. Effective international negotiation requires real sensitivity to these variations, rather than assuming that techniques effective in one cultural context will automatically work in another.</p>

        <p><span class="para-num">F</span> Modern research has identified several principles that consistently improve negotiation outcomes. Preparation matters enormously: negotiators who research their counterparts, understand their own alternatives if no agreement is reached, and set clear goals before they begin consistently outperform those who simply improvise. Active listening is another powerful tool, with the most skilled negotiators often spending more time understanding the other party's interests than presenting their own positions. The willingness to ask probing, open questions, rather than making aggressive demands, frequently produces better outcomes than a purely competitive approach.</p>

        <p><span class="para-num">G</span> Technology is changing negotiation in interesting and sometimes unsettling ways. Online platforms enable negotiations between parties who never meet face to face, potentially reducing the influence of personal <span class="vocab" data-word="charisma" data-def="sức hút cá nhân">charisma</span> and physical presence but also limiting the social information that helps build trust. Artificial intelligence systems are increasingly able to negotiate on behalf of humans, raising both practical and ethical questions. Some researchers suggest that AI negotiators may eventually become superior to human ones in many contexts, particularly where emotional reactions might lead humans to make <span class="vocab" data-word="suboptimal" data-def="dưới mức tối ưu">suboptimal</span> decisions. Whether this prospect represents progress or loss depends partly on what we value about negotiation beyond its purely economic outcomes.</p>`,
    ...
    passages: [
      {
        ...
        content: `<p><span class="para-num">A</span> Bees pollinate approximately one-third of the food we eat. From apples and almonds to coffee and cocoa, our breakfast tables would look dramatically different without these tiny workers, and many of the foods we take for granted would become rare luxuries. Globally, the economic value of <span class="vocab" data-word="pollination" data-def="sự thụ phấn">pollination</span> services provided by bees is estimated at over 200 billion dollars annually. Yet in recent decades, bee populations have been declining at alarming rates across North America, Europe, and parts of Asia, prompting urgent scientific investigation into the causes — and growing public concern about what their loss might mean for global food security.</p>

        <p><span class="para-num">B</span> The phenomenon known as Colony Collapse Disorder (CCD) first attracted widespread attention in 2006, when beekeepers in the United States reported losing 30 to 90 percent of their hives in a single winter. The hallmark of CCD is mysterious: worker bees simply vanish, leaving behind the queen, immature bees, and ample food stores. Unlike other forms of hive death, dead bodies are rarely found near the colony, as though the workers had flown off and never returned. This sudden disappearance puzzled scientists for years, and although CCD reports have decreased since around 2010, overall bee declines have continued, suggesting that the underlying problems were never fully resolved.</p>

        <p><span class="para-num">C</span> Researchers now believe that no single cause explains the crisis; instead, multiple stressors interact in complex ways that are difficult to disentangle. Among the most heavily investigated factors are <span class="vocab" data-word="neonicotinoids" data-def="thuốc trừ sâu neonicotinoid">neonicotinoids</span>, a class of pesticides introduced in the 1990s that became one of the most widely used groups of insecticides in the world. These chemicals are absorbed into the tissues of treated plants, including their pollen and nectar, exposing bees that visit the flowers. Studies have shown that even at sub-lethal doses — levels too low to kill the bees outright — neonicotinoids impair bees' ability to navigate, learn, and reproduce, weakening colonies in ways that may not be immediately obvious.</p>

        <p><span class="para-num">D</span> A second major factor is the <span class="vocab" data-word="parasitic" data-def="ký sinh">parasitic</span> mite Varroa destructor. Originally a parasite of Asian honeybees, which have evolved defences against it over a long period of coexistence, Varroa jumped to European honeybees in the mid-twentieth century and has since spread worldwide. The mite attaches to bees and feeds on their fat reserves, weakening individuals and transmitting devastating viruses from bee to bee. Beekeepers describe Varroa as the single most damaging pest in modern apiculture, requiring constant and often expensive management simply to keep colonies alive through the year.</p>

        <p><span class="para-num">E</span> Habitat loss compounds these threats. Modern agriculture often features vast <span class="vocab" data-word="monocultures" data-def="canh tác độc canh (một loại cây)">monocultures</span> — single crops grown over enormous areas — which provide bees with abundant food during a brief bloom but leave them starving for the rest of the year. Wildflower meadows, hedgerows, and other diverse habitats that once supplied a steady succession of flowers have <span class="vocab" data-word="dwindled" data-def="suy giảm, thu hẹp">dwindled</span> dramatically in industrialised countries. In the United Kingdom alone, an estimated 97 percent of flower-rich grasslands have disappeared since the 1930s, removing the varied forage that pollinators need across the whole season.</p>

        <p><span class="para-num">F</span> Climate change adds yet another layer of complexity. As temperatures shift, the <span class="vocab" data-word="synchronisation" data-def="sự đồng bộ">synchronisation</span> between bees and the flowers they pollinate can break down. Some flowers now bloom earlier than the bees that traditionally pollinated them emerge, leaving both partners without their usual resources at the critical moment. Extreme weather events, including unseasonal frosts and prolonged droughts, also damage bee populations directly. Researchers in the Rocky Mountains have documented declining bumblebee numbers correlating with rising summer temperatures, a worrying sign that warming may be squeezing some species out of their traditional ranges.</p>

        <p><span class="para-num">G</span> Solutions are being pursued on multiple fronts. The European Union banned outdoor use of three major neonicotinoids in 2018, and similar restrictions are being considered elsewhere. Urban beekeeping has grown in popularity, and cities such as Oslo have created "bee highways" — corridors of flower-rich plantings designed to support pollinators as they move across the urban landscape. Farmers are being encouraged to plant pollinator-friendly hedgerows and to reduce pesticide use, while individual gardeners can contribute by choosing native flowering plants and avoiding chemical sprays. The fate of bees, ultimately, is tied to choices made at every scale, from international policy to the backyard garden.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> On the remote island of Malekula in the South Pacific nation of Vanuatu, an extraordinary art form survives that has fascinated anthropologists for over a century. The sand drawings of Vanuatu — <span class="vocab" data-word="geometrical" data-def="thuộc hình học">geometrical</span> designs traced rapidly in sand or ash with a single continuous finger movement — combine artistic beauty, mathematical sophistication, and cultural knowledge in a way that has few parallels anywhere else in the world. In 2003, UNESCO recognised these drawings as part of humanity's intangible cultural heritage, acknowledging their unique value at a time when the tradition itself faced increasing threats from social and economic change.</p>

        <p><span class="para-num">B</span> The technical achievement of the drawings becomes apparent when one watches a master practitioner at work. The artist begins by drawing a network of guidelines in the sand — perhaps a simple grid of intersecting lines to mark out the space. Then, without lifting the finger from the sand, they trace an <span class="vocab" data-word="intricate" data-def="phức tạp, tinh xảo">intricate</span> design that crosses and recrosses itself many times, eventually returning precisely to the starting point. The final pattern can include hundreds of intersections and yet maintain perfect mathematical regularity. Some designs require the finger to trace continuously for nearly a minute without pause, demanding both memory and manual control of a high order.</p>

        <p><span class="para-num">C</span> Each sand drawing is associated with specific cultural meanings. Designs may represent particular places, mythical stories, <span class="vocab" data-word="kinship" data-def="quan hệ họ hàng, thân tộc">kinship</span> relationships, or ceremonial occasions. The complete tradition encompasses several hundred different drawings, with experts able to perform them in specific narrative sequences that tell stories or convey teachings. The drawings function not just as art but as a kind of writing system — a visual library of cultural knowledge passed from generation to generation. Different designs are appropriate for different audiences and contexts; some are restricted to particular initiates and are not shown to outsiders at all.</p>

        <p><span class="para-num">D</span> Mathematicians have studied the sand drawings with considerable interest. The designs reveal a sophisticated understanding of what mathematicians call Eulerian graphs — networks that can be <span class="vocab" data-word="traversed" data-def="đi qua, vượt qua">traversed</span> completely without lifting the pen or retracing any edge. While European mathematicians did not formalise the theory of such paths until the eighteenth century, the people of Vanuatu had been producing complex examples of them for centuries. The drawings also demonstrate an intuitive grasp of geometric <span class="vocab" data-word="symmetries" data-def="các tính đối xứng">symmetries</span>, topological properties, and visual rhythm that scholars are only beginning to analyse fully.</p>

        <p><span class="para-num">E</span> The first systematic documentation of the sand drawings was conducted by the British anthropologist John Layard in the 1910s, who recorded hundreds of designs and analysed their cultural functions. Later researchers, including the French <span class="vocab" data-word="ethnographer" data-def="nhà dân tộc học">ethnographer</span> Jean Guiart in the 1950s, added substantially to this record. Their work preserved knowledge that might otherwise have been lost as colonial influences disrupted traditional ways of life. Today, the original recordings made by these researchers remain crucial sources for cultural revival efforts, providing a reference against which present-day practitioners can check their knowledge.</p>

        <p><span class="para-num">F</span> Despite UNESCO recognition, the sand drawing tradition faces serious threats. Few young people are learning the more complex designs, and the elderly masters who possess complete knowledge of the tradition are gradually disappearing. Modern educational systems and economic pressures pull young Vanuatu people toward different priorities, often far from their villages. Television, the internet, and mobile phones provide entertainment that once would have come from cultural traditions, including sand drawing performances. Without active intervention, the complete loss of the tradition within a generation seems entirely plausible.</p>

        <p><span class="para-num">G</span> Various initiatives now aim to preserve and revive sand drawing knowledge. Workshops in schools teach children basic designs, with elders demonstrating techniques and explaining cultural meanings. Cultural festivals provide opportunities for masters to perform publicly and pass on their knowledge to wider audiences. Digital recordings document complete performances for permanent preservation, though there is some debate about whether such recordings risk reducing living traditions to museum artefacts. The future of Vanuatu sand drawings, like that of many traditional knowledge systems, depends on whether modern societies can value such heritage enough to maintain it as a living practice rather than a historical curiosity.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Few topics receive more attention in modern professional life than productivity. Bookstores devote entire sections to productivity self-help; software companies build products promising to <span class="vocab" data-word="optimise" data-def="tối ưu hóa">optimise</span> work output; consulting firms develop methodologies they sell to organisations seeking efficiency improvements. Beneath this enormous industry lies a fundamental question that has occupied philosophers since antiquity: what does it mean to use time well? Modern psychology has approached this question scientifically, producing findings that often contradict the popular productivity advice sold so profitably.</p>

        <p><span class="para-num">B</span> The most persistent myth about productivity concerns multitasking — the practice of doing several things <span class="vocab" data-word="simultaneously" data-def="đồng thời, cùng lúc">simultaneously</span>. Many productivity systems promise to help workers handle more tasks at once, and most modern workers spend significant portions of their day juggling multiple responsibilities. Yet psychological research has consistently demonstrated that what people call multitasking is actually rapid task-switching, with significant cognitive costs incurred each time attention moves from one activity to another. Studies measuring brain activity show that the brain cannot truly process multiple complex tasks simultaneously; it can only alternate between them, with reduced quality on each.</p>

        <p><span class="para-num">C</span> Researchers have found that the costs of task-switching are far higher than most workers realise. Each switch typically requires about twenty minutes for the mind to refocus completely on the new task. When workers frequently switch between activities, they may spend most of their day in a state of partial attention to everything and full attention to nothing. Studies of workers with high email loads have found that those who check email constantly may produce roughly 40 percent less work than those who limit email checks to a few times per day. The myth of multitasking productivity, in other words, may be actively undermining the very productivity it promises.</p>

        <p><span class="para-num">D</span> Another well-established finding concerns the relationship between hours worked and productive output. The intuitive assumption — that more hours produce more work — proves incorrect beyond a certain <span class="vocab" data-word="threshold" data-def="ngưỡng, mức giới hạn">threshold</span>. Research consistently shows that productivity per hour declines significantly after about 50 hours of work per week, and total weekly output may actually decrease as hours increase beyond about 55. The exhausted worker not only produces less but also produces work of lower quality and creates errors that later require correction. <span class="vocab" data-word="counterintuitively" data-def="trái với trực giác">Counterintuitively</span>, organisations that have experimented with shorter working weeks — particularly the four-day week — have often found that productivity remained stable or even increased.</p>
        ...
        <p><span class="para-num">F</span> Sleep, often viewed as an unproductive activity that merely takes time away from work, turns out to be one of the most important contributors to productive work. Studies of sleep-deprived workers consistently show declining performance on cognitive tasks, decision-making, and creative work. The Harvard Business Review has estimated that sleep <span class="vocab" data-word="deprivation" data-def="sự thiếu hụt, tước đoạt">deprivation</span> costs the American economy roughly 411 billion dollars annually through reduced productivity and increased errors. Workers who consistently sleep less than six hours per night perform similarly to those legally too drunk to drive on tests of cognitive function — yet many workplaces continue to treat extensive sleep deprivation as a badge of dedication.</p>

        <p><span class="para-num">G</span> The implications of productivity research for individuals and organisations are clear, even if rarely fully implemented. Workers and managers should focus on the quality of attention rather than the quantity of hours, protect time for deep focused work, build genuine rest into the workday, and prioritise sleep over additional working hours. Yet these recommendations contradict workplace cultures that celebrate long hours and constant availability. The gap between what the research shows and how most workplaces actually operate may represent the largest single opportunity for improving productivity in modern economies — but closing this gap requires changes in workplace <span class="vocab" data-word="norms" data-def="chuẩn mực, quy chuẩn">norms</span> that have proven remarkably resistant.</p>`,
    ...
    passages: [
      {
        ...
        content: `<p><span class="para-num">A</span> The relationship between technology and employment has long fascinated economists. From the steam engines that <span class="vocab" data-word="displaced" data-def="thay thế, đẩy ra khỏi vị trí">displaced</span> agricultural labourers in the eighteenth century to the assembly lines that transformed manufacturing, each wave of innovation has brought both anxiety about job loss and, eventually, new types of employment that nobody had anticipated. Today, advances in artificial intelligence and robotics are sparking similar debates with renewed <span class="vocab" data-word="intensity" data-def="cường độ, sự dữ dội">intensity</span>, as machines begin to perform tasks once thought to require uniquely human judgment. The question is no longer whether technology will reshape work, but how quickly and how profoundly — and whether this time the historical pattern of eventual recovery will hold.</p>

        <p><span class="para-num">B</span> A landmark 2013 study by economists at Oxford University estimated that 47 percent of American jobs were at high risk of automation within twenty years. The findings sent shockwaves through policy circles and ignited public debate about a future of widespread unemployment. However, more recent analyses have challenged these estimates as overly pessimistic. The OECD, for instance, has suggested that only about 14 percent of jobs are at high risk of full automation, though many more will see significant changes in their day-to-day tasks. The discrepancy reflects how difficult it is to predict which human capabilities machines will master next, and how readily economies will create new kinds of work to replace those that disappear.</p>

        <p><span class="para-num">C</span> Routine tasks — both physical and cognitive — have proven most <span class="vocab" data-word="susceptible" data-def="dễ bị (ảnh hưởng), dễ mắc">susceptible</span> to automation. Manufacturing positions involving repetitive assembly, data-entry roles, and even certain legal tasks like contract review have all seen significant displacement. Customer service is being transformed by chatbots and automated phone systems that handle ever more complex enquiries. Even areas once considered immune, such as journalism, are seeing algorithmic systems produce routine reports on sports results and financial summaries. The pattern suggests that vulnerability depends less on whether work is physical or mental, and more on whether the tasks involved follow predictable, well-defined patterns that a machine can be trained to reproduce.</p>

        <p><span class="para-num">D</span> Conversely, jobs requiring creativity, complex social interaction, or skilled physical work in unpredictable environments have proven more resistant. Teaching, healthcare nursing, plumbing, and emergency response all combine unpredictability with the need for human judgment in ways that current AI cannot easily <span class="vocab" data-word="replicate" data-def="tái tạo, sao chép">replicate</span>. Interestingly, professions requiring high levels of education are not necessarily safer than skilled trades — a senior radiologist may face more automation pressure than a hairdresser, since reading medical images involves the kind of pattern recognition that AI excels at, while cutting hair on endlessly different head shapes in a cramped salon does not. The lesson is that the boundary between automatable and safe work does not follow the familiar divide between high-status and low-status jobs.</p>

        <p><span class="para-num">E</span> History suggests that disruption usually creates new opportunities even as it eliminates old ones. When ATMs proliferated in the 1990s, many predicted the demise of bank tellers. Instead, the number of tellers initially increased, as cheaper branch operations allowed banks to open more locations. The work shifted toward customer relations and sales rather than routine cash handling. Similar transitions have occurred repeatedly throughout the history of technological change. The real challenge, many economists now argue, is not technology eliminating work altogether, but rather the difficulty individual workers face in transitioning between fields, particularly as they age and as the new jobs demand skills very different from the old.</p>

        <p><span class="para-num">F</span> The geographic distribution of automation effects creates additional complications. Manufacturing regions in the American Midwest, parts of northern England, and former industrial centres in Germany and France have all experienced concentrated job losses that have proven politically <span class="vocab" data-word="destabilising" data-def="gây bất ổn">destabilising</span>. New jobs tend to emerge in different cities — tech hubs like San Francisco, London, and Berlin — and former industrial workers may lack the resources, qualifications, or willingness to relocate to them. The result has been growing economic polarization within wealthy nations, as prosperous regions pull further ahead while declining areas struggle to find a new economic role.</p>

        <p><span class="para-num">G</span> Policy responses have varied widely. Singapore has launched ambitious worker-retraining programmes through its SkillsFuture initiative, offering citizens credits for ongoing education throughout their careers. Finland conducted a high-profile experiment with universal basic income, providing <span class="vocab" data-word="unconditional" data-def="vô điều kiện">unconditional</span> payments to selected unemployed citizens to see whether a guaranteed income could ease the insecurity of a changing labour market. Other nations have invested in apprenticeship programmes that combine education with workplace training. None of these approaches has been definitively shown to solve the challenges of technological displacement, but together they reflect a growing recognition that the consequences of automation will require active social intervention, not merely faith in market adjustment.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> The shapes of cities — their patterns of streets, distribution of public spaces, <span class="vocab" data-word="density" data-def="mật độ">density</span> of buildings — have profound effects on how their inhabitants live, move, and interact. Urban planning, the discipline that consciously shapes these patterns, emerged as a formal profession only in the late nineteenth century, but the questions it addresses have been considered since ancient times. The Greek philosopher Aristotle observed that the proper size of a city was that in which all citizens could know one another; modern urbanists continue to debate the optimal scales and arrangements for human settlements, returning again and again to questions first raised thousands of years ago.</p>

        <p><span class="para-num">B</span> Traditional cities, developed organically over centuries, typically displayed distinctive patterns. Streets followed irregular routes shaped by <span class="vocab" data-word="topography" data-def="địa hình">topography</span>, property boundaries, and slowly changing needs rather than any master plan. Mixed-use development was the norm, with shops, residences, and workshops sharing buildings and neighbourhoods. Distances were necessarily short, since most movement happened on foot. Despite the lack of formal planning, such cities often produced remarkably liveable urban environments: the medieval centres of European cities, traditional Japanese castle towns, and many Middle Eastern bazaars represent sophisticated, time-tested solutions to the problem of organising human settlement.</p>

        <p><span class="para-num">C</span> The twentieth century saw the development of starkly different urban approaches. The Swiss-French architect Le Corbusier proposed designs based on widely separated tower blocks set in landscaped grounds, with cars travelling on dedicated roadways while pedestrians used elevated walkways. American suburban developments after World War II separated land uses comprehensively — residential areas distinct from shopping, both distinct from workplaces. The new approaches were intended to solve the problems of overcrowding, poor <span class="vocab" data-word="sanitation" data-def="điều kiện vệ sinh">sanitation</span>, and traffic conflict that had plagued nineteenth-century industrial cities, but they introduced fresh difficulties of their own.</p>

        <p><span class="para-num">D</span> The results of these modernist experiments have generated decades of intense debate. Critics, beginning with the journalist Jane Jacobs in her influential 1961 book, have argued that strictly planned cities lacked the <span class="vocab" data-word="vitality" data-def="sức sống, sinh khí">vitality</span>, safety, and sense of community that characterised traditional urban areas. Jacobs documented how successful neighbourhoods required short blocks, mixed uses, and constant <span class="vocab" data-word="pedestrian" data-def="người đi bộ">pedestrian</span> activity — features that modernist planning systematically eliminated. Subsequent research has confirmed many of her observations, finding that strictly zoned suburban developments tend to produce isolation, automobile dependence, and reduced physical activity among residents.</p>

        <p><span class="para-num">E</span> Recent decades have seen renewed interest in traditional urban patterns. The "new urbanism" movement, beginning in the United States during the 1980s, deliberately reproduces the dense, walkable, mixed-use patterns of traditional cities in new developments. European cities have invested heavily in pedestrian areas, bicycle infrastructure, and public transit, often reversing earlier accommodations to automobile traffic. Major cities including Copenhagen, Barcelona, and Vienna have become models for how modern needs can be combined with traditional urban virtues, attracting planners from around the world to study their successes.</p>

        <p><span class="para-num">F</span> The relationship between urban form and environmental <span class="vocab" data-word="sustainability" data-def="tính bền vững">sustainability</span> has become increasingly important. Dense traditional cities, despite their reputation for pollution and crowding, generally produce much lower per-capita greenhouse gas emissions than sprawling suburban developments. Residents of compact cities walk and cycle more, drive less, occupy smaller dwellings that require less energy to heat and cool, and consume fewer resources overall. The urban density that critics once associated with poverty and unhealthiness is increasingly recognised as essential to environmental sustainability in an age of climate change.</p>

        <p><span class="para-num">G</span> Looking toward the future, urban planners face a complex set of challenges. Climate change threatens many coastal cities with rising sea levels and more frequent extreme weather. Ageing populations require accessibility features that earlier planning often ignored. Affordable housing crises in major cities limit who can benefit from urban opportunities. Technology, from autonomous vehicles to remote work, may transform demands on urban form in ways that are still unclear. What seems certain is that the basic questions identified by Aristotle remain relevant: how should we design the physical environments in which we conduct our communal lives?</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Despite spending roughly a third of our lives sleeping, humans have only recently begun to understand what sleep actually is and why we need it. For most of history, sleep was viewed as a passive state — essentially the absence of <span class="vocab" data-word="wakefulness" data-def="trạng thái thức">wakefulness</span>, a nightly switching-off of the body. Modern research has revealed sleep to be an active and biologically complex process during which the brain and body perform essential functions that cannot occur during waking hours. Yet despite considerable progress, fundamental questions about sleep's ultimate purpose continue to puzzle researchers, and no single theory accounts for everything sleep appears to do.</p>

        <p><span class="para-num">B</span> The discovery in the 1950s that the brain remains highly active during certain phases of sleep transformed sleep research. Periods called REM (rapid eye movement) sleep involve brain activity strikingly similar to waking, while non-REM sleep involves distinct patterns, including the deep slow waves associated with the deepest sleep. Throughout a typical night, humans cycle through these states multiple times, with REM periods becoming progressively longer toward morning. Different sleep stages appear to serve different biological functions, though much about exactly what each stage does remains debated.</p>

        <p><span class="para-num">C</span> Memory <span class="vocab" data-word="consolidation" data-def="sự củng cố">consolidation</span> is one of the best-established functions of sleep. Studies consistently show that people remember information learned shortly before sleep better than information learned at times not followed by sleep. Brain imaging during sleep reveals activity patterns that appear to replay and process information acquired during waking hours, as if the sleeping brain were rehearsing the day. This processing appears particularly important for <span class="vocab" data-word="procedural" data-def="(trí nhớ) thủ tục, quy trình">procedural</span> memories — skills like playing musical instruments or operating machinery — and for transferring information from short-term to long-term storage.</p>

        <p><span class="para-num">D</span> Sleep also appears crucial for emotional regulation. People deprived of sleep show enhanced reactions to negative experiences and a reduced ability to manage their emotional responses. Brain-imaging studies have found that sleep <span class="vocab" data-word="deprivation" data-def="sự thiếu hụt, tước đoạt">deprivation</span> produces dramatic increases in activity in brain regions associated with emotional reactions, while reducing activity in the regions involved in regulating those reactions. The chronic sleep deprivation common in modern societies may contribute to widespread mood disorders, anxiety, and difficulties with emotional regulation in ways that researchers are still working to understand.</p>

        <p><span class="para-num">E</span> Recent research has identified physical maintenance functions performed during sleep that researchers had not previously suspected. The discovery of the glymphatic system, announced in 2013, revealed that brain tissue contracts during sleep, allowing cerebrospinal fluid to flow through expanded channels and clear away <span class="vocab" data-word="metabolic" data-def="(thuộc) chuyển hóa">metabolic</span> waste products. This cleaning process appears to remove proteins associated with neurodegenerative diseases like Alzheimer's, suggesting that chronic sleep disruption may contribute to such conditions. Other research has linked sleep to immune function, metabolic regulation, and the release of growth hormone.</p>

        <p><span class="para-num">F</span> Despite the clear importance of adequate sleep, modern lifestyles often work against it. Artificial lighting, particularly the blue light from electronic screens, suppresses production of melatonin, the hormone signalling the brain to sleep. Demanding work schedules, social commitments, and an endless supply of entertainment options compete for the time that previous generations spent sleeping. Average sleep duration has decreased by approximately one to two hours per night over the past century, with significant effects on health and wellbeing that researchers are only beginning to document fully.</p>

        <p><span class="para-num">G</span> Cultural attitudes toward sleep vary considerably and influence individual behaviour. Some cultures embrace afternoon napping as a normal part of daily life; others view daytime sleeping as a sign of laziness. Some societies celebrate working through fatigue as evidence of dedication; others recognise adequate rest as essential to good performance. Research increasingly supports the latter view, demonstrating that fatigue produces effects on cognition and decision-making comparable to those of alcohol <span class="vocab" data-word="intoxication" data-def="sự say (rượu)">intoxication</span>. As understanding of sleep grows, cultural attitudes are slowly shifting toward recognition that the time we spend asleep is not lost time but is rather essential to making the most of the time we spend awake.</p>`,
    ...
    passages: [
      {
        ...
        content: `<p><span class="para-num">A</span> Humans spend roughly one-third of their lives asleep, yet the purpose of this <span class="vocab" data-word="seemingly" data-def="có vẻ như, dường như">seemingly</span> wasteful state has long puzzled scientists. Why would evolution favour creatures that lie helpless for hours each day, <span class="vocab" data-word="vulnerable" data-def="dễ bị tổn thương, dễ bị tấn công">vulnerable</span> to predators and unable to feed or reproduce? For much of history, sleep was regarded as a passive shutting-down of the body, a mere absence of wakefulness. The answer that has emerged from decades of research tells a very different story: sleep is not wasted time at all but a period of intense biological activity essential for survival. Far from switching off, the sleeping brain is busy carrying out tasks that simply cannot be performed while we are awake.</p>

      <p><span class="para-num">B</span> During sleep, the human brain cycles through several distinct stages, each characterised by different patterns of electrical activity that can be recorded by electrodes placed on the scalp. The cycle begins with light sleep, progresses through deeper stages of slow-wave sleep, and culminates in rapid eye movement (REM) sleep, when most vivid dreaming occurs and the muscles of the body are temporarily paralysed. A complete cycle lasts roughly 90 minutes, and a typical night includes four to six cycles. Crucially, the proportions of different sleep stages shift across the night, with slow-wave sleep dominating early and REM sleep increasing toward morning. This is one reason why waking abruptly in the small hours can leave a person feeling far more disoriented than waking naturally at dawn.</p>

      <p><span class="para-num">C</span> Memory <span class="vocab" data-word="consolidation" data-def="sự củng cố, hợp nhất">consolidation</span> appears to be one of sleep's primary functions. Studies have shown that information learned during the day is reactivated and strengthened during sleep, particularly during slow-wave stages, as though the brain were replaying and filing away the day's experiences. Participants who sleep after learning a new task — whether memorising vocabulary or mastering a sequence of finger movements — perform significantly better the next day than those who remain awake for the same period. This finding has practical implications for students and professionals: pulling an all-nighter before an exam may actually impair the very memory the studying was meant to build. A shorter period of study followed by a full night's sleep often produces better results than hours of extra revision at the expense of rest.</p>

      <p><span class="para-num">D</span> Sleep also plays a critical role in physical health. During deep sleep, the body releases growth hormone, repairs tissues, and strengthens the immune system, which is why illness so often increases our need for rest. Chronic sleep deprivation has been linked to a wide range of health problems, including <span class="vocab" data-word="obesity" data-def="bệnh béo phì">obesity</span>, diabetes, cardiovascular disease, and weakened immunity. A landmark study found that people who consistently slept fewer than six hours per night were significantly more likely to catch colds than those who slept seven hours or more, even when deliberately exposed to the same virus under controlled conditions. The effects accumulate quietly, often without the sufferer recognising the connection between poor sleep and declining health.</p>

      <p><span class="para-num">E</span> Recently, researchers have identified another remarkable function of sleep: brain "cleaning". During wakeful hours, the brain accumulates <span class="vocab" data-word="metabolic" data-def="(thuộc) chuyển hóa">metabolic</span> waste products, including proteins associated with Alzheimer's disease. In 2013, scientists at the University of Rochester discovered that during sleep, the space between brain cells expands, allowing cerebrospinal fluid to flush out these waste products much more efficiently than during waking hours. This drainage process appears to operate chiefly at night, when the demands of conscious thought are reduced. The finding suggests that adequate sleep may be crucial for preventing <span class="vocab" data-word="neurodegenerative" data-def="thoái hóa thần kinh">neurodegenerative</span> diseases later in life, and it has opened an entirely new avenue of medical research.</p>

      <p><span class="para-num">F</span> Despite mounting evidence of sleep's importance, modern societies appear to be in the grip of a sleep deprivation epidemic. The average adult in industrialised countries now sleeps about an hour less per night than was typical fifty years ago. Artificial lighting, screen time before bed, demanding work schedules, and the cultural <span class="vocab" data-word="glorification" data-def="sự tôn vinh, ca tụng">glorification</span> of busyness all contribute to this trend. Many people wear chronic sleep loss as a badge of honour, boasting about how little rest they need, unaware that they are accumulating what researchers call "sleep debt" — a deficit that cannot simply be paid off by sleeping in on weekends. The damage done by repeated short nights builds up gradually and is not easily reversed by a single long lie-in.</p>

      <p><span class="para-num">G</span> Improving sleep, fortunately, is largely within our control. Sleep scientists recommend maintaining consistent sleep and wake times, including on weekends; keeping bedrooms cool, dark, and quiet; avoiding caffeine after midday; and limiting exposure to bright screens in the evening, since the light they emit can suppress the hormones that prepare the body for rest. While individual sleep needs vary, most adults function best with seven to nine hours per night. Treating sleep as a luxury rather than a necessity, current research suggests, is a mistake we cannot afford to continue making — one that quietly undermines our memory, our health, and our capacity to think clearly.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> The Olympic Games represent one of the world's most <span class="vocab" data-word="enduring" data-def="bền bỉ, lâu dài">enduring</span> cultural institutions, connecting the modern world to ancient Greek civilisation through more than 2,700 years of athletic competition. Yet the Games as we know them today bear only loose <span class="vocab" data-word="resemblance" data-def="sự giống nhau, tương đồng">resemblance</span> to their ancient predecessors. The scale, the technology, the global television audience and the professional athletes would all astonish a visitor from antiquity. Understanding how the Olympics evolved from a religious ritual in a small Greek valley into a global commercial spectacle reveals much about how cultural traditions survive by adapting to changing times rather than remaining frozen in their original form.</p>

        <p><span class="para-num">B</span> The original Olympic Games were held at Olympia in southwestern Greece beginning in 776 BCE, although athletic competitions had probably taken place there for centuries before formal records began. These ancient games were religious festivals dedicated to Zeus, the king of the Greek gods, and were one of four major athletic festivals held across Greece in a four-year cycle. Athletes came from across the Greek-speaking world, including colonies in Italy, Sicily, and Asia Minor, often travelling long distances to take part. The games combined athletic competition with religious worship, philosophical discussion, and political negotiation, and so important were they that even warring city-states observed temporary <span class="vocab" data-word="truces" data-def="các cuộc đình chiến, hưu chiến">truces</span> to allow competitors and spectators to travel safely to the festival.</p>

        <p><span class="para-num">C</span> Ancient Olympic events differed significantly from modern ones. The competitions included foot races of various distances, wrestling, boxing, the pentathlon (combining five events), chariot racing, and the pankration — a brutal combination of wrestling and boxing with almost no rules, in which serious injury was common. Most events were performed entirely nude, reflecting Greek attitudes toward the unclothed athletic body, which was admired rather than concealed. Women were barred not only from competing but from attending; the punishment for violating this rule was reportedly death, although there is no clear evidence that this penalty was ever imposed. Victors received only an olive wreath and the considerable prestige that came with Olympic victory — prestige that could bring lasting fame and reward in their home cities.</p>

        <p><span class="para-num">D</span> The ancient Games continued for nearly twelve centuries before being <span class="vocab" data-word="abolished" data-def="bãi bỏ, xóa bỏ">abolished</span> by the Roman emperor Theodosius I in 393 CE. As Christianity became dominant in the Roman Empire, athletic festivals associated with the worship of pagan gods were increasingly viewed with <span class="vocab" data-word="hostility" data-def="sự thù địch">hostility</span>, and an event so closely tied to Zeus could not easily survive. The site of Olympia was gradually abandoned, eventually being destroyed by earthquakes and buried under layers of silt by repeated river floods. For more than a thousand years the location was effectively lost, and the traditions of athletic competition that had defined Greek culture for over a millennium faded into historical memory, known only through surviving texts.</p>

        <p><span class="para-num">E</span> The modern Olympic Games were revived through the efforts of the French educator Pierre de Coubertin, who saw athletic competition as a means of promoting peaceful international understanding and improving the physical education of young people. The first modern Games were held in Athens in 1896, with 14 nations sending 241 athletes to compete in 43 events — a modest gathering by today's standards, but a remarkable achievement for its time. The international success of those Games launched what became a regular four-year cycle, although the competition was suspended during both world wars. From these modest beginnings, the Olympics have grown into one of the world's largest sporting events, watched by billions.</p>

        <p><span class="para-num">F</span> The modern Games have not been without controversy. Political disputes have repeatedly affected the Olympics, with major boycotts in 1980 and 1984 as rival power blocs refused to attend Games hosted by the other side during Cold War tensions. The 1936 Berlin Games, used for <span class="vocab" data-word="propaganda" data-def="sự tuyên truyền">propaganda</span> purposes by the Nazi regime, demonstrated how the event could be exploited for political ends. The increasing <span class="vocab" data-word="commercialisation" data-def="sự thương mại hóa">commercialisation</span> of the Olympics has changed their character; the modern Games depend heavily on broadcasting rights, sponsorships, and other commercial activities that earlier organisers would not have recognised. Doping scandals, in which athletes use banned substances to gain an unfair advantage, have damaged the credibility of competitions across many sports.</p>

        <p><span class="para-num">G</span> Despite these challenges, the Olympics retain extraordinary cultural significance. The ceremonial elements — the lighting of the torch in Olympia and its journey to the host city, the parade of athletes during opening ceremonies, the medal podium with its three flags — connect spectators to a tradition that, however changed, traces a continuous <span class="vocab" data-word="lineage" data-def="dòng dõi, nguồn gốc">lineage</span> back to ancient Greece. For two weeks every four years, billions of people around the world share an experience of international competition that remains, despite all its commercial elements, profoundly meaningful. Whatever criticism the modern Olympics deserve, they continue to fulfil at least part of Coubertin's original vision of bringing nations together in peaceful rivalry.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Few human activities are as universally enjoyed as music. Across every known human culture, people make music, listen to music, and respond emotionally to musical sounds, whether in religious ceremonies, public celebrations, or moments of private reflection. Yet from a strictly evolutionary perspective, music presents a puzzle: the production and appreciation of organised sound patterns requires considerable cognitive resources, yet music seems to offer no obvious survival benefit. Why did our species develop such <span class="vocab" data-word="elaborate" data-def="phức tạp, công phu">elaborate</span> capacities for an activity that does not directly help us find food, escape predators, or reproduce? The science of music attempts to answer these questions and to understand how music affects our minds and bodies, drawing on psychology, neuroscience, and anthropology.</p>

        <p><span class="para-num">B</span> The American psychologist Steven Pinker famously described music as "auditory cheesecake" — a pleasant <span class="vocab" data-word="by-product" data-def="sản phẩm phụ">by-product</span> of cognitive systems that evolved for other purposes such as language, emotional communication, and pattern recognition. According to this view, music has no specific evolutionary function but happens to stimulate brain systems that respond pleasurably to certain sound patterns, much as a rich dessert exploits a taste for sugar and fat that originally evolved to serve nutrition. Other scientists strongly disagree, arguing that music's universal presence in human cultures and its specific effects on brain function suggest a more fundamental role, perhaps in social bonding or the soothing of infants. The debate over music's evolutionary origins remains unresolved among researchers.</p>

        <p><span class="para-num">C</span> What is clear is that music affects the brain in distinctive and powerful ways. Brain imaging studies show that listening to music activates multiple brain regions <span class="vocab" data-word="simultaneously" data-def="đồng thời, cùng lúc">simultaneously</span> — areas involved in hearing, memory, emotion, movement, and even motor planning, as if the brain prepares to dance even when the body remains still. Particularly striking is music's effect on the brain's reward system, the same circuits activated by food and other pleasures. The pleasure people derive from music shows up in brain activity as clearly as any other reward, and the most intense musical moments can trigger the release of the very chemicals associated with other deeply pleasurable experiences. This helps explain why music feels so emotionally <span class="vocab" data-word="compelling" data-def="cuốn hút, có sức thuyết phục">compelling</span>.</p>

        <p><span class="para-num">D</span> Music's effects on emotion have been extensively studied. Sad music can produce genuine feelings of sadness in listeners, just as joyful music produces feelings of happiness. Yet people often seek out sad music when they themselves are sad — a behaviour that puzzles researchers, since it seems to run against the natural desire to avoid unpleasant feelings. Recent studies suggest that sad music may produce a complex emotional response that includes both sadness and a kind of comforting connection, perhaps reflecting the social functions of music in helping listeners feel understood and less alone. Music can also evoke memories with remarkable specificity, sometimes recalling experiences that conscious thought cannot easily access.</p>

        <p><span class="para-num">E</span> The <span class="vocab" data-word="therapeutic" data-def="(thuộc) trị liệu">therapeutic</span> uses of music have a long history but are increasingly supported by scientific evidence. Music therapy is now used in many medical settings, from helping stroke patients regain language and movement abilities to reducing anxiety in patients before surgery. Studies have found that listening to music can lower blood pressure, reduce stress hormones, and ease the perception of pain, sometimes allowing patients to manage with smaller doses of medication. Patients with dementia often retain musical memories long after losing other cognitive abilities, and a familiar song can sometimes briefly restore communication that seemed completely lost, reconnecting individuals with their own past. These effects remain incompletely understood but are consistently observed.</p>

        <p><span class="para-num">F</span> Musical training appears to have lasting effects on brain development. Children who receive significant musical training show enhanced abilities in several non-musical domains, including verbal skills, mathematical reasoning, and certain types of memory. Brain imaging shows that musicians' brains differ structurally from those of non-musicians in measurable ways, with certain regions appearing larger or more densely connected. Yet questions remain about cause and effect — whether musical training produces these brain changes, or whether children with particular brain characteristics are simply more likely to take up and persist with musical training in the first place. The relationship between music education and broader cognitive development continues to be studied closely.</p>

        <p><span class="para-num">G</span> Modern digital technologies have transformed humans' relationship with music. For most of human history, music required personal performance — either by oneself or in the presence of others. Recording technology, beginning in the late nineteenth century, allowed music to be preserved and replayed for the first time. Digital music later made vast libraries accessible to anyone with a connection, and streaming services have given listeners <span class="vocab" data-word="unprecedented" data-def="chưa từng có tiền lệ">unprecedented</span> choice, placing almost the entire history of recorded sound within reach of a single device. Yet some researchers worry that these conveniences come at a cost: people who once would have made music themselves now passively consume it. Whether this represents progress or loss remains debated, but the basic human relationship with music — present in some form in every culture — seems likely to continue evolving as long as humans exist.</p>`,
  ...
  'cam11-t1': {
    ...
    topic: 'Architecture · Biology · Psychology',
    difficulty: 'Medium',
    passages: [
      { label: 'Reading Passage 1', title: 'Reaching for the Sky: The Birth of the Skyscraper', content: `<p><span class="para-num">A</span> The skyscraper is among the most recognizable symbols of modern urban life, yet its development depended on a precise combination of technological innovations that came together only in the late nineteenth century. Before this period, the height of buildings was limited by two fundamental constraints: the load-bearing capacity of <span class="vocab" data-word="masonry" data-def="khối xây (gạch đá)">masonry</span> walls and the practical difficulty of climbing stairs to upper floors. For thousands of years, even the grandest structures had rarely risen more than a few storeys above the ground. Resolving these limitations would require entirely new approaches to both construction and vertical transportation.</p>

      <p><span class="para-num">B</span> The breakthrough in vertical transportation came in 1853, when American inventor Elisha Otis demonstrated a safety elevator at the New York Crystal Palace exhibition. Earlier elevators had existed for transporting goods, but had been considered too dangerous for passengers because of the risk of falls if the cable broke. Otis's <span class="vocab" data-word="ingenious" data-def="khéo léo, tài tình">ingenious</span> invention used a safety brake that would automatically engage if the elevator cable failed. To prove its effectiveness, he had himself raised on the platform and then dramatically ordered the cable cut. The platform held firm, and the safety elevator was born. Without this innovation, tall buildings would have remained impractical regardless of structural improvements.</p>

      <p><span class="para-num">C</span> The structural revolution came two decades later in Chicago, where the catastrophic fire of 1871 had destroyed much of the city and created enormous demand for new construction. Architects working in the rebuilt city pioneered the use of iron and then steel <span class="vocab" data-word="skeleton" data-def="khung xương, khung chịu lực">skeleton</span> frames. Unlike traditional masonry construction, where the walls themselves supported the weight of the building, the new approach used a frame of vertical and horizontal metal beams to bear all structural loads. The walls became simply a thin skin attached to this frame, no longer needing to be thick at the base to support upper floors. This radical change meant that the height of buildings was no longer limited by the practical impossibility of constructing massive stone walls.</p>

      <p><span class="para-num">D</span> The Home Insurance Building, completed in Chicago in 1885, is generally considered the first true skyscraper. Designed by William Le Baron Jenney, it stood ten stories tall — modest by modern standards but revolutionary for its time. More importantly, it was the first major building to use a complete metal skeleton frame to support its weight. Other Chicago architects, including Louis Sullivan and Daniel Burnham, refined and popularized the approach during the following decade. Their work gave rise to what became known as the Chicago School of architecture, characterized by tall buildings with restrained <span class="vocab" data-word="ornamentation" data-def="sự trang trí">ornamentation</span> and emphasis on the underlying steel frame.</p>

      <p><span class="para-num">E</span> Although Chicago invented the skyscraper, New York City quickly claimed leadership in pushing the form to ever greater heights. The geographical constraints of Manhattan, where land prices were extraordinarily high but the <span class="vocab" data-word="bedrock" data-def="nền đá gốc">bedrock</span> was particularly suitable for supporting tall buildings, encouraged maximum vertical development. The Flatiron Building of 1902 and the Singer Building of 1908 set successive records, but they were soon dwarfed by the Woolworth Building of 1913, which reached 792 feet. The race continued through the 1920s and culminated in 1931 with the completion of the Empire State Building, whose 1,250-foot height would remain unsurpassed for forty years.</p>

      <p><span class="para-num">F</span> The early skyscrapers transformed not only the appearance of cities but also their social organization. By dramatically increasing the floor space available on any given parcel of land, they allowed enormous concentrations of office workers and commercial activity in central business districts. This had complex consequences: it created the modern downtown but also led to the daily exodus to suburban housing that defines so many North American cities today. Skyscrapers became symbols of corporate power and national <span class="vocab" data-word="prestige" data-def="uy tín, danh giá">prestige</span>, with companies and cities competing to construct the tallest examples for reasons that were as much about image as about practical need.</p>

      <p><span class="para-num">G</span> Today, skyscraper construction continues at a remarkable pace, but its center has shifted decisively away from North America. Of the hundred tallest buildings completed since 2000, the vast majority are in Asia, particularly China and the United Arab Emirates. The Burj Khalifa in Dubai, completed in 2010 at over 2,700 feet, demonstrates how far the form has come since the modest ten-story Home Insurance Building. Yet despite changes in scale, location, and technology, modern skyscrapers continue to rely on the same fundamental innovations — the safety elevator and the skeleton frame — that made the original tall buildings possible.</p>`, vi: `<p><strong>Đoạn A:</strong> Tòa nhà chọc trời là biểu tượng đô thị hiện đại. Trước cuối thế kỷ 19, chiều cao bị giới hạn bởi sức chịu tải của tường gạch và khó khăn leo cầu thang.</p>
      <p><strong>Đoạn B:</strong> 1853, Elisha Otis trình diễn thang máy an toàn (phanh tự động khi đứt cáp) ở Crystal Palace New York. Ông tự đứng rồi ra lệnh cắt cáp.</p>
      <p><strong>Đoạn C:</strong> Cách mạng cấu trúc tại Chicago sau cháy 1871. Khung sắt/thép chịu lực; tường thành lớp da mỏng.</p>
      <p><strong>Đoạn D:</strong> Home Insurance Building (Chicago 1885) do William Le Baron Jenney thiết kế, cao 10 tầng, khung kim loại hoàn chỉnh. Trường phái Chicago.</p>
      <p><strong>Đoạn E:</strong> New York vượt Chicago. Manhattan giá đất cao nhưng nền đá tốt. Woolworth 1913 (792 ft); Empire State 1931 (1.250 ft) - 40 năm không bị vượt.</p>
      <p><strong>Đoạn F:</strong> Biến đổi xã hội: tập trung văn phòng, tạo downtown, chuyển ra ngoại ô. Biểu tượng quyền lực và uy tín.</p>
      <p><strong>Đoạn G:</strong> Nay trung tâm chuyển sang châu Á (Trung Quốc, UAE). Burj Khalifa Dubai (2010, hơn 2.700 ft). Vẫn dựa trên thang máy an toàn và khung chịu lực.</p>` },
      { label: 'Reading Passage 2', title: 'The Intelligence of Crows', content: `<p><span class="para-num">A</span> For centuries, crows and their relatives were dismissed as little more than noisy scavengers. Today, however, scientists regard the <span class="vocab" data-word="corvids" data-def="họ quạ (quạ, qua lớn, giẻ cùi)">corvids</span> — the family that includes crows, ravens, jays, and magpies — as among the most intelligent animals on the planet. Relative to their body size, corvid brains are remarkably large, rivalling those of the great apes, and a growing body of research suggests that these birds can solve problems, use tools, and plan ahead in ways once thought to be uniquely human. The clever crow of folklore, it turns out, was not such a fanciful idea after all.</p>

      <p><span class="para-num">B</span> The most celebrated demonstrations of corvid intelligence involve tools. New Caledonian crows not only use sticks and leaves to extract insects from crevices but actually manufacture their own tools, bending wire into hooks and trimming twigs into shape. In a famous experiment inspired by one of Aesop's fables, crows were presented with a tube of water containing a floating treat out of reach; the birds dropped stones into the tube to raise the water level and bring the food within reach, showing an understanding of water displacement that astonished researchers. This kind of <span class="vocab" data-word="ingenuity" data-def="sự khéo léo, tài tình">ingenuity</span> had previously been observed only in humans and a handful of other primates.</p>

      <p><span class="para-num">C</span> Corvids also possess extraordinary memories. The Clark's nutcracker, a relative of the crow, buries tens of thousands of seeds across a wide area each autumn and is able to <span class="vocab" data-word="retrieve" data-def="tìm lại, lấy lại">retrieve</span> the great majority of them months later, even when the landscape is covered in snow. This feat of spatial memory far exceeds anything most humans could manage, and it depends on a part of the brain that grows larger during the season when the birds are <span class="vocab" data-word="caching" data-def="cất giấu (thức ăn)">caching</span> their food. Such precise recall is essential for survival through the long winter months.</p>

      <p><span class="para-num">D</span> Perhaps most striking is the corvids' social intelligence. In a well-known study, researchers wearing distinctive masks captured and released wild crows; for years afterwards, the birds recognised and scolded anyone wearing the same mask, even passing on their hostility to other crows that had never been captured. Crows, in other words, can recognise individual human faces, hold <span class="vocab" data-word="grudges" data-def="sự hằn thù, để bụng">grudges</span>, and communicate threats to one another. They are also known to gather noisily around a dead member of their species, possibly in order to learn about sources of danger.</p>

      <p><span class="para-num">E</span> Corvids can even plan for the future, a capacity long believed to be restricted to humans and great apes. In controlled experiments, ravens were given a tool that could later be exchanged for food, and chose to keep the tool for use at a future time rather than accept an immediate but smaller reward. This ability to forgo a present benefit in favour of a greater future one suggests a sophisticated sense of time, and challenges the long-held assumption that only humans truly plan ahead.</p>

      <p><span class="para-num">F</span> Communication among corvids is also surprisingly rich. Crows produce a wide range of calls with different meanings, and populations in different regions develop distinctive local <span class="vocab" data-word="dialects" data-def="phương ngữ, giọng vùng">dialects</span>. Information appears to be shared socially: young birds learn from older ones, and knowledge about food sources or dangers can spread rapidly through a group. This capacity for social learning means that corvid behaviour can vary from place to place in ways that resemble the cultural traditions of human communities.</p>

      <p><span class="para-num">G</span> What makes corvid intelligence especially fascinating to scientists is that it evolved entirely separately from that of mammals. Bird brains are organised very differently from primate brains, lacking the layered structure of the mammalian cortex, yet they achieve comparable feats of reasoning and memory. This is a striking example of convergent evolution, in which similar abilities arise independently in unrelated lineages. The study of crows therefore offers valuable clues about what intelligence really is, and about the different ways in which a brain can be built to produce it.</p>`, vi: `<p><strong>Đoạn A:</strong> Họ quạ (corvids) là một trong những loài thông minh nhất. Não lớn so với cơ thể, sánh với vượn lớn.</p>
      <p><strong>Đoạn B:</strong> Quạ New Caledonia tự chế tạo công cụ. Thí nghiệm theo ngụ ngôn Aesop: thả đá nâng mực nước - hiểu sự dịch chuyển nước.</p>
      <p><strong>Đoạn C:</strong> Trí nhớ phi thường: Clark's nutcracker giấu hàng chục nghìn hạt, tìm lại sau nhiều tháng.</p>
      <p><strong>Đoạn D:</strong> Trí thông minh xã hội: nhận diện khuôn mặt người, để bụng, cảnh báo nhau (thí nghiệm mặt nạ).</p>
      <p><strong>Đoạn E:</strong> Lập kế hoạch tương lai: giữ công cụ để đổi thức ăn sau thay vì phần thưởng nhỏ tức thì.</p>
      <p><strong>Đoạn F:</strong> Giao tiếp phong phú: nhiều tiếng kêu, phương ngữ vùng; học hỏi xã hội.</p>
      <p><strong>Đoạn G:</strong> Tiến hóa độc lập với động vật có vú - ví dụ tiến hóa hội tụ (convergent).</p>` },
      { label: 'Reading Passage 3', title: 'How Memory Works', content: `<p><span class="para-num">A</span> Memory lies at the very heart of who we are. Without it, we could not recognise our families, hold a conversation, or learn from experience; our sense of being a continuous self depends entirely upon it. Yet despite its central importance, memory is widely misunderstood. Most people imagine it works rather like a video recording, faithfully storing events for later replay. In reality, as more than a century of research has shown, human memory is a far more active, selective, and <span class="vocab" data-word="reconstructive" data-def="tái dựng, kiến tạo lại">reconstructive</span> process than this comfortable image suggests.</p>

      <p><span class="para-num">B</span> Psychologists generally distinguish several kinds of memory. Information first enters a very brief sensory store, and the small fraction we pay attention to passes into short-term, or working, memory. This working memory is strikingly limited: in a classic 1956 paper, the psychologist George Miller estimated that it can hold only about seven items at any one time. Only some of this material is then transferred into long-term memory, the vast and durable store that can hold information for a lifetime. The journey from fleeting impression to lasting memory is therefore far from automatic.</p>

      <p><span class="para-num">C</span> Forming a lasting memory depends on a process called <span class="vocab" data-word="encoding" data-def="sự mã hóa (ghi nhớ)">encoding</span>, in which the brain links new information to what we already know. A small region deep in the brain, the hippocampus, plays an essential role in transferring new experiences into long-term storage, a process that continues even during sleep. The importance of this region was revealed dramatically by the case of a patient known as H.M., who had his hippocampus removed in an operation and was thereafter unable to form any new long-term memories, although his memories from before the surgery remained intact.</p>

      <p><span class="para-num">D</span> One of the most important discoveries about memory is that it is reconstructive rather than <span class="vocab" data-word="reproductive" data-def="tái tạo, sao chép lại">reproductive</span>. Each time we recall an event, we rebuild it from fragments rather than replaying a fixed record, and in doing so we may unknowingly alter it. The psychologist Elizabeth Loftus demonstrated through a series of famous experiments that people can be led to remember details that never occurred, and can even develop entirely false memories of events that never happened, simply through suggestion. This finding has profound implications for the reliability of <span class="vocab" data-word="eyewitness" data-def="nhân chứng">eyewitness</span> testimony in courts of law.</p>

      <p><span class="para-num">E</span> Forgetting, which we usually regard as a failure, is in fact a normal and often useful feature of memory. A mind that remembered absolutely everything would be overwhelmed by irrelevant detail, unable to recognise what truly matters. Forgetting may occur because memories gradually decay through lack of use, or because newer information interferes with older memories. The familiar 'tip-of-the-tongue' experience, in which a word feels frustratingly just out of reach, shows that a memory can be present yet temporarily <span class="vocab" data-word="inaccessible" data-def="không thể truy cập, không gợi lại được">inaccessible</span> rather than truly lost.</p>

      <p><span class="para-num">F</span> Because memory is so important, people have long sought ways to improve it. Research has confirmed that spacing study sessions out over time works far better than cramming, and that actively retrieving information — testing oneself — strengthens memory more than simply rereading, an effect known as the testing effect. The most powerful traditional technique is the method of loci, or 'memory palace', in which items to be remembered are mentally placed in the rooms of a familiar building. Ancient Greek and Roman orators used this method to memorise long speeches, and competitors in modern memory contests still rely on it today.</p>

      <p><span class="para-num">G</span> Modern life is changing our relationship with memory in new ways. As we age, some decline in memory is normal, though serious memory loss is a sign of disease rather than ordinary ageing. Meanwhile, the constant availability of information online appears to be altering how we remember: studies suggest that people are now less likely to remember facts they know they can easily look up, and more likely to remember where to find them instead. This so-called 'Google effect' is a modern example of a very old human habit — <span class="vocab" data-word="offloading" data-def="chuyển gánh nặng ra ngoài">offloading</span> the burden of memory onto external aids, from knotted strings to notebooks to the digital devices in our pockets.</p>`, vi: `<p><strong>Đoạn A:</strong> Trí nhớ là cốt lõi bản thân. Không phải băng ghi hình mà là quá trình chủ động, chọn lọc, tái dựng.</p>
      <p><strong>Đoạn B:</strong> Các loại: giác quan → ngắn hạn/làm việc (giới hạn ~7 mục, Miller 1956) → dài hạn.</p>
      <p><strong>Đoạn C:</strong> Mã hóa (encoding) liên kết thông tin mới với cái đã biết. Hippocampus thiết yếu; bệnh nhân H.M. mất hippocampus → không tạo được trí nhớ mới.</p>
      <p><strong>Đoạn D:</strong> Tái dựng chứ không tái tạo. Loftus: tạo trí nhớ giả qua gợi ý → ảnh hưởng độ tin cậy nhân chứng.</p>
      <p><strong>Đoạn E:</strong> Quên là bình thường và hữu ích (phai mòn/nhiễu). "Tip-of-the-tongue": có nhưng tạm thời không gợi lại được.</p>
      <p><strong>Đoạn F:</strong> Cải thiện: học giãn cách; tự kiểm tra (testing effect); method of loci (cung điện trí nhớ).</p>
      <p><strong>Đoạn G:</strong> Tuổi tác suy giảm nhẹ (mất nhiều là bệnh). "Google effect": nhớ NƠI tìm thông tin - offloading.</p>` }
    ],
    questions: [
      [
              {
      ...
      [
        {
          ...
          instruction: 'Reading Passage 2 has seven paragraphs, A-G. Choose the correct heading for each paragraph from the list below.',
          headings: [
            { id: 'i', text: 'Remembering where food is hidden' },
            { id: 'ii', text: 'Making and using tools' },
            { id: 'iii', text: 'An introduction to surprisingly clever birds' },
            { id: 'iv', text: 'Recognising and remembering people' },
            { id: 'v', text: 'Planning for the future' },
            { id: 'vi', text: 'Communicating and sharing information' },
            { id: 'vii', text: 'What crow intelligence reveals about the brain' },
            { id: 'viii', text: 'How crows raise their young' },
            { id: 'ix', text: 'The decline of crow populations' }
          ],
          items: [
            { q: 'A', answer: 'iii', explain: 'Doan A gioi thieu nhung loai chim thong minh dang ngac nhien.' },
            { q: 'B', answer: 'ii', explain: 'Doan B ve che tao va su dung cong cu.' },
            { q: 'C', answer: 'i', explain: 'Doan C ve tri nho noi giau thuc an.' },
            { q: 'D', answer: 'iv', explain: 'Doan D ve nhan dien va ghi nho con nguoi.' },
            { q: 'E', answer: 'v', explain: 'Doan E ve lap ke hoach tuong lai.' },
            { q: 'F', answer: 'vi', explain: 'Doan F ve giao tiep va chia se thong tin.' },
            { q: 'G', answer: 'vii', explain: 'Doan G ve dieu tri thong minh cua qua tiet lo ve bo nao.' }
          ]
        },
        {
          group: 'Questions 21–23',
          ...
          instruction: 'Do the following statements agree with the information given in Reading Passage 2? Write TRUE, FALSE, or NOT GIVEN.',
          items: [
            { q: 'New Caledonian crows can make their own tools.', answer: 'TRUE', explain: 'Doan B: chung "manufacture their own tools".' },
            { q: 'Crows quickly forget humans who have threatened them.', answer: 'FALSE', explain: 'Doan D: nho va canh bao trong nhieu nam - khong quen.' },
            { q: 'Crows are more intelligent than chimpanzees.', answer: 'NOT GIVEN', explain: 'Khong co so sanh truc tiep qua voi tinh tinh.' }
          ]
        },
        {
          group: 'Questions 24–26',
          ...
          instruction: 'Complete the sentences below. Choose NO MORE THAN TWO WORDS from the passage for each answer.',
          items: [
            { q: "The Clark's nutcracker can remember the locations of tens of thousands of buried __________.", answer: 'seeds', explain: 'Doan C: "buries tens of thousands of seeds".' },
            { q: 'In an experiment based on a fable, crows showed an understanding of water __________.', answer: 'displacement', explain: 'Doan B: "understanding of water displacement".' },
            { q: 'Crow intelligence is an example of __________ evolution, having developed separately from that of mammals.', answer: 'convergent', explain: 'Doan G: "convergent evolution".' }
          ]
        }
      ],
      [
        {
          ...
          paragraphs: ['A','B','C','D','E','F','G'],
          items: [
            { q: 'A reference to a famous patient who could not form new long-term memories.', answer: 'C', explain: 'Doan C: benh nhan H.M.' },
            { q: 'Information about how false memories can be created in people.', answer: 'D', explain: 'Doan D: Loftus.' },
            { q: 'A description of an ancient technique used to memorise speeches.', answer: 'F', explain: 'Doan F: method of loci.' },
            { q: 'A reference to the limited capacity of short-term memory.', answer: 'B', explain: 'Doan B: Miller ~7 muc.' },
            { q: 'The claim that forgetting can sometimes be useful.', answer: 'E', explain: 'Doan E: quen huu ich.' },
            { q: 'A discussion of how digital devices affect the way we remember.', answer: 'G', explain: 'Doan G: Google effect.' }
          ]
        },
        {
          group: 'Questions 33–36',
          ...
          instruction: 'Choose the correct letter, A, B, C or D.',
          items: [
            { q: 'According to the passage, human memory is best described as:', options: ['A. a perfect recording of events', 'B. an active, reconstructive process', 'C. limited entirely to short-term storage', 'D. completely unaffected by suggestion'], answer: 'B', explain: 'Doan A/D: tri nho la qua trinh tai dung.' },
            { q: 'The case of patient H.M. demonstrated that:', options: ['A. memory is stored in a single location', 'B. the hippocampus is essential for forming new long-term memories', 'C. short-term memory has unlimited capacity', 'D. memories never fade with time'], answer: 'B', explain: 'Doan C: mat hippocampus → khong tao tri nho dai han moi.' },
            { q: 'The "testing effect" refers to the finding that:', options: ['A. tests mainly cause anxiety', 'B. retrieving information strengthens memory more than rereading', 'C. memory cannot be improved by practice', 'D. cramming is the best study method'], answer: 'B', explain: 'Doan F: tu kiem tra cung co tri nho hon doc lai.' },
            { q: 'The "Google effect" describes how people tend to:', options: ['A. remember far more because of the internet', 'B. remember where to find information rather than the information itself', 'C. stop using search engines entirely', 'D. develop larger memories than past generations'], answer: 'B', explain: 'Doan G: nho NOI tim thong tin.' }
          ]
        },
        {
          group: 'Questions 37–40',
          ...
          instruction: 'Complete the sentences below. Choose NO MORE THAN TWO WORDS from the passage for each answer.',
          items: [
            { q: 'According to George Miller, short-term memory can hold only about __________ items at once.', answer: 'seven', explain: 'Doan B: "about seven items".' },
            { q: 'The brain region essential for forming new long-term memories is the __________.', answer: 'hippocampus', explain: 'Doan C: "the hippocampus".' },
            { q: 'Elizabeth Loftus showed that people can develop entirely __________ memories of events that never happened.', answer: 'false', explain: 'Doan D: "entirely false memories".' },
            { q: 'The traditional technique of placing items in a familiar building is called the method of __________.', answer: 'loci', explain: 'Doan F: "the method of loci".' }
          ]
        }
      ]
    ]
    ...
    passages: [
      {
        ...
        content: `<p><span class="para-num">A</span> No question in linguistics is more controversial than how human language first emerged. Unlike fossils of ancient bones or stone tools, speech leaves no physical trace for archaeologists to study. The earliest written records date from only about 5,000 years ago, but spoken language is certainly far older than that. Scholars have proposed dates ranging from 50,000 to over a million years for the emergence of fully modern language, with no consensus in sight. So <span class="vocab" data-word="intractable" data-def="nan giải, khó xử lý">intractable</span> was this problem that in 1866 the Linguistic Society of Paris famously banned all papers on the topic, declaring it effectively unsolvable.</p>

        <p><span class="para-num">B</span> Modern researchers have approached the question from multiple angles. Comparative <span class="vocab" data-word="anatomy" data-def="giải phẫu (học)">anatomy</span> provides some clues. The human vocal tract differs from those of other primates in ways that suggest adaptation for speech: a lower <span class="vocab" data-word="larynx" data-def="thanh quản">larynx</span> position allows for the production of a wider range of sounds. However, this anatomical change may have evolved before language itself, perhaps for other reasons such as swallowing efficiency, so its presence cannot by itself date the origin of speech. Brain imaging has identified regions essential for language processing, but related structures exist in other primates, complicating attempts to pinpoint when a human-like language capacity first emerged.</p>

        <p><span class="para-num">C</span> Genetic evidence has added new dimensions to the debate. The FOXP2 gene, dubbed "the language gene" in popular media, came to attention through studies of a British family with severe speech disorders. Members affected by a <span class="vocab" data-word="mutation" data-def="sự đột biến">mutation</span> in this gene struggle with both producing and understanding language. The human version of FOXP2 differs from that of chimpanzees by just two amino acids, and these differences are thought to have spread through human populations within the last 200,000 years. However, calling FOXP2 a language gene is misleading; it appears to play roles in many aspects of motor control, not just speech. Language depends on hundreds of genes working together, not on any single one.</p>

        <p><span class="para-num">D</span> Some researchers have looked to existing primate communication for clues. Vervet monkeys produce distinct alarm calls for different predators — one for eagles, another for snakes, a third for leopards — and other monkeys respond appropriately to each. This suggests a <span class="vocab" data-word="rudimentary" data-def="sơ khai, thô sơ">rudimentary</span> form of symbolic communication. However, primate calls are largely fixed and instinctive, while human language is open-ended and learned anew by every child. The gap between these systems is enormous and may indicate that human language did not evolve gradually from primate calls but emerged through some more dramatic transformation.</p>

        <p><span class="para-num">E</span> The American linguist Noam Chomsky has long argued that the human capacity for language is uniquely complex and probably arose suddenly rather than through gradual evolution. He points to the fact that any normal child can acquire any human language with remarkable speed and accuracy, suggesting that the basic structures of language are somehow <span class="vocab" data-word="innate" data-def="bẩm sinh">innate</span>. Critics, including the cognitive scientist Steven Pinker, accept that language is partly innate but argue that this capacity must have evolved through ordinary evolutionary processes over hundreds of thousands of years, like any other complex biological adaptation.</p>

        <p><span class="para-num">F</span> Recent archaeological evidence has shifted the conversation. The emergence of complex tool-making, symbolic art, and trade networks among Homo sapiens around 70,000 years ago — often called the "cognitive revolution" — coincides with what many scholars believe was the development of fully modern language. Cave paintings, beadwork, and other early symbolic objects from this period suggest that the underlying cognitive abilities supporting language were already in place. Some researchers argue that this represents not the origin of language but a fundamental change in how it was used, perhaps the emergence of grammar capable of expressing abstract and hypothetical thoughts.</p>

        <p><span class="para-num">G</span> What seems increasingly clear is that no single answer will satisfy the question of language origins. Language is not a single trait but a complex of abilities — pronunciation, vocabulary, grammar, conversation, narrative — each of which may have its own evolutionary history. The cognitive, anatomical, and social changes that produced modern language likely unfolded over a very long period and involved many small steps rather than one revolutionary leap. The 1866 ban on language-origin papers was eventually rescinded, but the underlying mystery remains as intriguing as ever, and as far from a final resolution.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Throughout history, civilisations have risen, <span class="vocab" data-word="flourished" data-def="phát triển hưng thịnh">flourished</span>, and then disappeared, leaving behind <span class="vocab" data-word="ruins" data-def="tàn tích, phế tích">ruins</span> that capture the imagination of subsequent generations. The discovery of lost cities and forgotten kingdoms has been one of the most romantic pursuits of archaeology, often combining serious scientific investigation with elements of treasure hunting and adventure. Yet behind these dramatic discoveries lies a more sober reality: most lost civilisations were not so much discovered as rediscovered, having always been known to the people whose ancestors built them or who lived near their remains long after they were abandoned.</p>

        <p><span class="para-num">B</span> The case of Petra, the ancient Nabataean city carved from rose-coloured cliffs in modern Jordan, illustrates this pattern. The Swiss explorer Johann Ludwig Burckhardt is widely credited with "discovering" Petra in 1812 — but Bedouin people had been living among and around the ruins for centuries before he arrived. They knew exactly where the city was; they had simply never told European outsiders. Burckhardt's achievement was not so much finding Petra as bringing it to European attention, which he did by disguising himself as a Muslim pilgrim and persuading local guides to lead him to the site. The story of his "discovery" reveals as much about European attitudes as about archaeology itself.</p>

        <p><span class="para-num">C</span> Similar patterns appear in many other famous archaeological discoveries. The American adventurer Hiram Bingham III did not so much find Machu Picchu in 1911 as become the first outsider to publicise its existence to the wider world. Local Quechua people had known about the Inca site throughout the centuries since its abandonment, and at least one previous European visitor had reached it without recognising its significance. The temples of Angkor in Cambodia, sometimes described as "rediscovered" by the French naturalist Henri Mouhot in 1860, had been known to local people and visited by various foreign travellers for centuries before Mouhot arrived to describe them for European readers.</p>

        <p><span class="para-num">D</span> The story of the ancient city of Troy demonstrates how the dramatic narrative of archaeological discovery can sometimes overshadow the actual evidence. Heinrich Schliemann, a wealthy German businessman with no formal archaeological training, claimed to have discovered the historical Troy in the 1870s. His excavations at Hisarlik in modern Turkey were carried out with little of the careful <span class="vocab" data-word="methodology" data-def="phương pháp luận">methodology</span> that would later become standard in archaeology. Schliemann's enthusiastic but destructive digging probably eliminated evidence that more patient <span class="vocab" data-word="excavation" data-def="sự khai quật">excavation</span> would have preserved, and many of his most famous claims have since been questioned by later researchers. Yet his romantic story continues to dominate popular understanding of how Troy was found.</p>

        <p><span class="para-num">E</span> Some lost civilisations have been discovered through more recent and sometimes accidental means. The Terracotta Army of China, one of the most spectacular archaeological finds of the twentieth century, was discovered in 1974 by Chinese farmers digging a well. The thousands of life-sized clay warriors guarding the tomb of the first Chinese emperor had remained completely unknown for over two thousand years. Sometimes, modern technology reveals what traditional methods missed. Satellite imagery, ground-penetrating radar, and other remote-sensing technologies have identified hundreds of previously unknown archaeological sites in recent decades, including substantial settlements hidden beneath Cambodian jungles and in the Amazon basin.</p>

        <p><span class="para-num">F</span> The reasons civilisations are lost are as varied as the civilisations themselves. Environmental <span class="vocab" data-word="degradation" data-def="sự suy thoái">degradation</span> has been blamed for the collapse of many ancient societies, including the Maya civilisation in Central America, which appears to have suffered drought conditions that overwhelmed its agricultural systems. Political conflicts and military defeats have erased others from the map. The cumulative effects of disease, especially when new <span class="vocab" data-word="pathogens" data-def="mầm bệnh">pathogens</span> encountered populations with no immunity, devastated many indigenous American civilisations following European contact. Climate change, both natural and human-caused, has played roles ranging from minor to decisive in different cases.</p>
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> The concept of emotional intelligence, often shortened to EI or EQ, has become one of the most influential ideas in modern psychology and business. First <span class="vocab" data-word="popularised" data-def="phổ biến hóa">popularised</span> by the science journalist Daniel Goleman in his 1995 bestseller, the idea suggested that traditional measures of intelligence — IQ tests and academic achievement — captured only part of what makes people successful in life. Equally important, according to Goleman, are the abilities to understand and manage emotions in oneself and in others. Although the concept has faced significant criticism, it has profoundly influenced how we think about education, leadership, and personal development.</p>

        <p><span class="para-num">B</span> Emotional intelligence as a formal psychological concept was developed by the researchers Peter Salovey and John Mayer in academic papers published in the late 1980s and early 1990s. They defined it as <span class="vocab" data-word="comprising" data-def="bao gồm">comprising</span> four related abilities: perceiving emotions in oneself and others, using emotions to facilitate thinking, understanding the meanings and causes of emotions, and managing emotions effectively. This original formulation was relatively narrow and, importantly, testable. Goleman's subsequent popularisation expanded the concept considerably, adding components such as motivation, social skills, and empathy that were less precisely defined and harder to measure.</p>

        <p><span class="para-num">C</span> Research has linked higher levels of emotional intelligence to numerous positive outcomes. Studies of students have found that emotional intelligence correlates with academic performance, even after controlling for traditional measures of intelligence. Workers with higher emotional intelligence tend to receive better performance evaluations and to advance further in their careers. Marriages and friendships involving people with higher emotional intelligence tend to be more stable and satisfying. Health outcomes also appear better for emotionally intelligent individuals, possibly because they manage stress more effectively over the long term.</p>

        <p><span class="para-num">D</span> Despite its popularity, emotional intelligence has faced substantial scientific criticism. Critics point out that the concept overlaps heavily with established personality traits, particularly <span class="vocab" data-word="conscientiousness" data-def="tính tận tâm, chu đáo">conscientiousness</span> and agreeableness, which can be measured more precisely. The <span class="vocab" data-word="methodologies" data-def="các phương pháp luận">methodologies</span> used to test emotional intelligence have also been questioned. Some tests rely on people's judgements about their own abilities, which may reflect self-perception more than actual skill. Other tests use scenarios in which there is no clearly correct answer, raising questions about what they really measure. Whether emotional intelligence represents a coherent ability distinct from personality and intelligence remains debated among researchers.</p>

        <p><span class="para-num">E</span> The application of emotional intelligence in workplace settings has been particularly enthusiastic. Many companies now use emotional intelligence assessments in hiring and promotion decisions, and provide training programmes intended to develop these skills in their staff. The research evidence supporting the effectiveness of such programmes is mixed at best. Some studies have found significant improvements in employee behaviour and team functioning following emotional intelligence training, while others have found minimal effects. The commercial market for emotional intelligence services may have grown considerably faster than the scientific evidence supporting their value.</p>

        <p><span class="para-num">F</span> Cultural differences in emotional expression and recognition present another challenge for emotional intelligence research. Most studies have been conducted in Western contexts and may not <span class="vocab" data-word="generalise" data-def="khái quát hóa">generalise</span> to other cultures. Standards for appropriate emotional expression vary considerably across societies; behaviours considered emotionally intelligent in one cultural setting may be inappropriate in another. East Asian cultures often value an emotional restraint that Western emotional intelligence frameworks might interpret as low emotional awareness. Research on emotional intelligence in non-Western contexts has lagged behind, leaving open questions about how universal the concept actually is.</p>

        <p><span class="para-num">G</span> Whatever the ultimate scientific status of emotional intelligence as a coherent psychological concept, its influence on practical thinking about human relationships and success has been substantial. The basic insight — that managing emotions effectively contributes to wellbeing and achievement — seems sound even if precise measurement remains <span class="vocab" data-word="elusive" data-def="khó nắm bắt, khó định lượng">elusive</span>. Schools have introduced curricula focused on developing emotional skills in children. Therapy approaches increasingly emphasise emotional regulation as a core skill. Whether or not emotional intelligence represents a single ability that can be measured precisely, its popularisation has contributed to taking emotions seriously as legitimate subjects of study and skill development.</p>`,
    ...
    passages: [
      {
        ...
        content: `<p><span class="para-num">A</span> Every year, billions of birds undertake journeys of extraordinary length and difficulty. The Arctic tern travels from the Arctic to Antarctica and back, covering roughly 40,000 miles annually — the longest migration of any animal on Earth. Bar-tailed godwits fly non-stop for over a week from Alaska to New Zealand, a distance of more than 7,000 miles, without once landing to rest or feed. These remarkable feats of <span class="vocab" data-word="endurance" data-def="sức bền, sức chịu đựng">endurance</span> and navigation have fascinated scientists and naturalists for centuries, yet many fundamental questions about how and why birds migrate remain only partly answered.</p>

      <p><span class="para-num">B</span> Migration is driven primarily by the seasonal availability of food and suitable breeding conditions. In the <span class="vocab" data-word="temperate" data-def="ôn đới">temperate</span> and polar regions, summer brings an abundance of insects and plant growth that can support large populations of breeding birds. As autumn approaches and these resources disappear, birds that cannot survive the cold winter must move to warmer climates or starve. Species that have evolved to take advantage of these seasonal patterns now make regular journeys between breeding grounds and wintering areas, sometimes spanning entire <span class="vocab" data-word="hemispheres" data-def="các bán cầu">hemispheres</span> and crossing oceans, deserts, and mountain ranges along the way.</p>

      <p><span class="para-num">C</span> How birds navigate over such vast distances has long been one of the most puzzling questions in biology. Research has revealed that birds use multiple cues simultaneously: the position of the sun during the day, the patterns of stars at night, and even the Earth's magnetic field. Experiments in special planetariums have shown that some species learn to recognise star patterns as young birds and use this knowledge throughout their lives. Other studies have demonstrated that pigeons and several migratory species contain tiny grains of magnetite in their beaks, which may function as biological compasses, allowing them to sense direction even when the sky is hidden by cloud.</p>

      <p><span class="para-num">D</span> The <span class="vocab" data-word="physiological" data-def="(thuộc) sinh lý học">physiological</span> demands of migration are immense. Before departure, migrating birds dramatically increase their body weight by eating intensively, sometimes doubling their mass with stored fat that will fuel the journey. Some species also reduce the size of internal organs they will not need during flight, including portions of their digestive system, in order to reduce weight. Their muscles, particularly those powering the wings, undergo significant changes that increase efficiency. These transformations occur on a precise schedule controlled by changing day length and internal biological clocks that prepare the bird long before it sets off.</p>

      <p><span class="para-num">E</span> Climate change is now profoundly affecting bird migration. Many species are arriving at their breeding grounds earlier in the spring than they did decades ago, apparently responding to warmer temperatures. This sounds like a positive adaptation, but it can create serious problems. The insects and plants on which migrating birds depend may not be available at the new arrival times, leaving birds without food when they most need it to breed. Research in Europe has shown population declines in species that have failed to adjust their timing rapidly enough to keep pace with the shifting seasons.</p>

      <p><span class="para-num">F</span> Human activities pose other significant threats to migrating birds. The destruction of stopover sites — wetlands, forests, and other habitats where birds rest and refuel during their journeys — can be particularly devastating. A single critical stopover may be used by millions of birds each year, and its loss can affect populations across entire continents. Light pollution from cities <span class="vocab" data-word="disorients" data-def="làm mất phương hướng">disorients</span> migrating birds at night, leading to collisions with buildings; window strikes alone kill hundreds of millions of birds annually in North America. Hunting along migration routes continues in some regions despite international protections.</p>

      <p><span class="para-num">G</span> Conservation efforts have produced some encouraging results. The protection of key wetlands along the East Asian-Australasian flyway has helped stabilise populations of several waterbird species that had been in steep decline. Citizen-science projects have engaged millions of ordinary people in monitoring bird populations, providing data of <span class="vocab" data-word="unprecedented" data-def="chưa từng có tiền lệ">unprecedented</span> scale and resolution. Yet the challenges remain enormous. Effective protection requires international cooperation across the entire migration route — a single nation protecting its own territory cannot save birds that depend on habitats in many countries thousands of miles apart.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> The invention of writing represents one of the most <span class="vocab" data-word="consequential" data-def="có hệ quả quan trọng">consequential</span> intellectual achievements in human history. Before writing, communication was limited to those within speaking distance and to whatever could be transmitted, with inevitable distortion, through oral tradition. Writing made it possible to preserve thoughts, <span class="vocab" data-word="transactions" data-def="giao dịch">transactions</span>, and stories across time, and to communicate across vast distances without the messenger needing to understand the message. Yet despite its central importance, writing was invented independently only a few times in human history — most scholars accept four or five separate origins — making it among the rarest of major human innovations.</p>

        <p><span class="para-num">B</span> The earliest known writing system developed in ancient Mesopotamia (modern Iraq) around 3,400 BCE. The Sumerian civilisation, which had emerged in this region, created systems of symbols pressed into wet clay tablets with reed styluses to record economic transactions. This script, called <span class="vocab" data-word="cuneiform" data-def="chữ hình nêm">cuneiform</span> from its wedge-shaped marks, initially recorded mainly commercial information — quantities of grain stored, livestock owned, debts to be paid. Only gradually did writing expand from accounting to other purposes, eventually being used for religious texts, royal proclamations, and the world's first works of literature.</p>

        <p><span class="para-num">C</span> Egyptian <span class="vocab" data-word="hieroglyphic" data-def="chữ tượng hình">hieroglyphic</span> writing developed slightly later than Sumerian cuneiform, around 3,200 BCE. Whether the Egyptian invention was entirely independent or influenced by Mesopotamian developments remains debated among scholars. The hieroglyphic system combined symbols representing whole words with others representing sounds, producing one of the most visually elegant writing systems ever created. Egyptian writing was used for religious and royal purposes for over three thousand years before being gradually forgotten, only to be deciphered by the French scholar Jean-François Champollion in 1822, working from the famous Rosetta Stone.</p>

        <p><span class="para-num">D</span> Chinese writing emerged around 1,200 BCE during the Shang dynasty, the earliest examples being inscriptions on oracle bones used for divination. Unlike Western alphabets, Chinese writing uses <span class="vocab" data-word="logograms" data-def="ký tự biểu ý (đại diện cả từ)">logograms</span> — symbols representing whole words or concepts rather than individual sounds. This approach has both advantages and disadvantages compared with alphabetic systems. Chinese can be read regardless of how the reader pronounces the words, allowing speakers of mutually incomprehensible Chinese dialects to communicate in writing. However, the system requires memorising thousands of distinct characters, making full literacy significantly harder to achieve.</p>

        <p><span class="para-num">E</span> The Mesoamerican civilisations developed writing independently from Old World traditions, with the earliest examples coming from the Zapotec people of southern Mexico around 500 BCE. Mayan writing, developed by 200 BCE and reaching maturity around 250 CE, combined sound-based signs with logograms in sophisticated ways. The Maya wrote on bark-paper books, monuments, and pottery, recording historical events, astronomical observations, religious texts, and royal genealogies. Most Mayan books were destroyed by Spanish colonists in the sixteenth century, but the surviving examples reveal a fully developed literary tradition.</p>

        <p><span class="para-num">F</span> The development of alphabetic writing transformed the spread of literacy. Earlier writing systems required mastering hundreds or thousands of symbols, making literacy practical only for specialist scribes who trained for years. Alphabets, requiring memorisation of only about 20 to 30 symbols representing sounds, dramatically reduced the difficulty of learning to read and write. The first true alphabet appears to have developed among Semitic-speaking peoples in the Levant around 1,800 BCE. From this original alphabet descended the Phoenician, Hebrew, Greek, Latin, Arabic, and many other writing systems used today.</p>

        <p><span class="para-num">G</span> Writing's consequences for human societies have been profound and continuing. Written records allowed the accumulation of knowledge across generations in ways that oral traditions could never match. Religious traditions based on sacred texts became possible. Government <span class="vocab" data-word="bureaucracies" data-def="bộ máy hành chính quan liêu">bureaucracies</span> could maintain consistent administration across large territories and long periods of time. Personal communication across distance and across the centuries became possible for the first time. Even today, despite radio, television, and other communications media, written text remains central to how complex societies operate. The remarkable fact that all this depends on people scratching marks on surfaces — an innovation invented only a few times in our species' history — remains striking on reflection.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Throughout the twentieth century, economists assumed that human decision-making could be understood through the model of the "rational actor" — a hypothetical person who calmly weighs costs and benefits before choosing the option that maximises personal benefit. This assumption produced elegant economic theories and useful predictions in many situations, and it had the great advantage of being mathematically <span class="vocab" data-word="tractable" data-def="dễ xử lý, dễ tính toán">tractable</span>. Yet psychologists who actually studied how people make decisions consistently found behaviour that contradicted the rational actor model. This contradiction eventually produced a new field, behavioural economics, that has transformed our understanding of human choice.</p>

        <p><span class="para-num">B</span> The Israeli-American psychologists Daniel Kahneman and Amos Tversky, working together in the 1970s, conducted experiments that revealed <span class="vocab" data-word="systematic" data-def="có hệ thống">systematic</span> biases in human decision-making. Their work showed that people consistently make predictable errors when judging probabilities, comparing options, and reasoning about uncertain situations. These were not random mistakes that disappeared with education or careful thought; they were stable patterns built into the way human minds work. Kahneman received the Nobel Prize in Economics in 2002 — an unusual honour for a psychologist, indicating just how important this work had become for understanding economic behaviour.</p>

        <p><span class="para-num">C</span> One of the most influential findings concerns what Kahneman and Tversky called "loss aversion" — the tendency for people to feel losses more strongly than equivalent gains. Most people would refuse a gamble offering equal chances of winning or losing the same amount of money, even though a purely rational actor would be indifferent to such a bet. The pain of losing $100, research suggests, is roughly twice as intense as the pleasure of gaining $100. This <span class="vocab" data-word="asymmetry" data-def="sự bất đối xứng">asymmetry</span> has powerful implications for how people respond to investment risks, insurance offerings, and many other everyday choices.</p>

        <p><span class="para-num">D</span> Closely related is the "endowment effect" — the tendency to value things more highly when we own them than when we do not. Experiments have shown that people given a coffee mug typically demand significantly more money to sell it than they would have been willing to pay to buy the same mug only minutes earlier. From the rational actor perspective, this makes no sense; the value of the mug should be the same whether one happens to own it or not. From the psychology of loss aversion, however, the pattern makes perfect sense — giving up the mug feels like a loss, while never buying it would merely have felt like a non-gain.</p>

        <p><span class="para-num">E</span> Behavioural research has also revealed how easily people can be influenced by the way choices are presented. Identical options can produce different decisions depending on how they are described — what behavioural economists call "<span class="vocab" data-word="framing" data-def="sự định khung (cách trình bày)">framing</span> effects". A medical procedure described as having a 90 percent survival rate will seem more attractive than one described as having a 10 percent mortality rate, even though the underlying facts are identical. Politicians, advertisers, and other persuaders exploit these effects continuously, often without their audiences realising what is happening.</p>

        <p><span class="para-num">F</span> The practical implications of behavioural economics have led to new approaches called "choice architecture" — designing how choices are presented in order to encourage particular outcomes. The default option in a decision typically has enormous influence simply because many people accept defaults without considering the alternatives. Switching countries from requiring people to opt in to organ donation to requiring them to opt out has dramatically increased donor rates, simply by changing which choice happens automatically. Critics worry about whether such "nudging" represents helpful guidance or manipulative control, but the underlying <span class="vocab" data-word="empirical" data-def="dựa trên thực nghiệm">empirical</span> findings about default effects are not seriously disputed.</p>

        <p><span class="para-num">G</span> Behavioural economics has not replaced traditional economic analysis but has supplemented it in important ways. The rational actor model remains useful for predicting average behaviour in markets with strong competitive pressures. But understanding why individual decisions <span class="vocab" data-word="deviate" data-def="đi chệch, lệch khỏi">deviate</span> from this model, and how systematic biases can affect collective outcomes, has become essential to addressing issues from financial regulation to public health to climate change. The recognition that humans are not perfectly rational does not make us less worthy of respect; it makes us more interesting subjects of study, and more challenging participants in the social systems we have created.</p>`,
    ...
    passages: [
      {
        label: 'Reading Passage 1',
        title: 'The Science of Happiness',
        content: `<p><span class="para-num">A</span> For most of its history, psychology focused almost exclusively on what goes wrong in human minds. The field developed <span class="vocab" data-word="elaborate" data-def="phức tạp, công phu">elaborate</span> categories of mental illness and refined methods for treating depression, anxiety, and other disorders, achieving real success in relieving suffering. Yet relatively little attention was given to what makes some people <span class="vocab" data-word="thrive" data-def="phát triển mạnh, hưng thịnh">thrive</span> — to what constitutes the psychology of happiness rather than the psychology of misery. A psychologist of the mid-twentieth century could describe dozens of ways a mind might fail, but few ways it might flourish. This imbalance began to change around the turn of the millennium with the emergence of positive psychology, a movement championed by the American psychologist Martin Seligman among others, which set out to study human strengths with the same rigour previously reserved for human weaknesses.</p>

      <p><span class="para-num">B</span> Positive psychology asks fundamentally different questions from traditional clinical work. Rather than focusing on how to reduce suffering, it investigates what makes life worth living. What are the components of a happy and meaningful existence? Can these qualities be measured scientifically, in the way that symptoms of illness can be measured? And, most practically, can they be deliberately cultivated, or are they largely fixed by <span class="vocab" data-word="temperament" data-def="tính khí, khí chất">temperament</span> and circumstance? The answers emerging from this research have sometimes surprised both scientists and the public, overturning assumptions that many people had taken for granted.</p>

      <p><span class="para-num">C</span> One of the most striking findings concerns the role of material wealth in happiness. Surveys conducted across many countries reveal a <span class="vocab" data-word="counterintuitive" data-def="trái với trực giác">counterintuitive</span> pattern. Within any given society, wealthier people do tend to be somewhat happier than poorer people, but this relationship is much weaker than most people assume. Once basic needs are met, additional income produces only modest gains in life satisfaction, and the pursuit of ever-greater wealth often delivers far less contentment than expected. Even more remarkably, the dramatic increase in wealth that the developed world has experienced since the 1950s has not produced any corresponding increase in average happiness. Researchers refer to this phenomenon as the "Easterlin paradox", after the economist who first identified it.</p>

      <p><span class="para-num">D</span> If money does not buy happiness beyond a certain point, what does? Research consistently identifies social relationships as among the most important factors. People with strong friendships, supportive family ties, and active community involvement report higher life satisfaction than those who lack these connections, and they also tend to live longer and recover more quickly from illness. The Harvard Study of Adult Development, which has followed hundreds of men for over eight decades, found that the quality of personal relationships at age fifty was a better predictor of physical and mental health at age eighty than cholesterol levels. Loneliness, the same body of research suggests, can be as damaging to health as long-recognised physical risk factors.</p>

      <p><span class="para-num">E</span> Engagement in meaningful activities also contributes substantially to happiness. The psychologist Mihaly Csikszentmihalyi coined the term "flow" to describe the state of complete absorption in a challenging but achievable task — the feeling that athletes call being "in the zone" and that scientists, artists, and craftspeople often report when fully engaged in their work. During flow, the sense of time can distort and self-consciousness fades, leaving only the activity itself. People who regularly experience flow report greater happiness than those whose lives consist primarily of passive entertainment, even when the passive activities seem, on the surface, more obviously pleasurable.</p>

      <p><span class="para-num">F</span> Perhaps the most actionable finding of positive psychology research concerns specific practices that can increase wellbeing. Regular expressions of gratitude — through writing letters of thanks, keeping a gratitude journal, or simply noting positive experiences at the end of each day — have been shown in controlled studies to produce measurable improvements in mood and life satisfaction. Acts of kindness toward others produce similar benefits, suggesting that <span class="vocab" data-word="generosity" data-def="sự rộng lượng, hào phóng">generosity</span> benefits the giver as much as the recipient. Mindfulness meditation, which involves training attention on present-moment experience without judgment, has accumulated substantial evidence for reducing anxiety and depression while increasing positive emotions, and is now recommended in many clinical settings.</p>

      <p><span class="para-num">G</span> Despite these promising findings, positive psychology has faced significant criticism. Some scholars argue that the field has overstated the <span class="vocab" data-word="malleability" data-def="tính dễ uốn nắn, dễ thay đổi">malleability</span> of happiness, ignoring the substantial role of genetic and circumstantial factors that lie beyond an individual's control. Others worry that the emphasis on individual happiness practices distracts attention from the social and economic conditions that affect wellbeing at a population level — that telling people to keep a journal is no substitute for addressing poverty or insecurity. Still, the basic insight of positive psychology — that the study of what goes right in human lives is as important as the study of what goes wrong — has fundamentally changed both research priorities and clinical practice. The science of happiness remains a young field, but it is already producing knowledge with practical relevance for how we live.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Maps have shaped how humans understand the world for as long as we have records of human thought. The earliest known maps date from about 2,500 BCE, but the idea of representing space visually probably emerged much earlier, perhaps as marks scratched in the ground to guide a hunting party. Throughout history, maps have served many purposes — practical guides for travel, instruments of administration and military strategy, expressions of religious or political <span class="vocab" data-word="ideology" data-def="hệ tư tưởng">ideology</span>, and tools for scientific understanding. The story of how mapmaking developed illuminates much about how cultures perceive themselves and their place in the wider world, for a map is never merely a neutral record of the land; it is always a selection of what its makers considered worth showing.</p>

        <p><span class="para-num">B</span> Ancient maps differed dramatically from modern conceptions of geographical accuracy. The Babylonian Map of the World, created around 600 BCE, places Babylon at the centre of a flat circular world surrounded by ocean and inhabited by mythical creatures. Ancient Egyptian maps show roads and irrigation systems with clear practical purpose but minimal concern for geographical <span class="vocab" data-word="proportion" data-def="tỷ lệ, cân đối">proportion</span>. The famous Roman Tabula Peutingeriana, surviving only in a medieval copy, stretches geography to fit a long thin strip, emphasising road connections and the distances between towns rather than spatial accuracy. These maps were not failed attempts at modern <span class="vocab" data-word="cartography" data-def="ngành vẽ bản đồ">cartography</span>; they reflected priorities very different from those of the present day.</p>

        <p><span class="para-num">C</span> Medieval European maps were dominated by religious concerns. The famous mappae mundi placed Jerusalem at the centre of the world, often depicted as a round disc divided into three continents. East was placed at the top — explaining the modern word "orientation" — because Paradise was believed to lie in the east. Such maps were intended less as practical guides for the traveller than as statements about how Christians should understand the world's spiritual organisation, with biblical scenes filling the spaces between the few known places. Geographical accuracy in our modern sense was simply not the primary purpose.</p>

        <p><span class="para-num">D</span> Two major developments transformed European mapmaking from the fifteenth century onward. The recovery of ancient Greek geographical works, particularly Ptolemy's "Geography" with its mathematical <span class="vocab" data-word="projection" data-def="phép chiếu (bản đồ)">projection</span> systems, gave mapmakers new theoretical tools for representing a curved Earth on a flat sheet. At the same time, the age of European exploration produced enormous demand for accurate sea charts, since errors could lead to shipwreck and economic loss. Cartographers like Gerardus Mercator developed map projections specifically designed for navigation, accepting distortions of land masses in exchange for navigationally useful properties. Mercator's 1569 world map, despite well-known distortions making polar regions appear enormous, remained the standard for centuries.</p>

        <p><span class="para-num">E</span> Maps have always been used for political purposes, often subtly. The choice of what to include or exclude, how to label features, what to place at the centre and what to push to the margins — all such choices express political positions. Maps drawn during colonial periods routinely showed European nations at impressive sizes while marginalising other regions. The Mercator projection, used in many classroom maps throughout the twentieth century, has been criticised for making Europe and North America appear larger relative to equatorial regions like Africa than they actually are. Even modern maps, despite their apparent objectivity, embed political assumptions about what matters in geography and whose perspective is treated as standard.</p>

        <p><span class="para-num">F</span> The development of detailed <span class="vocab" data-word="topographic" data-def="(thuộc) địa hình">topographic</span> surveys revolutionised what maps could show. The British Ordnance Survey, established in 1791 for military purposes, eventually produced detailed maps of the entire United Kingdom, recording every road, building and contour of the land. Similar national mapping organisations developed in other countries as governments recognised the strategic and administrative value of accurate geographic knowledge. By the early twentieth century, governments could produce maps accurate to within metres, transforming everything from urban planning to agricultural management. The cost of producing such surveys was enormous, but the value to societies that conducted them was even greater.</p>

        <p><span class="para-num">G</span> Modern digital mapping has transformed humans' relationship with geographic information. Satellite imaging provides views of Earth that earlier mapmakers could only imagine. GPS technology allows continuous precise positioning anywhere on the planet. Online mapping services like Google Maps have made detailed geographic information available to anyone with internet access, updated almost in real time. Smartphone navigation has made paper maps largely <span class="vocab" data-word="obsolete" data-def="lỗi thời, lạc hậu">obsolete</span> for everyday use. These transformations have happened so quickly that humans are still adjusting to the implications — both the practical benefits and the loss of certain kinds of geographic intuition that previous generations developed from working with traditional maps.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Humans are storytelling creatures. Every culture ever documented has developed traditions of narrative, from mythological <span class="vocab" data-word="epics" data-def="sử thi, anh hùng ca">epics</span> to bedtime stories to gossip about neighbours. Long before writing existed, people gathered to recount the deeds of ancestors and the origins of the world. Modern researchers estimate that adults spend roughly one-third of their waking hours either telling, reading, watching, or thinking about stories. Yet this universal human activity has only recently begun to receive serious scientific attention. What does the science of storytelling reveal about why narratives so powerfully engage human minds?</p>

        <p><span class="para-num">B</span> The first thing scientific research reveals is that stories activate brain networks differently from other kinds of information. When people listen to stories, brain imaging shows <span class="vocab" data-word="simultaneous" data-def="đồng thời, cùng lúc">simultaneous</span> activity in regions involved in language processing, emotional response, sensory imagination, and what neuroscientists call "theory of mind" — the capacity to understand other people's mental states. A dry list of facts lights up only the language areas; a single <span class="vocab" data-word="compelling" data-def="cuốn hút, có sức thuyết phục">compelling</span> story can activate brain regions that no other type of cognitive task engages simultaneously. This suggests that storytelling engages multiple cognitive systems in coordinated ways, which may be why a well-told tale feels so much more vivid than a plain report of the same events.</p>

        <p><span class="para-num">C</span> One important finding concerns what researchers call "narrative transportation" — the absorbed state listeners or readers enter when fully engaged with a story. When transported, people's sense of their own surroundings can fade as they imagine the world the story describes. Studies have shown that narratively transported readers may respond emotionally to fictional events as if they were real, lose track of time, and even briefly forget where they actually are. The more vividly a person is transported, the more likely their beliefs and attitudes are to shift in line with the story. This state of cognitive engagement helps explain why stories so effectively communicate ideas and influence attitudes.</p>

        <p><span class="para-num">D</span> Stories appear to have evolved as effective tools for <span class="vocab" data-word="transmitting" data-def="truyền tải, truyền đạt">transmitting</span> practical knowledge. Information embedded in narrative form is remembered far better than the same facts presented in isolation, because a story links events into a chain of cause and effect that the mind can follow and retain. People who could remember stories about how predecessors had handled dangers or opportunities would have enjoyed practical advantages over those who could not. This may explain why almost every traditional culture has developed extensive oral traditions, with elders transmitting their accumulated wisdom through stories rather than abstract teachings. The cognitive equipment for processing stories appears to be a deep feature of human evolution.</p>

        <p><span class="para-num">E</span> Stories also serve crucial social functions. Shared narratives create community by giving members common reference points and shared values. National myths, religious texts, and even popular entertainment all function partly to create and maintain social <span class="vocab" data-word="cohesion" data-def="sự gắn kết, cố kết">cohesion</span>, binding together people who may never meet. Researchers have found that people who share favourite stories often develop stronger social bonds, and that introducing strangers to mutually appreciated narratives can quickly create connection where none existed before. The communal element of storytelling — gathering to hear, watch, or discuss narratives together — has been a feature of human cultures from the earliest documented periods.</p>

        <p><span class="para-num">F</span> The <span class="vocab" data-word="persuasive" data-def="có sức thuyết phục">persuasive</span> power of stories has practical implications across many fields. Politicians who can frame their positions through compelling narratives often prove more effective than those who rely on abstract arguments and statistics. Advertisers have long used storytelling techniques to make their products memorable and emotionally appealing. Public health campaigns that frame information narratively typically produce more behaviour change than purely informational approaches. The legal profession, too, has developed a sophisticated understanding of how to construct narratives that persuade juries. Across these diverse domains, the principle remains consistent: stories typically influence people more powerfully than facts alone.</p>

        <p><span class="para-num">G</span> Modern technologies have transformed how stories are produced, distributed, and consumed. Recording technology preserved oral performances that would once have vanished the moment they ended. Cinema added moving images and synchronised sound; television brought storytelling into homes on a continuous basis. Streaming services and social media platforms have created environments where billions of stories compete for attention every second. Some researchers worry that the sheer volume of available narratives may reduce the depth of engagement that earlier generations brought to a smaller number of stories. Yet the basic human appetite for narrative shows no signs of diminishing. Whatever forms it takes, storytelling seems likely to remain at the heart of human experience.</p>`,
  ...
  'cam10-t1': {
    title: 'The Origins of Writing',
    topic: 'Linguistics · Biology · Psychology',
    difficulty: 'Medium',
    passages: [
      {
        label: 'Reading Passage 1',
        title: 'How Writing Began',
        content: `<p><span class="para-num">A</span> The invention of writing was one of the most <span class="vocab" data-word="consequential" data-def="có hệ quả quan trọng, hệ trọng">consequential</span> achievements in human history. Spoken language must have existed for tens of thousands of years before writing emerged, but it left no permanent record, vanishing into the air the moment it was spoken. Writing changed this fundamentally. For the first time, ideas could outlive the people who originated them, accumulate across generations, and travel far beyond face-to-face communication. The civilisations that we know best from ancient history are precisely those that developed systems of writing — a coincidence that is no coincidence at all, since without written records most of what a society knew simply disappeared with the people who knew it.</p>

      <p><span class="para-num">B</span> Writing was invented independently at least three times in human history. The earliest known system emerged in Mesopotamia around 3200 BCE, where Sumerian <span class="vocab" data-word="scribes" data-def="người chép chữ, thư lại">scribes</span> developed cuneiform script using wedge-shaped marks pressed into wet clay tablets. A similar system arose in Egypt at approximately the same time, though scholars debate whether the two developments were truly independent or influenced each other through trade and contact. The Chinese script emerged considerably later, around 1200 BCE, with no apparent connection to Middle Eastern writing. A fourth independent invention occurred in Mesoamerica before 600 BCE, where the Olmec, Maya, and other cultures developed elaborate hieroglyphic systems entirely unconnected to the Old World.</p>

      <p><span class="para-num">C</span> The first writing was not invented to record poetry, philosophy, or religious texts — uses we now most readily associate with writing — but for the much more <span class="vocab" data-word="mundane" data-def="bình thường, tầm thường">mundane</span> purpose of economic accounting. The earliest cuneiform tablets are essentially receipts: records of grain delivered, livestock counted, or workers paid. As civilisation in Mesopotamia grew more complex, the need to track these transactions reliably became urgent. Memory and oral testimony were no longer sufficient to manage the affairs of cities containing thousands of people. Writing emerged, in short, as a practical technology for managing the increasingly complex economic and administrative needs of early urban life.</p>

      <p><span class="para-num">D</span> All early writing systems began as pictographs — simple drawings representing the objects or actions they described. A sketch of an ox meant "ox"; a stylised sun meant "sun". This approach has obvious limitations: drawings can directly represent only concrete objects, not abstract concepts. To express ideas like "love", "freedom", or even ordinary grammatical words like "for" or "with", writers had to find indirect strategies. The most important solution involved using pictures for the sounds they represented — a process scholars call the rebus principle. The picture of an ox might come to represent any word that sounded like the spoken word for "ox", regardless of its actual meaning, freeing writing from the limits of literal <span class="vocab" data-word="depiction" data-def="sự khắc họa, mô tả bằng hình">depiction</span>.</p>

      <p><span class="para-num">E</span> The development of true alphabetic writing — in which each symbol represents a single sound — was a much later innovation. Most early systems were <span class="vocab" data-word="syllabaries" data-def="hệ chữ âm tiết">syllabaries</span>, in which each symbol represented a whole syllable. The Phoenicians, around 1500 BCE, developed what most scholars consider the first true alphabet, with characters representing individual consonants. This system spread through trade across the Mediterranean and was adopted by the Greeks, who added vowels to create the fully alphabetic system that would become the basis for Latin and ultimately for most modern Western writing systems. The economy of the alphabet — a mere handful of symbols — made literacy far easier to acquire than it had ever been before.</p>

      <p><span class="para-num">F</span> Different writing systems offer different trade-offs. Alphabetic systems have a small set of symbols — generally between twenty and forty — that can be learned relatively quickly. Logographic systems like Chinese require knowledge of thousands of characters for full literacy but can be read by speakers of dialects so different they cannot understand each other's speech. Syllabaries fall between these two extremes, with a hundred or so symbols typically sufficient. Each system suits some languages better than others, and there is no single best approach that works equally well for every spoken language.</p>

      <p><span class="para-num">G</span> Today, writing has been transformed beyond anything its ancient inventors could have imagined. Most communication is now electronic, and physical writing surfaces have largely given way to digital screens. Yet the fundamental principle remains exactly the same: visual symbols representing meaning, allowing communication across both time and space. Recent research using brain imaging has shown that reading engages <span class="vocab" data-word="specialised" data-def="chuyên biệt">specialised</span> neural circuits that did not exist when writing was first invented; our brains have adapted, in cultural rather than evolutionary timescales, to the demands of literacy. Whether scratched into clay tablets or glowing on a smartphone screen, writing remains one of the most powerful inventions in human history.</p>`,
        vi: `<p><strong>Đoạn A:</strong> Phát minh chữ viết là một trong những thành tựu có hệ quả lớn nhất lịch sử. Ngôn ngữ nói tồn tại hàng chục nghìn năm trước chữ viết nhưng không để lại dấu vết. Chữ viết cho phép ý tưởng tồn tại lâu hơn người tạo ra chúng.</p>
      <p><strong>Đoạn B:</strong> Chữ viết được phát minh độc lập ít nhất ba lần. Mesopotamia ~3200 TCN (chữ hình nêm Sumer); Ai Cập cùng thời (còn tranh luận có độc lập không); Trung Quốc ~1200 TCN; Trung Mỹ trước 600 TCN.</p>
      <p><strong>Đoạn C:</strong> Chữ viết đầu tiên không dùng cho thơ ca/tôn giáo mà cho mục đích bình dị: kế toán kinh tế. Bảng cuneiform sớm nhất là biên lai.</p>
      <p><strong>Đoạn D:</strong> Mọi hệ chữ sớm bắt đầu là chữ tượng hình. Để biểu đạt khái niệm trừu tượng, người ta dùng nguyên tắc rebus — dùng hình cho âm thanh nó đại diện.</p>
      <p><strong>Đoạn E:</strong> Chữ bảng chữ cái thực sự ra đời muộn hơn. Người Phoenicia (~1500 TCN) tạo bảng chữ cái đầu tiên (phụ âm); người Hy Lạp thêm nguyên âm.</p>
      <p><strong>Đoạn F:</strong> Mỗi hệ chữ có ưu nhược. Bảng chữ cái ~20-40 ký hiệu, học nhanh; chữ Trung cần hàng nghìn ký tự nhưng đọc được qua nhiều phương ngữ.</p>
      <p><strong>Đoạn G:</strong> Ngày nay chữ viết phần lớn là điện tử nhưng nguyên tắc không đổi. Nghiên cứu não cho thấy đọc dùng các mạch thần kinh chuyên biệt.</p>`
      },
      {
        label: 'Reading Passage 2',
        title: 'The Toughest Animals on Earth',
        content: `<p><span class="para-num">A</span> Among the most extraordinary animals on Earth is a creature so small that most people have never knowingly seen one. Tardigrades, commonly known as "water bears" or "moss piglets", are microscopic <span class="vocab" data-word="invertebrates" data-def="động vật không xương sống">invertebrates</span> rarely more than a millimetre long, with plump, segmented bodies and eight stubby legs ending in tiny claws. First described in 1773 by a German pastor studying them under an early microscope, tardigrades have since fascinated biologists not for their appearance but for an almost unbelievable ability: they can survive conditions that would instantly kill virtually any other form of life.</p>

      <p><span class="para-num">B</span> The secret to this resilience lies in a process called cryptobiosis. When their environment becomes hostile — too dry, too cold, or too hot — tardigrades can suspend their <span class="vocab" data-word="metabolism" data-def="sự trao đổi chất">metabolism</span> almost completely, entering a state in which the chemical processes of life effectively stop. The animal pulls in its legs, expels most of the water from its body, and curls into a tiny dehydrated ball known as a "tun". In this state, a tardigrade is not quite dead but is barely alive, capable of waiting out catastrophic conditions for years — and according to some claims, even decades — before reviving when favourable conditions finally return.</p>

      <p><span class="para-num">C</span> The feats tardigrades can survive in this <span class="vocab" data-word="dormant" data-def="ngủ đông, ngừng hoạt động">dormant</span> state are staggering. They have endured temperatures close to absolute zero, around minus 272 degrees Celsius, as well as heat above 150 degrees. They can withstand pressures many times greater than those found at the deepest point of the ocean, and doses of radiation that would be <span class="vocab" data-word="lethal" data-def="gây chết người">lethal</span> to a human thousands of times over. Most remarkably, in 2007 tardigrades became the first animals known to survive direct exposure to the vacuum and radiation of open space, when samples carried outside an orbiting spacecraft were later returned to Earth and successfully revived.</p>

      <p><span class="para-num">D</span> How tardigrades achieve these feats has only recently begun to be understood. As they dry out, many species replace the lost water in their cells with a sugar called trehalose, which forms a glass-like substance that holds delicate cellular structures in place and prevents them from collapsing. More recently, scientists discovered that tardigrades produce unique proteins found in no other animals. One of these, nicknamed Dsup, short for "damage suppressor", appears to physically shield the animal's DNA from the breaks caused by radiation and <span class="vocab" data-word="dehydration" data-def="sự mất nước">dehydration</span>, which may help explain their extraordinary tolerance of conditions that destroy the genetic material of other organisms.</p>

      <p><span class="para-num">E</span> Despite their reputation as exotic survivors, tardigrades are remarkably common and widespread. More than 1,300 species have been identified, living in habitats ranging from Himalayan mountaintops to the deep sea, and from tropical rainforests to Antarctic ice. The greatest numbers are found in the thin films of water that cling to mosses and lichens, which is why a casual search of damp moss under a microscope will very often reveal them. They are, in fact, among the most widely distributed animals on the entire planet, present almost anywhere that even temporary moisture exists.</p>

      <p><span class="para-num">F</span> It is important to understand that tardigrades do not actually thrive in extreme conditions; they merely tolerate them. A tardigrade exposed to the vacuum of space does not go about its normal business — it shuts down entirely and survives only by ceasing to live in any active sense. In their preferred state, tardigrades are ordinary aquatic animals that feed on plant cells, algae, and tiny invertebrates, and that reproduce, grow, and behave much like other small creatures. The extreme survival for which they are famous is a last-resort emergency response, not a way of life. Describing them as "extremophiles", as is sometimes done, is therefore rather misleading.</p>

      <p><span class="para-num">G</span> The unusual biology of tardigrades has attracted intense interest far beyond pure curiosity. Researchers hope that the trehalose and protective proteins allowing tardigrades to survive drying could one day be used to preserve vaccines and other fragile biological materials without <span class="vocab" data-word="refrigeration" data-def="sự làm lạnh, bảo quản lạnh">refrigeration</span>, which would be transformative for medicine in regions lacking reliable electricity. The Dsup protein is being studied for its potential to protect human cells from radiation damage. Tardigrades also feature prominently in astrobiology, the study of life beyond Earth: if such a complex animal can survive the conditions of open space, the possibility that some forms of life might endure on hostile worlds seems a little less far-fetched.</p>`,
        vi: `<p><strong>Đoạn A:</strong> Tardigrade ("gấu nước") là động vật không xương sống cực nhỏ, dưới 1mm, 8 chân. Mô tả lần đầu 1773. Nổi tiếng vì sống sót trong điều kiện giết chết hầu hết sinh vật.</p>
      <p><strong>Đoạn B:</strong> Bí mật là cryptobiosis: khi khắc nghiệt, gần như ngừng trao đổi chất, thải nước, cuộn thành quả bóng khô "tun", chờ nhiều năm rồi hồi sinh.</p>
      <p><strong>Đoạn C:</strong> Chịu gần -272°C, trên 150°C, áp suất cực lớn, phóng xạ. Năm 2007 là động vật đầu tiên sống sót khi phơi trực tiếp ngoài chân không vũ trụ.</p>
      <p><strong>Đoạn D:</strong> Cơ chế: thay nước bằng đường trehalose; protein Dsup bảo vệ ADN khỏi phóng xạ và mất nước.</p>
      <p><strong>Đoạn E:</strong> Rất phổ biến: hơn 1.300 loài, từ Himalaya đến đáy biển. Nhiều nhất trong màng nước trên rêu và địa y.</p>
      <p><strong>Đoạn F:</strong> Chúng KHÔNG phát triển mạnh trong điều kiện khắc nghiệt mà chỉ chịu đựng. Bình thường là động vật thủy sinh. Gọi là "extremophile" là sai lệch.</p>
      <p><strong>Đoạn G:</strong> Ứng dụng: bảo quản vắc-xin không cần tủ lạnh; protein Dsup bảo vệ tế bào người; sinh học vũ trụ.</p>`
      },
      {
        label: 'Reading Passage 3',
        title: 'The Psychology of Procrastination',
        content: `<p><span class="para-num">A</span> Almost everyone procrastinates. We delay starting important tasks, put off difficult decisions, and find ourselves cleaning the kitchen or scrolling through our phones when we should be working on something that genuinely matters to us. Procrastination is so familiar that we rarely examine it closely, dismissing it simply as laziness or poor time management. Yet psychological research over the past two decades has revealed that procrastination is a far more interesting and complex phenomenon than these casual explanations suggest — and that understanding it properly is the first step toward overcoming it.</p>

      <p><span class="para-num">B</span> The most important insight from recent research is that procrastination is not fundamentally about time management at all, but about the management of emotions. Researchers such as Timothy Pychyl and Fuschia Sirois have argued that we <span class="vocab" data-word="procrastinate" data-def="trì hoãn">procrastinate</span> in order to avoid the negative feelings that a particular task <span class="vocab" data-word="arouses" data-def="khơi gợi, gây ra (cảm xúc)">arouses</span> — boredom, anxiety, frustration, self-doubt, or the fear of failing. Putting the task off provides immediate relief from these uncomfortable emotions, which makes us feel better in the short term. Procrastination, in this view, is essentially a strategy for repairing one's mood in the present moment, at the expense of one's future self.</p>

      <p><span class="para-num">C</span> This emotional account is supported by what is known about the brain. Decisions about whether to act now or later involve a kind of tug-of-war between two systems. The limbic system, an ancient part of the brain associated with emotions and the pursuit of immediate rewards, pushes us toward whatever feels good right now. The prefrontal cortex, a more recently evolved region responsible for planning and self-control, tries to keep us focused on our longer-term goals. When the emotional pull of avoidance is strong and our capacity for self-control is <span class="vocab" data-word="depleted" data-def="cạn kiệt, suy giảm">depleted</span> — by tiredness, stress, or distraction — the limbic system tends to win, and we procrastinate.</p>

      <p><span class="para-num">D</span> A related factor is the way human beings value the present over the future. We tend to give far more weight to immediate rewards than to future ones, a tendency that economists and psychologists call temporal discounting. A small reward available now often feels more <span class="vocab" data-word="compelling" data-def="hấp dẫn, cuốn hút mạnh">compelling</span> than a much larger reward available later. The psychologist Hal Hershfield has shown, using brain-imaging studies, that many people think about their future selves almost as though they were different people — strangers whose interests feel less pressing than their own. If the person who will suffer the consequences of today's delay feels like someone else entirely, it becomes much easier to leave the work for them to deal with.</p>

      <p><span class="para-num">E</span> The consequences of <span class="vocab" data-word="chronic" data-def="kinh niên, mãn tính">chronic</span> procrastination extend well beyond missed deadlines. Studies have linked persistent procrastination to higher levels of stress, anxiety, and even physical health problems, including poorer sleep and weaker immune function. Procrastinators often experience increasing stress as deadlines approach, along with guilt and self-criticism about their own behaviour. Ironically, the very strategy that provides short-term emotional relief tends to produce greater emotional distress over the longer term. Far from being a harmless habit, procrastination can become a genuinely self-defeating cycle that undermines both wellbeing and achievement.</p>

      <p><span class="para-num">F</span> Fortunately, research also points toward strategies that genuinely help. Perhaps the most surprising finding is that self-compassion — treating oneself with kindness rather than harsh self-criticism after procrastinating — actually reduces future procrastination, whereas guilt and self-blame tend to make it worse. Breaking large, intimidating tasks into small, concrete steps reduces the negative emotions that trigger avoidance. Forming specific plans about exactly when and where one will act, a technique researchers call implementation intentions, has been shown to be remarkably effective. Reducing the temptations within easy reach — putting the phone in another room, for instance — removes the easy escape routes that procrastination depends upon.</p>

      <p><span class="para-num">G</span> It is tempting to blame modern technology for procrastination, and there is no doubt that smartphones and streaming services offer more immediate, effortless distractions than any previous generation faced. Yet procrastination is far from a modern invention. The ancient Greek poet Hesiod warned against putting off work until tomorrow nearly three thousand years ago, and the Roman statesman Cicero condemned procrastination in the conduct of public affairs. The tendency appears to be a deep feature of human psychology rather than a product of any particular era. What has changed is not the impulse to delay but the sheer <span class="vocab" data-word="abundance" data-def="sự dồi dào, phong phú">abundance</span> of tempting alternatives now available to satisfy it.</p>`,
        vi: `<p><strong>Đoạn A:</strong> Hầu như ai cũng trì hoãn. Ta coi đó là lười biếng hay quản lý thời gian kém, nhưng nghiên cứu tâm lý 20 năm qua cho thấy trì hoãn phức tạp hơn nhiều.</p>
      <p><strong>Đoạn B:</strong> Phát hiện quan trọng nhất: trì hoãn không phải quản lý thời gian mà là quản lý CẢM XÚC — né tránh cảm xúc tiêu cực (Pychyl, Sirois).</p>
      <p><strong>Đoạn C:</strong> Não bộ: giằng co giữa hệ viền (limbic) và vỏ não trước trán (prefrontal cortex). Khi tự chủ cạn kiệt, hệ viền thắng.</p>
      <p><strong>Đoạn D:</strong> Temporal discounting: coi trọng phần thưởng hiện tại hơn tương lai. Hershfield: nhiều người nghĩ về "bản thân tương lai" như người lạ.</p>
      <p><strong>Đoạn E:</strong> Hậu quả: stress, lo âu, vấn đề sức khỏe; là vòng luẩn quẩn tự hủy hoại.</p>
      <p><strong>Đoạn F:</strong> Giải pháp: lòng tự trắc ẩn thay vì tự chỉ trích; chia nhỏ việc; "implementation intentions"; giảm cám dỗ trong tầm với.</p>
      <p><strong>Đoạn G:</strong> Không thể đổ lỗi hoàn toàn cho công nghệ: Hesiod và Cicero đã lên án trì hoãn từ cổ đại. Đây là đặc điểm sâu xa của tâm lý người.</p>`
      }
    ],
    questions: [
      [
      ...
      [
        {
          ...
          instruction: 'Reading Passage 2 has seven paragraphs, A-G. Choose the correct heading for each paragraph from the list below.',
          headings: [
            { id: 'i', text: 'The chemistry behind their survival' },
            { id: 'ii', text: 'Surviving the impossible: feats in extreme conditions' },
            { id: 'iii', text: 'An introduction to a tiny but hardy creature' },
            { id: 'iv', text: 'Tolerating extremes rather than preferring them' },
            { id: 'v', text: 'How widespread and varied tardigrades are' },
            { id: 'vi', text: 'The dormant state that makes survival possible' },
            { id: 'vii', text: 'Potential practical uses of tardigrade biology' },
            { id: 'viii', text: 'How tardigrades reproduce and grow' },
            { id: 'ix', text: 'Predators and threats facing tardigrades' }
          ],
          items: [
            { q: 'A', answer: 'iii', explain: 'Đoạn A giới thiệu sinh vật nhỏ bé nhưng cứng cỏi.' },
            { q: 'B', answer: 'vi', explain: 'Đoạn B mô tả trạng thái ngủ (cryptobiosis/tun) giúp sống sót.' },
            { q: 'C', answer: 'ii', explain: 'Đoạn C liệt kê các kỳ tích chịu đựng điều kiện cực đoan.' },
            { q: 'D', answer: 'i', explain: 'Đoạn D giải thích cơ chế hóa học: trehalose và protein Dsup.' },
            { q: 'E', answer: 'v', explain: 'Đoạn E nói về số loài và môi trường sống đa dạng.' },
            { q: 'F', answer: 'iv', explain: 'Đoạn F nhấn mạnh chỉ chịu đựng chứ không ưa thích điều kiện khắc nghiệt.' },
            { q: 'G', answer: 'vii', explain: 'Đoạn G nói về các ứng dụng tiềm năng.' }
          ]
        },
        {
          group: 'Questions 21–23',
          ...
          instruction: 'Do the following statements agree with the information given in Reading Passage 2? Write TRUE, FALSE, or NOT GIVEN.',
          items: [
            { q: 'Tardigrades were the first animals shown to survive exposure to open space.', answer: 'TRUE', explain: 'Đoạn C: "in 2007 tardigrades became the first animals known to survive direct exposure to the vacuum... of open space".' },
            { q: 'Tardigrades continue their normal activities while in the vacuum of space.', answer: 'FALSE', explain: 'Đoạn F: "does not go about its normal business — it shuts down entirely".' },
            { q: 'Tardigrades can survive for longer periods in space than in the deep sea.', answer: 'NOT GIVEN', explain: 'Đoạn văn không so sánh thời gian sống sót giữa hai môi trường.' }
          ]
        },
        {
          group: 'Questions 24–26',
          ...
          instruction: 'Complete the sentences below. Choose NO MORE THAN TWO WORDS from the passage for each answer.',
          items: [
            { q: 'In a hostile environment, a tardigrade curls into a dehydrated ball known as a __________.', answer: 'tun', explain: 'Đoạn B: "curls into a tiny dehydrated ball known as a tun".' },
            { q: 'Many tardigrade species replace lost water with a sugar called __________.', answer: 'trehalose', explain: 'Đoạn D: "replace the lost water in their cells with a sugar called trehalose".' },
            { q: 'A protein nicknamed __________ appears to protect tardigrade DNA from radiation.', answer: 'Dsup', explain: 'Đoạn D: protein Dsup bảo vệ ADN khỏi phóng xạ.' }
          ]
        }
      ],
      [
        {
          ...
          paragraphs: ['A','B','C','D','E','F','G'],
          items: [
            { q: 'A reference to two brain systems that compete when we make decisions.', answer: 'C', explain: 'Đoạn C: hệ viền (limbic) và vỏ não trước trán giằng co.' },
            { q: 'The idea that people regard their future selves almost as strangers.', answer: 'D', explain: 'Đoạn D: Hershfield - future selves như những người lạ.' },
            { q: 'A description of strategies based on treating oneself with kindness.', answer: 'F', explain: 'Đoạn F: self-compassion giúp giảm trì hoãn.' },
            { q: 'A claim that procrastination is mainly about managing feelings.', answer: 'B', explain: 'Đoạn B: trì hoãn là về quản lý cảm xúc.' },
            { q: 'Evidence that procrastination existed in the ancient world.', answer: 'G', explain: 'Đoạn G: Hesiod và Cicero từ thời cổ đại.' },
            { q: 'Information linking procrastination to physical health problems.', answer: 'E', explain: 'Đoạn E: liên hệ với ngủ kém và miễn dịch yếu.' }
          ]
        },
        {
          group: 'Questions 33–36',
          ...
          instruction: 'Choose the correct letter, A, B, C or D.',
          items: [
            { q: 'According to recent research, procrastination is best understood as:', options: ['A. a simple failure of time management', 'B. a problem of managing emotions', 'C. a sign of low intelligence', 'D. a uniquely modern habit'], answer: 'B', explain: 'Đoạn B: trì hoãn là vấn đề quản lý cảm xúc.' },
            { q: 'The term "temporal discounting" refers to the tendency to:', options: ['A. forget how much time has passed', 'B. value present rewards more highly than future ones', 'C. underestimate how long a task will take', 'D. delay only unpleasant tasks'], answer: 'B', explain: 'Đoạn D: coi trọng phần thưởng hiện tại hơn tương lai.' },
            { q: 'Research on self-compassion suggests that:', options: ['A. self-criticism reduces future procrastination', 'B. treating oneself kindly reduces future procrastination', 'C. guilt is the most effective motivator', 'D. emotions have no effect on procrastination'], answer: 'B', explain: 'Đoạn F: lòng tự trắc ẩn giảm trì hoãn.' },
            { q: 'The passage suggests that procrastination:', options: ['A. was caused by the invention of smartphones', 'B. is an entirely recent phenomenon', 'C. has existed since ancient times', 'D. only affects creative people'], answer: 'C', explain: 'Đoạn G: Hesiod và Cicero cho thấy trì hoãn có từ cổ đại.' }
          ]
        },
        {
          group: 'Questions 37–40',
          ...
          instruction: 'Complete the sentences below. Choose NO MORE THAN TWO WORDS from the passage for each answer.',
          items: [
            { q: 'Procrastination involves a conflict between the limbic system and the __________ cortex.', answer: 'prefrontal', explain: 'Đoạn C: the prefrontal cortex chịu trách nhiệm lập kế hoạch và tự chủ.' },
            { q: 'Valuing present rewards over future ones is a tendency called temporal __________.', answer: 'discounting', explain: 'Đoạn D: a tendency... call temporal discounting.' },
            { q: 'Forming specific plans about when and where to act is called __________ intentions.', answer: 'implementation', explain: 'Đoạn F: a technique researchers call implementation intentions.' },
            { q: 'As deadlines approach, procrastinators often experience increasing __________.', answer: 'stress', explain: 'Đoạn E: experience increasing stress as deadlines approach.' }
          ]
        }
      ]
    ]
  ...
  'cam10-t2': {
    ...
    topic: 'History · Biology · Psychology',
    difficulty: 'Easy',
    passages: [
      {
        label: 'Reading Passage 1',
        title: 'The Global Spice Trade',
        content: `<p><span class="para-num">A</span> For most of recorded history, spices have been among the most valuable <span class="vocab" data-word="commodities" data-def="hàng hóa">commodities</span> on Earth. Black pepper, cinnamon, cloves, and nutmeg — ingredients now found in any supermarket — were once worth their weight in gold or even more. Their cultivation was restricted to a few small regions, particularly in South and Southeast Asia, while demand existed in every civilisation with the wealth to afford them. This mismatch between a tiny area of supply and a vast world of demand was the engine that drove the entire trade. The result was one of history's most dramatic and far-reaching trade networks, connecting cultures from China to Western Europe and shaping events from the rise of empires to the colonisation of distant continents.</p>

      <p><span class="para-num">B</span> The earliest evidence of long-distance spice trading dates from around 2000 BCE, when Egyptian merchants began importing cinnamon from sources thousands of miles away. The actual origin of this cinnamon remained mysterious for centuries — Egyptian and later Greek sources record fanciful stories of cinnamon being collected from the nests of giant birds, suggesting that the true sources were deliberately <span class="vocab" data-word="concealed" data-def="che giấu, giấu kín">concealed</span> by middlemen seeking to protect their monopoly. Such tales were good for business, since they discouraged competitors from seeking the source directly. Modern research has confirmed that the cinnamon used in ancient Egypt actually came from Sri Lanka and the Indonesian archipelago, transported through long and complex chains of intermediaries.</p>

      <p><span class="para-num">C</span> By Roman times, the spice trade had become enormous in scale. Roman writers complained that vast quantities of gold and silver were flowing out of the empire to pay for Eastern luxuries, including spices. Pepper, in particular, was consumed in vast quantities by wealthy Romans, who used it not only in cooking but in elaborate medicinal preparations. Some Roman recipes called for pepper in dishes ranging from main courses to desserts and even drinks. Archaeological discoveries have shown that Roman merchants travelled directly to Indian ports to acquire spices, bypassing the traditional Middle Eastern intermediaries whenever they could, in order to increase their profits.</p>

      <p><span class="para-num">D</span> The collapse of the Western Roman Empire disrupted but did not end the spice trade. Spices continued to flow westward, increasingly under the control of Arab merchants who <span class="vocab" data-word="dominated" data-def="thống trị, chi phối">dominated</span> the routes connecting Asia with Mediterranean markets. The Crusades reintroduced European elites to the pleasures of spiced food, and demand grew steadily throughout the medieval period. By the late Middle Ages, Venice and Genoa had become enormously wealthy by controlling the European end of the spice trade, while Constantinople thrived as the key point where Asian spices entered European markets. The profits were so great that control of even a single route could make a city's fortune.</p>

      <p><span class="para-num">E</span> The conquest of Constantinople by the Ottoman Turks in 1453 disrupted established trade routes and provided enormous motivation for Europeans to seek direct connections with the spice-producing regions. Vasco da Gama's 1498 voyage to India, sailing around the southern tip of Africa, marked the beginning of European attempts to control the spice trade directly. Within decades, Portuguese ships were <span class="vocab" data-word="patrolling" data-def="tuần tra">patrolling</span> the Indian Ocean, attacking the Arab merchants who had previously dominated the trade. The Portuguese were eventually displaced by the Dutch, who in turn faced fierce competition from the British and French — all of them seeking control of what was, for many centuries, among the most profitable enterprises in human history.</p>

      <p><span class="para-num">F</span> The contest for spice-trade dominance had lasting consequences. The Dutch East India Company, established in 1602 to organise Dutch spice trading, became the world's first multinational corporation and pioneered many aspects of modern capitalism, including stock markets and limited <span class="vocab" data-word="liability" data-def="trách nhiệm pháp lý (limited liability: TNHH)">liability</span>. European competition for spices led directly to the colonisation of Indonesia, the Philippines, India, and parts of Africa. Wars between European powers over the spice islands sometimes involved cruelties that would shock modern sensibilities — the Dutch massacre of the inhabitants of the Banda Islands in 1621, motivated by the desire to monopolise nutmeg production, killed roughly fifteen thousand people.</p>

      <p><span class="para-num">G</span> The romance and value of the spice trade gradually faded. As Europeans established spice <span class="vocab" data-word="plantations" data-def="đồn điền">plantations</span> in their colonies, prices fell dramatically and spices became affordable luxuries rather than precious commodities. Refrigeration and other food-preservation technologies reduced their practical importance for storing and flavouring food. By the twentieth century, most spices had become inexpensive grocery items that consumers simply took for granted. Yet the legacy of the spice trade remains immense, having shaped the global economy, transformed cuisines worldwide, and contributed to political arrangements whose consequences are still being felt today.</p>`,
        vi: `<p><strong>Đoạn A:</strong> Gia vị từng là một trong những hàng hóa giá trị nhất Trái Đất, giá bằng vàng. Việc trồng giới hạn ở vài vùng nhỏ Nam và Đông Nam Á, tạo nên mạng lưới thương mại sâu rộng nối Trung Quốc với Tây Âu.</p>
      <p><strong>Đoạn B:</strong> Bằng chứng sớm nhất ~2000 TCN (Ai Cập nhập quế). Nguồn gốc bị giấu kín bằng các câu chuyện kỳ ảo (tổ chim khổng lồ). Thực ra quế từ Sri Lanka và Indonesia.</p>
      <p><strong>Đoạn C:</strong> Thời La Mã thương mại khổng lồ. Nhà văn La Mã phàn nàn vàng bạc chảy ra ngoài. Thương nhân La Mã đi thẳng tới các cảng Ấn Độ.</p>
      <p><strong>Đoạn D:</strong> Sau khi Tây La Mã sụp đổ, thương nhân Ả Rập kiểm soát các tuyến. Venice và Genoa giàu lên nhờ kiểm soát đầu châu Âu.</p>
      <p><strong>Đoạn E:</strong> Ottoman chiếm Constantinople 1453 làm gián đoạn tuyến, thúc đẩy châu Âu tìm đường trực tiếp. Da Gama 1498 tới Ấn Độ. Bồ Đào Nha rồi Hà Lan, Anh, Pháp.</p>
      <p><strong>Đoạn F:</strong> VOC (1602) là tập đoàn đa quốc gia đầu tiên. Cạnh tranh dẫn tới thực dân hóa. Thảm sát Banda 1621 (vì nhục đậu khấu) giết ~15.000 người.</p>
      <p><strong>Đoạn G:</strong> Giá trị gia vị phai dần khi đồn điền thuộc địa làm giá giảm. Đến thế kỷ 20 gia vị thành hàng rẻ. Nhưng di sản vẫn to lớn.</p>`
      },
      {
        label: 'Reading Passage 2',
        title: 'Living Light: The Science of Bioluminescence',
        content: `<p><span class="para-num">A</span> On a dark night in certain parts of the ocean, the water itself seems to come alive with light. A breaking wave glows an eerie blue; a disturbed patch of sea sparkles like a field of stars. This phenomenon, known as <span class="vocab" data-word="bioluminescence" data-def="sự phát quang sinh học">bioluminescence</span>, is the production of light by living organisms through a chemical reaction inside their bodies. Far from being a rare curiosity, it is one of the most widespread forms of communication and survival on the planet, and it has fascinated sailors, scientists, and poets for as long as people have gone to sea.</p>

      <p><span class="para-num">B</span> The light is produced by a chemical reaction involving a molecule called luciferin, an enzyme called luciferase, and oxygen. When these combine, energy is released in the form of light rather than heat. This makes bioluminescence remarkably <span class="vocab" data-word="efficient" data-def="hiệu quả">efficient</span>: almost all of the energy becomes visible light, with very little wasted as warmth. For this reason it is often described as "cold light", in striking contrast to an ordinary light bulb, which loses most of its energy as heat. Different organisms use slightly different versions of these chemicals, producing colours that range from blue and green to, more rarely, red.</p>

      <p><span class="para-num">C</span> Bioluminescence is overwhelmingly a <span class="vocab" data-word="marine" data-def="thuộc về biển">marine</span> phenomenon. Scientists estimate that the majority of animals living in the open ocean below the sunlit surface can produce light — by some counts as many as three-quarters of them. On land it is far rarer, limited mainly to fireflies, certain fungi, and glow-worms. Curiously, it is almost entirely absent from freshwater environments such as rivers and lakes, for reasons that are still not fully understood. The deep sea, where no sunlight ever reaches, is the true home of living light.</p>

      <p><span class="para-num">D</span> The most obvious use of bioluminescence is in finding food. The deep-sea anglerfish, for example, dangles a glowing lure in front of its mouth to attract curious prey straight into its jaws. Other animals use light in the opposite way, to avoid becoming food themselves. Many small sea creatures produce a faint glow on their undersides that exactly matches the dim light filtering down from above — a trick called counter-illumination that erases their silhouette and hides them from <span class="vocab" data-word="predators" data-def="động vật săn mồi">predators</span> looking up from below.</p>

      <p><span class="para-num">E</span> Light also serves defence and communication. Some creatures release a sudden bright flash to startle an attacker, or eject a glowing cloud to confuse it while they escape. Others use a so-called "burglar alarm" strategy, glowing brightly when attacked in order to attract an even larger predator that may eat their attacker. On land, fireflies use light primarily for communication: each species flashes in its own distinctive rhythm, allowing males and females of the same species to find one another in the dark among many other species.</p>

      <p><span class="para-num">F</span> Not every glowing animal makes its own light. A great many marine creatures cannot produce light at all and instead host colonies of luminous bacteria inside special organs. The Hawaiian bobtail squid, for instance, cultivates a particular species of bacteria in a light organ on its underside, using the glow for counter-illumination. The squid provides the bacteria with nutrients and a safe home, while the bacteria provide light — a partnership that benefits both. This kind of <span class="vocab" data-word="symbiosis" data-def="sự cộng sinh">symbiosis</span> is one of the most studied examples of cooperation between animals and microbes.</p>

      <p><span class="para-num">G</span> Bioluminescence has also become a powerful tool for human science and technology. The light-producing genes of fireflies and other organisms can be inserted into other cells, where they act as visible markers showing when a particular gene is switched on, an enormously useful technique in medical and biological research. Luminous reactions are used in <span class="vocab" data-word="biosensors" data-def="cảm biến sinh học">biosensors</span> that detect bacterial contamination in food and water, glowing only when contaminants are present. Researchers have even created glowing plants in the hope that, one day, trees lit from within might replace some forms of electric street lighting.</p>`,
        vi: `<p><strong>Đoạn A:</strong> Bioluminescence (phát quang sinh học) là việc sinh vật tự tạo ánh sáng qua phản ứng hóa học trong cơ thể. Rất phổ biến, đặc biệt ở biển.</p>
      <p><strong>Đoạn B:</strong> Ánh sáng sinh ra từ luciferin + luciferase + oxy. Rất hiệu quả: gần như toàn bộ năng lượng thành ánh sáng, ít nhiệt — nên gọi là "cold light".</p>
      <p><strong>Đoạn C:</strong> Chủ yếu ở biển (tới 3/4 động vật biển sâu). Trên cạn hiếm (đom đóm, nấm, sâu phát sáng). Gần như không có ở nước ngọt.</p>
      <p><strong>Đoạn D:</strong> Dùng để tìm mồi (cá vây chân dùng mồi phát sáng) hoặc để ẩn nấp (counter-illumination — phát sáng ở bụng để xóa bóng).</p>
      <p><strong>Đoạn E:</strong> Phòng vệ và giao tiếp: phát flash dọa kẻ thù; "burglar alarm" thu hút kẻ săn mồi lớn hơn; đom đóm nhấp nháy theo nhịp riêng từng loài.</p>
      <p><strong>Đoạn F:</strong> Nhiều loài không tự phát sáng mà nuôi vi khuẩn phát quang (mực bobtail Hawaii + vi khuẩn). Đây là cộng sinh (symbiosis).</p>
      <p><strong>Đoạn G:</strong> Ứng dụng: gắn gene phát sáng làm chỉ thị nghiên cứu; biosensor phát hiện nhiễm khuẩn; cây phát sáng thay đèn đường tương lai.</p>`
      },
      {
        label: 'Reading Passage 3',
        title: 'Why We Laugh',
        content: `<p><span class="para-num">A</span> Laughter is one of the most familiar of all human behaviours, and yet for a long time it was almost entirely ignored by science. Everyone laughs, in every culture, beginning in the first months of life and long before a child can speak or understand a joke. Despite this universality, serious research into why we laugh only began in recent decades. What that research has revealed is surprising: laughter has far less to do with jokes and humour than most people assume, and far more to do with the social bonds between human beings.</p>

      <p><span class="para-num">B</span> The psychologist Robert Provine carried out some of the most influential studies of laughter simply by observing thousands of real conversations in everyday settings. His findings overturned common assumptions. People, he discovered, laugh about thirty times more often in the company of others than when they are alone. Moreover, most laughter does not follow anything that could be called a joke at all; it follows ordinary remarks like "I'll see you later" or "Are you sure?". Laughter, Provine concluded, is fundamentally a social signal rather than a response to cleverness or wit.</p>

      <p><span class="para-num">C</span> Laughter is also far older than language or humour. It appears to have evolved from the signals that young animals use during play. Great apes such as chimpanzees and gorillas produce a panting, breathy sound during tickling and rough-and-tumble play that closely resembles human laughter and is now widely regarded as its evolutionary ancestor. This suggests that laughter originated as a way of signalling that aggressive-looking play was not serious — a message meaning, in effect, "this is fun, not a fight" — long before our ancestors could tell or understand any kind of joke.</p>

      <p><span class="para-num">D</span> When researchers do turn to the question of what makes things funny, three broad theories dominate the discussion. The superiority theory, which dates back to ancient philosophers, holds that we laugh out of a feeling of superiority over others when they suffer misfortune or appear foolish. The relief theory, associated with Sigmund Freud, sees laughter as a release of built-up nervous tension. The <span class="vocab" data-word="incongruity" data-def="sự không tương xứng, nghịch lý">incongruity</span> theory, which most modern researchers favour, argues that humour arises from a mismatch between what we expect and what actually happens — the sudden, harmless violation of our expectations.</p>

      <p><span class="para-num">E</span> Not all laughter is the same. Researchers distinguish between two basic kinds. Genuine, spontaneous laughter — sometimes called Duchenne laughter, after the scientist who studied facial expressions — is <span class="vocab" data-word="involuntary" data-def="không chủ ý, vô thức">involuntary</span> and driven by real emotion. Social or polite laughter, by contrast, is <span class="vocab" data-word="voluntary" data-def="có chủ ý, tự nguyện">voluntary</span> and produced deliberately to smooth conversation and signal friendliness. Listeners are remarkably good at telling the two apart, even across different languages and cultures, which suggests that the distinction is deeply rooted in human nature rather than learned.</p>

      <p><span class="para-num">F</span> Laughter brings real physical and social benefits. It strengthens bonds between people, reduces stress, and has been shown to increase <span class="vocab" data-word="tolerance" data-def="sức chịu đựng, ngưỡng chịu">tolerance</span> of pain, partly through the release of natural painkilling chemicals called endorphins. Laughter is also strongly <span class="vocab" data-word="contagious" data-def="dễ lây lan">contagious</span>: hearing others laugh makes us far more likely to laugh ourselves, which is why television comedies once added recorded laughter to their soundtracks. This contagiousness reinforces laughter's central role as a kind of social glue, binding groups together and spreading good feeling from person to person.</p>

      <p><span class="para-num">G</span> Although laughter itself is <span class="vocab" data-word="universal" data-def="phổ quát, có ở mọi nơi">universal</span>, what people find funny varies enormously from one culture and individual to another. Humour that delights one audience may baffle or offend another, and jokes frequently fail to survive translation. There is even a recognised psychological condition, known as gelotophobia, in which sufferers experience an intense fear of being laughed at by others. Far from being a trivial subject, then, laughter turns out to be a window into human emotion, social life, and the deep evolutionary history we share with our closest animal relatives.</p>`,
        vi: `<p><strong>Đoạn A:</strong> Cười là hành vi quen thuộc nhưng từng bị khoa học bỏ qua. Ai cũng cười, mọi nền văn hóa, từ những tháng đầu đời. Nghiên cứu cho thấy cười ít liên quan đến chuyện đùa mà liên quan đến gắn kết xã hội.</p>
      <p><strong>Đoạn B:</strong> Robert Provine: người ta cười nhiều hơn ~30 lần khi có người khác so với khi ở một mình; phần lớn tiếng cười không theo sau chuyện đùa. Cười là tín hiệu xã hội.</p>
      <p><strong>Đoạn C:</strong> Cười cổ xưa hơn ngôn ngữ, tiến hóa từ tín hiệu chơi đùa của động vật. Vượn lớn (tinh tinh, khỉ đột) phát ra âm thanh giống cười khi bị cù — tổ tiên tiến hóa của tiếng cười.</p>
      <p><strong>Đoạn D:</strong> Ba lý thuyết về cái gì gây cười: superiority (cảm giác hơn người), relief (giải tỏa căng thẳng - Freud), incongruity (nghịch lý kỳ vọng - được ưa chuộng nhất).</p>
      <p><strong>Đoạn E:</strong> Hai loại cười: cười thật (Duchenne, vô thức, cảm xúc thật) và cười xã giao (có chủ ý). Người nghe phân biệt được hai loại qua mọi ngôn ngữ.</p>
      <p><strong>Đoạn F:</strong> Lợi ích: gắn kết, giảm stress, tăng ngưỡng chịu đau (endorphin). Cười dễ lây — vì sao hài kịch TV có tiếng cười thu sẵn.</p>
      <p><strong>Đoạn G:</strong> Cười là phổ quát nhưng cái gì buồn cười thì khác nhau theo văn hóa. Có chứng gelotophobia - sợ bị cười nhạo.</p>`
      }
    ],
    questions: [
      [
      ...
      [
        {
          ...
          instruction: 'Reading Passage 2 has seven paragraphs, A-G. Choose the correct heading for each paragraph from the list below.',
          headings: [
            { id: 'i', text: 'The chemistry that produces living light' },
            { id: 'ii', text: 'An introduction to nature\'s light-makers' },
            { id: 'iii', text: 'Where bioluminescence is and is not found' },
            { id: 'iv', text: 'Using light to find food or to hide' },
            { id: 'v', text: 'Light for defence and communication' },
            { id: 'vi', text: 'Borrowing light from bacteria' },
            { id: 'vii', text: 'Putting bioluminescence to work for humans' },
            { id: 'viii', text: 'The evolution of the first light-producing organisms' },
            { id: 'ix', text: 'How light pollution affects glowing species' }
          ],
          items: [
            { q: 'A', answer: 'ii', explain: 'Đoạn A giới thiệu hiện tượng phát quang sinh học.' },
            { q: 'B', answer: 'i', explain: 'Đoạn B giải thích phản ứng hóa học (luciferin, luciferase, oxy).' },
            { q: 'C', answer: 'iii', explain: 'Đoạn C nói nơi có/không có phát quang (biển nhiều, nước ngọt gần như không).' },
            { q: 'D', answer: 'iv', explain: 'Đoạn D về dùng ánh sáng để tìm mồi hoặc ẩn nấp.' },
            { q: 'E', answer: 'v', explain: 'Đoạn E về ánh sáng cho phòng vệ và giao tiếp.' },
            { q: 'F', answer: 'vi', explain: 'Đoạn F về việc nuôi vi khuẩn phát quang.' },
            { q: 'G', answer: 'vii', explain: 'Đoạn G về ứng dụng cho khoa học và công nghệ.' }
          ]
        },
        {
          group: 'Questions 21–23',
          ...
          instruction: 'Do the following statements agree with the information given in Reading Passage 2? Write TRUE, FALSE, or NOT GIVEN.',
          items: [
            { q: 'Bioluminescence is more common in the ocean than on land.', answer: 'TRUE', explain: 'Đoạn C: "Bioluminescence is overwhelmingly a marine phenomenon... On land it is far rarer".' },
            { q: 'Bioluminescent reactions produce a large amount of heat.', answer: 'FALSE', explain: 'Đoạn B: "energy is released in the form of light rather than heat... often described as cold light".' },
            { q: 'Fireflies use exactly the same chemicals as deep-sea fish to make light.', answer: 'NOT GIVEN', explain: 'Đoạn văn nói các sinh vật dùng phiên bản hóa chất khác nhau nhưng không so sánh cụ thể đom đóm với cá biển sâu.' }
          ]
        },
        {
          group: 'Questions 24–26',
          ...
          instruction: 'Complete the sentences below. Choose NO MORE THAN TWO WORDS from the passage for each answer.',
          items: [
            { q: 'The light-producing molecule in bioluminescence is called __________.', answer: 'luciferin', explain: 'Đoạn B: "a molecule called luciferin".' },
            { q: 'The Hawaiian bobtail squid produces light by hosting luminous __________.', answer: 'bacteria', explain: 'Đoạn F: "host colonies of luminous bacteria".' },
            { q: 'Because it produces almost no heat, bioluminescence is often called __________ light.', answer: 'cold', explain: 'Đoạn B: "often described as cold light".' }
          ]
        }
      ],
      [
        {
          ...
          paragraphs: ['A','B','C','D','E','F','G'],
          items: [
            { q: 'A reference to how much more often people laugh in company than alone.', answer: 'B', explain: 'Đoạn B: Provine - cười nhiều hơn ~30 lần khi có người khác.' },
            { q: 'A description of three competing theories of what makes things funny.', answer: 'D', explain: 'Đoạn D: superiority, relief, incongruity.' },
            { q: 'Evidence that laughter is shared with other primates.', answer: 'C', explain: 'Đoạn C: vượn lớn phát ra âm thanh giống cười khi bị cù.' },
            { q: 'A distinction between genuine and polite laughter.', answer: 'E', explain: 'Đoạn E: cười Duchenne (thật) vs cười xã giao (có chủ ý).' },
            { q: 'Information about the physical and social benefits of laughing.', answer: 'F', explain: 'Đoạn F: gắn kết, giảm stress, tăng ngưỡng chịu đau.' },
            { q: 'A reference to a fear of being laughed at.', answer: 'G', explain: 'Đoạn G: gelotophobia - sợ bị cười nhạo.' }
          ]
        },
        {
          group: 'Questions 33–36',
          ...
          instruction: 'Choose the correct letter, A, B, C or D.',
          items: [
            { q: 'According to Robert Provine\'s research, most laughter occurs:', options: ['A. in response to jokes', 'B. after ordinary remarks in social situations', 'C. when people are alone', 'D. during formal speeches'], answer: 'B', explain: 'Đoạn B: phần lớn tiếng cười theo sau câu nói bình thường, không phải chuyện đùa.' },
            { q: 'The incongruity theory explains humour as arising from:', options: ['A. a feeling of superiority over others', 'B. the release of nervous tension', 'C. a mismatch between expectation and outcome', 'D. physical tickling'], answer: 'C', explain: 'Đoạn D: incongruity - sự không khớp giữa kỳ vọng và thực tế.' },
            { q: 'Genuine, involuntary laughter is sometimes called:', options: ['A. social laughter', 'B. Duchenne laughter', 'C. relief laughter', 'D. polite laughter'], answer: 'B', explain: 'Đoạn E: cười thật, vô thức gọi là Duchenne laughter.' },
            { q: 'The passage suggests that what people find funny:', options: ['A. is identical across all cultures', 'B. depends only on language', 'C. varies between cultures', 'D. has no social function'], answer: 'C', explain: 'Đoạn G: cái gì buồn cười khác nhau theo văn hóa.' }
          ]
        },
        {
          group: 'Questions 37–40',
          ...
          instruction: 'Complete the sentences below. Choose NO MORE THAN TWO WORDS AND/OR A NUMBER from the passage for each answer.',
          items: [
            { q: 'Provine found that people laugh about __________ times more often in company than alone.', answer: '30', explain: 'Đoạn B: "about thirty times more often in the company of others".' },
            { q: 'Laughter probably evolved from the play signals of young __________.', answer: 'animals', explain: 'Đoạn C: "evolved from the signals that young animals use during play".' },
            { q: 'Laughing releases natural painkilling chemicals called __________.', answer: 'endorphins', explain: 'Đoạn F: "natural painkilling chemicals called endorphins".' },
            { q: 'An intense fear of being laughed at is known as __________.', answer: 'gelotophobia', explain: 'Đoạn G: "a recognised psychological condition, known as gelotophobia".' }
          ]
        }
      ]
    ]
    ...
    passages: [
      {
        label: 'Reading Passage 1',
        title: 'The Hidden World of Fungi',
        content: `<p><span class="para-num">A</span> When most people think of fungi, they picture mushrooms — the visible reproductive structures that occasionally appear on forest floors or in damp lawns. But mushrooms are merely the small visible tip of a vast hidden network. Beneath every step you take in a healthy forest, an extensive web of fungal <span class="vocab" data-word="filaments" data-def="sợi nhỏ, sợi tơ">filaments</span> called mycelium spreads through the soil, often invisible to the naked eye. A single fungal organism can extend over many square kilometres and weigh more than a hundred tonnes — placing it among the largest living things on Earth. The fungus is one of nature's most fundamental yet least understood kingdoms of life, and its true scale has only recently been appreciated.</p>

        <p><span class="para-num">B</span> Fungi occupy a unique position in the living world. They are neither plants nor animals but constitute their own biological kingdom, more closely related to animals than to plants in evolutionary terms. Unlike plants, fungi cannot <span class="vocab" data-word="photosynthesise" data-def="quang hợp">photosynthesise</span>; they obtain their energy by breaking down organic matter, whether dead leaves, fallen logs, or living tissues. Unlike animals, they do not move actively, instead growing toward food sources by extending their mycelial networks through the soil. Some fungi are microscopic, while others form structures visible from a distance. The estimated total number of fungal species is around five million, but only about 150,000 have been formally described — meaning that most of fungal diversity remains entirely unknown to science.</p>

        <p><span class="para-num">C</span> Perhaps the most remarkable aspect of fungi is their relationship with plants. The vast majority of land plants — over 90 percent — depend on partnerships with specific fungi in order to thrive. These relationships, called <span class="vocab" data-word="mycorrhizal" data-def="(thuộc) nấm rễ cộng sinh">mycorrhizal</span> associations, involve fungi attaching to plant roots and exchanging resources with them. The fungi extend the effective root area enormously, gathering water and nutrients that the plant could not reach on its own. In return, the plant supplies the fungi with sugars produced through photosynthesis. This partnership likely played a key role in the original colonisation of land by plants over 400 million years ago, and it continues to be essential to nearly all <span class="vocab" data-word="terrestrial" data-def="trên cạn, thuộc đất liền">terrestrial</span> ecosystems today.</p>

        <p><span class="para-num">D</span> Recent research has revealed that mycorrhizal networks also connect different plants to each other. Trees in a forest can share resources through underground fungal connections, with mature trees sometimes transferring sugars to young saplings struggling to grow in the shade. The Canadian ecologist Suzanne Simard, whose pioneering work in this field popularised the term "wood-wide web", has shown that these networks can transfer not only nutrients but also chemical signals warning of insect attacks or other dangers. Trees that previously seemed to be solitary competitors emerge from this research as members of complex collaborative communities, even if the balance between cooperation and competition is still being worked out.</p>

        <p><span class="para-num">E</span> Fungi also serve as the principal <span class="vocab" data-word="decomposers" data-def="sinh vật phân hủy">decomposers</span> in most ecosystems. When trees fall, leaves drop, or animals die, fungi are the primary agents that break this material down, releasing the nutrients it contains back into the soil for new growth. Without this decomposition, ecosystems would gradually choke on accumulated dead matter, and the nutrients required for new life would remain locked up in dead tissues indefinitely. Fungi can break down compounds that almost nothing else can digest, including the tough cellulose and lignin that give wood its strength. Some specialised fungi can even break down petroleum products and certain plastics, raising hopes for their use in cleaning up pollution.</p>

        <p><span class="para-num">F</span> Humans have long made practical use of fungi, often without understanding what they were using. Bread, beer, and wine all depend on fungi called yeasts that ferment sugars into alcohol and carbon dioxide. Cheese-making frequently uses moulds to produce distinctive flavours and textures. The discovery of penicillin from a mould in 1928 launched the antibiotic revolution, and many other important medicines, including statins and <span class="vocab" data-word="immunosuppressant" data-def="thuốc ức chế miễn dịch">immunosuppressant</span> drugs, were originally derived from fungal compounds. More recently, researchers have begun exploring fungi as sustainable materials for construction, packaging, and even leather substitutes.</p>

        <p><span class="para-num">G</span> Despite their importance, fungi receive far less attention than plants or animals in conservation efforts. Many fungal species are threatened by habitat destruction, climate change, and pollution, but few are formally protected by law. Some scientists argue that this neglect reflects a broader cultural blindness to the importance of fungi — an underground kingdom whose contributions to ecosystem function and human welfare remain dramatically undervalued. Greater understanding of fungi, advocates suggest, could transform our approach to medicine, agriculture, materials science, and environmental management. The mushrooms we see emerging from forest floors are only reminders of the vast unseen biological work occurring constantly beneath our feet.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Throughout history, large populations have sometimes left their homelands to settle elsewhere — a phenomenon known as mass migration. These movements have shaped the genetic makeup of populations, transformed political boundaries, and produced cultures that blend influences from multiple sources. Some migrations are well documented in historical records; others must be <span class="vocab" data-word="reconstructed" data-def="tái dựng, dựng lại">reconstructed</span> from archaeological evidence, linguistic patterns, or modern DNA studies. The reasons people migrate remain complex and much debated, but certain patterns recur throughout human history with striking regularity.</p>

        <p><span class="para-num">B</span> The most extensively studied <span class="vocab" data-word="prehistoric" data-def="tiền sử">prehistoric</span> migration is the spread of farming peoples from Anatolia (modern Turkey) into Europe, beginning around 8,000 years ago. Ancient DNA evidence has confirmed that the genetic makeup of European populations changed substantially during this period as farmers expanded westward, partly replacing and partly mixing with the hunter-gatherer populations they encountered. This migration brought not only new genetic material but also the practice of agriculture, new languages, and distinctive types of pottery. The descendants of these early farmers contributed significantly to the genetic composition of all modern Europeans, a legacy still visible in their DNA today.</p>

        <p><span class="para-num">C</span> Another remarkable prehistoric movement was the colonisation of the Pacific by Austronesian-speaking peoples beginning around 5,000 years ago. From a homeland probably in modern Taiwan or southern China, these <span class="vocab" data-word="voyagers" data-def="những người đi biển, nhà thám hiểm">voyagers</span> gradually spread across an enormous oceanic area, ultimately reaching destinations as distant as Madagascar to the west, Easter Island to the east, and New Zealand to the south. The technological achievement of these voyages, undertaken without modern navigation aids in small wooden boats, ranks among the great triumphs of human exploration. Genetic studies of modern Pacific populations confirm the basic patterns earlier described by linguistic research.</p>

        <p><span class="para-num">D</span> The reasons populations migrate are typically complex and often debated. Climate change has been blamed for many ancient movements — periods of drought or cooling temperatures driving populations to seek more favourable conditions elsewhere. Population pressure on limited resources, particularly farmland, has motivated movements throughout history. Conflict and <span class="vocab" data-word="persecution" data-def="sự ngược đãi, đàn áp">persecution</span> have produced refugee migrations in many periods, from the dispersal of religious minorities to the population movements following major wars. Economic opportunity, both real and imagined, has drawn people to new regions in every era. Often multiple factors operate simultaneously, making any single simple explanation incomplete.</p>

        <p><span class="para-num">E</span> The Bantu expansion across Africa represents one of the most significant population movements in human history. Beginning around 3,000 years ago, Bantu-speaking peoples expanded from a homeland in the modern Cameroon-Nigeria border region across much of sub-Saharan Africa. They brought with them agricultural practices, iron-working technology, and language families that today account for hundreds of related African languages. By the time European colonisers arrived, Bantu speakers had spread across an enormous area, replacing or absorbing many of the earlier populations they encountered along the way.</p>

        <p><span class="para-num">F</span> More recent migrations have been better documented and more controversial in their effects. The settlement of the Americas by Europeans, beginning around 500 years ago, transformed both continents through population movements involving tens of millions of people from Europe and Africa. Diseases brought by Europeans devastated indigenous American populations, sometimes killing 90 percent or more of affected communities within a single generation. The mass enslavement of African peoples and their forced transportation to American colonies produced one of the most significant <span class="vocab" data-word="involuntary" data-def="không tự nguyện, cưỡng bức">involuntary</span> migrations in history. The cultural and genetic consequences of these movements continue to shape the Americas today.</p>

        <p><span class="para-num">G</span> Modern migration patterns differ in important ways from earlier movements. Industrial economies create labour demands that draw migrants across long distances. International transport makes movement possible on scales that would have been unimaginable to earlier generations. National borders, supported by passport controls and visa requirements, restrict movement in ways unknown to most historical migrations. Yet despite these changes, the basic patterns of mass migration — driven by economic opportunity, environmental change, conflict, and family connections — remain remarkably similar to those documented throughout history. Whether modern democracies can manage migration humanely while addressing the legitimate concerns of host populations remains among the most <span class="vocab" data-word="contested" data-def="gây tranh cãi">contested</span> political questions of our time.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Few questions in philosophy have proven as resistant to <span class="vocab" data-word="definitive" data-def="dứt khoát, xác định">definitive</span> answers as the nature of time. Despite millennia of inquiry, philosophers continue to disagree fundamentally about what time actually is. Does time flow, in some objective sense, from past to future? Are past, present, and future equally real, or does only the present truly exist? Such questions might seem purely academic, but they connect to deeply practical concerns about personal identity, moral responsibility, and the meaning of human life, which is partly why they have never lost their grip on serious thinkers.</p>

        <p><span class="para-num">B</span> The ancient Greek philosopher Heraclitus famously declared that "no one steps in the same river twice" — emphasising the constant change and flow that seemed to him to define time and reality. His near-contemporary Parmenides took the opposite view, arguing that change itself was an illusion and that reality must consist of unchanging <span class="vocab" data-word="eternal" data-def="vĩnh cửu">eternal</span> truths. This ancient disagreement has continued through Western philosophy in various forms, with thinkers divided between those emphasising change and process and those emphasising permanence and being. Modern physics has not so much resolved this disagreement as transformed its terms.</p>

        <p><span class="para-num">C</span> The philosopher J.M.E. McTaggart, writing in 1908, proposed an influential distinction between two ways of thinking about time. The "A-series" describes events as past, present, or future — categories that shift as time passes and as the present moves forward. The "B-series" describes events as earlier than, <span class="vocab" data-word="simultaneous" data-def="đồng thời">simultaneous</span> with, or later than other events — relationships that never change whatever moment one occupies. McTaggart argued controversially that the A-series involves hidden contradictions and that consequently time itself must be unreal. Few philosophers accepted his startling conclusion, but his framework for thinking about time has influenced philosophical discussion ever since.</p>

        <p><span class="para-num">D</span> Modern philosophy of time has been profoundly shaped by Einstein's theories of relativity. Special relativity implies that there is no universal "now" shared across the entire universe — different observers moving at different velocities will disagree about which distant events are simultaneous. This appears to support a "block universe" view, in which all moments of time are equally real, with past and future no different in <span class="vocab" data-word="ontological" data-def="thuộc bản thể luận">ontological</span> status from the present. The flow of time, on this interpretation, must be an illusion produced by our limited human perception rather than a genuine feature of physical reality.</p>
        ...
        <p><span class="para-num">F</span> The question of time's nature connects directly to the problem of personal identity. If only the present is real, what justifies our sense of being the same person we were yesterday or a decade ago? Some philosophers have argued that personal identity is fundamentally unstable across time and that our sense of <span class="vocab" data-word="continuity" data-def="tính liên tục">continuity</span> is more a social and psychological construct than a <span class="vocab" data-word="metaphysical" data-def="thuộc siêu hình học">metaphysical</span> reality. Buddhist traditions, developing their own analyses of time over many centuries, reached related conclusions in arguing that the self has no fixed or permanent existence. Such philosophical conclusions, whether eastern or western, carry profound implications for how we should think about our own lives.</p>

        <p><span class="para-num">G</span> Whatever the ultimate metaphysical truth about time, human beings cannot help but live in time. We remember pasts and anticipate futures; we plan and hope and regret. The philosophical investigation of time may not change these basic features of human experience, but it can illuminate them and make us more thoughtful about them. Whether we understand ourselves as travellers through a four-dimensional landscape, or as briefly existing beings carried along by the flow of becoming, philosophers continue to debate. The questions are old, but they remain genuinely open, with real consequences for how we live our temporal lives.</p>`,
    ...
    passages: [
      {
        ...
        content: `<p><span class="para-num">A</span> Tourism has become one of the world's largest industries, generating roughly ten percent of global economic activity and supporting hundreds of millions of jobs. For many countries, particularly smaller ones with limited natural resources, tourist spending represents a vital source of foreign currency and economic opportunity. Yet alongside these benefits, the rapid growth of international tourism has created problems that are only now being seriously addressed. The phenomenon known as "overtourism" — when destinations attract more visitors than they can comfortably <span class="vocab" data-word="accommodate" data-def="chứa đựng, đáp ứng">accommodate</span> — has emerged as a defining challenge of the twenty-first-century travel industry, prompting some of the world's most famous places to question how many guests they can sustain.</p>

      <p><span class="para-num">B</span> The scale of modern tourism is unprecedented. International tourist arrivals have grown from roughly 25 million in 1950 to over 1.4 billion before the disruptions of the recent pandemic, an increase of more than five thousand percent. Air travel has become dramatically cheaper in real terms, opening up international travel to populations that could not previously have afforded it. The rise of online platforms for booking flights and accommodation has further reduced the practical barriers to international travel. The result is that destinations once visited by tens of thousands now receive millions of visitors annually, creating pressures that <span class="vocab" data-word="infrastructure" data-def="cơ sở hạ tầng">infrastructure</span> designed for far smaller populations struggles to manage.</p>

      <p><span class="para-num">C</span> Venice has become the most cited example of overtourism's consequences. The historic Italian city, with a permanent population of only about 50,000, regularly hosts 30 million tourists each year. Cruise ships, until recently the largest of which dwarfed the medieval buildings they passed, contributed enormously to visitor numbers while spending relatively little in the local economy. Property prices have been driven up by short-term rentals catering to tourists, steadily displacing the resident population. Traditional shops have given way to souvenir stores. The city has implemented various measures to manage tourism, including limits on cruise-ship access and an entrance fee for day visitors, with mixed results so far.</p>

      <p><span class="para-num">D</span> Beyond major cities, overtourism affects fragile natural environments. The Galapagos Islands, whose unique wildlife inspired Darwin's theory of evolution, must constantly balance the economic benefits of tourism against pressing conservation needs. Annual visitor numbers, once limited to a few thousand, have grown into the hundreds of thousands. Coral reefs popular with snorkellers and divers experience <span class="vocab" data-word="cumulative" data-def="tích lũy">cumulative</span> damage from boats, sunscreen chemicals, and physical contact with fragile structures. Ancient archaeological sites suffer wear from millions of visitors walking on surfaces designed to last for centuries, not for daily mass tourism.</p>

      <p><span class="para-num">E</span> The environmental costs of tourism extend well beyond local impacts. Aviation alone accounts for approximately three percent of global carbon dioxide emissions, with this share rising rapidly as flying becomes more widespread across the world. The carbon footprint of international tourism, when full <span class="vocab" data-word="lifecycle" data-def="vòng đời (toàn bộ)">lifecycle</span> effects are considered, may be considerably larger still. Hotels and resorts consume enormous quantities of water, often in regions where freshwater is already scarce. The construction of tourist infrastructure has destroyed coastal habitats and ancient landscapes that took millennia to develop. These costs are often invisible to visitors enjoying their experiences and are rarely reflected in the prices they pay.</p>

      <p><span class="para-num">F</span> Local communities frequently bear the costs of tourism while seeing only limited benefits. In many destinations, the most profitable tourist businesses are owned by multinational corporations or wealthy outsiders, with most revenue flowing out of the region rather than supporting local economies. Service workers in tourism are typically employed at low wages, often seasonally and without security. Cultural traditions can be transformed into commercial performances that gradually lose their <span class="vocab" data-word="authentic" data-def="đích thực, nguyên bản">authentic</span> meaning. Some <span class="vocab" data-word="indigenous" data-def="bản địa">indigenous</span> communities have actively resisted tourism development, arguing that the brief economic benefits cannot compensate for the long-term damage to their way of life.</p>

      <p><span class="para-num">G</span> Responses to these challenges are still being developed. Some destinations have implemented visitor limits, requiring advance bookings or charging entrance fees that discourage casual visits. Others promote "sustainable tourism" that aims to minimise environmental impact while ensuring that local communities benefit financially. Education campaigns urge tourists to consider their impacts and to behave responsibly. Whether these efforts will be sufficient to prevent the worst consequences of overtourism, while preserving the genuine benefits that tourism can provide, remains an open question. The future of one of humanity's most rapidly growing activities depends on finding workable answers.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> For most of recorded history, the trade in spices was among the most economically significant and politically important commercial activities on Earth. The exotic flavours and <span class="vocab" data-word="aromas" data-def="hương thơm">aromas</span> of pepper, cinnamon, cloves, nutmeg, and ginger were prized in cooking, medicine, and religious ceremony across Europe, the Middle East, and Asia. Yet these spices grew naturally only in a few specific locations — the islands of present-day Indonesia, the coasts of India, the highlands of Sri Lanka — meaning that the desire for spices required networks of trade spanning thousands of miles. This mismatch between where spices grew and where they were craved shaped commerce, exploration, and empire for centuries.</p>

        <p><span class="para-num">B</span> The earliest evidence of the spice trade dates back at least four thousand years. Cloves found at archaeological sites in Syria, dating from around 1700 BCE, came from islands in modern Indonesia — a distance of over 5,000 miles by the trade routes of the time. Pepper from India has been found in ancient Egyptian mummies, where it was used in preparing the dead for burial. The Roman Empire developed an extensive spice trade with India, with ships carrying gold and silver eastward and returning loaded with pepper, cinnamon, and other valuable goods. The economic impact was so significant that Roman writers expressed concern about the steady drain of currency to the East.</p>

        <p><span class="para-num">C</span> Throughout the medieval period, the spice trade was dominated by various Middle Eastern <span class="vocab" data-word="intermediaries" data-def="trung gian, người môi giới">intermediaries</span>. Arab merchants controlled the routes between Asian producers and European consumers, ultimately delivering spices to Mediterranean ports through which Italian merchants distributed them across Europe. This long chain of middlemen made spices extraordinarily expensive in European markets — at certain periods, pepper was literally worth its weight in silver. The high prices reflected the great length of the supply chain, the dangers of the journey, and the <span class="vocab" data-word="monopolies" data-def="các thế độc quyền">monopolies</span> maintained at various points along the route.</p>

        <p><span class="para-num">D</span> The desire to bypass these intermediaries motivated the great European voyages of exploration in the fifteenth and sixteenth centuries. The Portuguese explorer Vasco da Gama, reaching India by sailing around Africa in 1498, established the first direct sea route between Europe and Asia. His arrival was greeted with hostility by established Arab traders, but the new route eventually broke their monopoly. The Spanish sponsored Columbus's voyages partly to find an alternative route to the spice islands; he reached the Americas instead, but his "discovery" of new lands would have long-lasting consequences for the spice trade and for world history.</p>

        <p><span class="para-num">E</span> The Dutch and English East India Companies, founded in the early seventeenth century, used military force and political alliance to gain control of major spice-producing areas. The Dutch in particular dominated the lucrative trade in cloves and nutmeg from the Moluccas, the so-called "Spice Islands", sometimes through extraordinarily brutal methods. The 1621 massacre of the Banda Islanders by Dutch forces, sometimes described as the first colonial genocide, was motivated almost entirely by the desire to secure control over nutmeg production. The wealth generated by these companies financed the Dutch and English economic rise and helped to shape modern capitalism.</p>

        <p><span class="para-num">F</span> The spice trade declined in economic importance during the eighteenth and nineteenth centuries for several reasons. New crops cultivated in the Americas, particularly chilli peppers, provided cheaper alternatives to traditional Asian spices. The development of <span class="vocab" data-word="refrigeration" data-def="sự làm lạnh, đông lạnh">refrigeration</span> reduced the need for spices as food preservatives. Changes in fashion led European cooks toward different flavour profiles. By the time <span class="vocab" data-word="decolonisation" data-def="sự phi thực dân hóa">decolonisation</span> transformed the spice islands in the twentieth century, spices had become relatively ordinary <span class="vocab" data-word="commodities" data-def="hàng hóa">commodities</span> rather than the luxury goods of strategic importance they had once been.</p>

        <p><span class="para-num">G</span> Yet the consequences of the historical spice trade continue to shape the modern world. The colonial empires established largely in pursuit of spice profits created political boundaries that persist today. The international companies developed for the spice trade evolved into the modern corporation, with its shareholders and global reach. Cultural connections established through centuries of trade continue to influence cooking, religion, and language across enormous areas. When we sprinkle pepper on our food or buy cinnamon for baking, we engage with commodities whose history has quietly shaped the world in which we live.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Curiosity is one of the defining features of human <span class="vocab" data-word="cognition" data-def="sự nhận thức">cognition</span>. From earliest childhood, we ask questions about the world around us, explore unfamiliar environments, and seek out new experiences for no apparent immediate benefit. This drive to investigate the unknown distinguishes humans from most other animals and underlies our most important achievements as a species, from science to art to exploration. Yet despite curiosity's obvious importance, the cognitive science of why we are curious — and why curiosity sometimes fails — has only recently begun to receive serious scientific attention.</p>

        <p><span class="para-num">B</span> Curiosity appears to be driven by what researchers call the "information gap" — the difference between what we know and what we want to know. When we encounter something puzzling or surprising, our minds register the gap and become motivated to fill it. This process operates without conscious decision; we feel drawn toward information even when seeking it has no practical purpose whatsoever. Studies using brain imaging have shown that curious states activate the same neural pathways involved in processing rewards like food or money, suggesting that discovering new information is <span class="vocab" data-word="intrinsically" data-def="về bản chất, nội tại">intrinsically</span> pleasurable for the human brain.</p>

        <p><span class="para-num">C</span> The American psychologist George Loewenstein distinguished between two main types of curiosity, each with different psychological characteristics. "Epistemic curiosity" refers to the desire to understand and acquire abstract knowledge — what makes people enjoy learning about distant historical periods, scientific theories, or unfamiliar cultures. "Perceptual curiosity" refers to the response to novel sensory information — what makes us want to explore new environments, try unfamiliar foods, or watch unusual events. Both types contribute to learning and discovery, but they operate somewhat differently and may be strongest in different people.</p>

        <p><span class="para-num">D</span> Curiosity's relationship to learning is particularly important for educators and parents. Children who are curious learn more effectively, because curiosity activates the motivational and attention systems that facilitate memory formation. Educational approaches that <span class="vocab" data-word="nurture" data-def="nuôi dưỡng, bồi đắp">nurture</span> curiosity — by posing intriguing questions, encouraging exploration, and openly acknowledging the limits of current knowledge — appear to produce better learning outcomes than approaches focused purely on the transmission of information. Yet many traditional educational settings inadvertently discourage curiosity by emphasising correct answers over interesting questions, rewarding recall rather than wonder.</p>

        <p><span class="para-num">E</span> The Hungarian-American psychologist Mihaly Csikszentmihalyi's influential research on "flow states" — periods of intense engagement when challenging tasks fully absorb the attention — has identified curiosity as one of the key factors enabling such states. People become absorbed in activities that present optimal challenges to their current abilities, where curiosity about how to proceed pulls them forward through demanding tasks. This research has practical implications for designing work environments, educational experiences, and recreational activities that promote both productivity and wellbeing.</p>

        <p><span class="para-num">F</span> Yet curiosity has limits and can be <span class="vocab" data-word="inhibited" data-def="bị kìm hãm, ức chế">inhibited</span> by various factors. Anxiety appears to reduce curiosity, with people who feel threatened becoming focused on avoiding harm rather than exploring possibilities. Excessive stress, both immediate and chronic, also undermines curious engagement with the world. Even comfort can reduce curiosity when situations become too routine or predictable to hold the attention. The optimal conditions for curiosity appear to involve moderate levels of <span class="vocab" data-word="novelty" data-def="sự mới lạ">novelty</span> and challenge, supported by sufficient psychological security for a person to feel safe in exploring.</p>

        <p><span class="para-num">G</span> Modern digital technology presents complex effects on human curiosity. The instant availability of information through search engines and online resources can satisfy curiosity in ways previous generations could not have imagined. Yet some researchers argue that this very ease of access may also undermine <span class="vocab" data-word="sustained" data-def="được duy trì lâu dài">sustained</span> curious engagement, as questions become quickly answered rather than productively pursued over time. Social-media platforms that present a constant stream of new content may stimulate "shallow" curiosity at the expense of deeper inquiry. Whether digital environments will enhance or diminish the curiosity that has driven human achievement remains among the most important open questions about technology and human cognition.</p>`,
    ...
    passages: [
      {
        label: 'Reading Passage 1',
        title: 'The Lost City of Petra',
        content: `<p><span class="para-num">A</span> Hidden deep in the mountainous deserts of southern Jordan lies one of the world's most remarkable archaeological sites: the ancient city of Petra. For centuries this elaborate <span class="vocab" data-word="metropolis" data-def="đô thị lớn, thành phố lớn">metropolis</span>, with its temples and tombs carved directly into rose-red sandstone cliffs, was unknown to the outside world, surviving only in the tales of local Bedouin and in vague European rumours of a lost city in the desert. When the Swiss explorer Johann Ludwig Burckhardt rediscovered it in 1812, posing as a Muslim pilgrim to access territory closed to Europeans, he found a city that had been largely abandoned for over a thousand years. Today Petra attracts hundreds of thousands of visitors annually and stands as one of UNESCO's World Heritage Sites, as well as one of the most recognisable images of the ancient world.</p>

      <p><span class="para-num">B</span> Petra was the capital of the Nabataean kingdom, a people whose origins remain somewhat mysterious. They appear to have been Arab <span class="vocab" data-word="nomads" data-def="dân du mục">nomads</span> who gradually settled along the trade routes connecting Arabia, the Mediterranean, and Mesopotamia, abandoning a wandering life for the wealth that commerce could bring. By the fourth century BCE they had established Petra as their main centre, taking advantage of its strategic location at the intersection of major trade routes. The site was also remarkable for its defensibility — surrounded by mountains and accessed primarily through a narrow gorge called the Siq, which winds for more than a kilometre through cliffs over 80 metres high, so that a handful of defenders could control entry to the entire city.</p>

      <p><span class="para-num">C</span> The Nabataeans grew wealthy by controlling the <span class="vocab" data-word="lucrative" data-def="sinh lợi, béo bở">lucrative</span> trade in incense, particularly frankincense and myrrh, which were among the most valuable commodities of the ancient world and were burned in temples and homes from Egypt to Rome. Caravans loaded with these and other goods crossed Nabataean territory, paying tolls and acquiring supplies along the way. The kingdom's position made it possible to charge substantial fees while providing essential services such as water, food, and protection from raiders. At its peak around the first century CE, Petra may have had a population of 30,000 and was visited by traders from across the known world, making it a genuinely cosmopolitan centre.</p>

      <p><span class="para-num">D</span> The Nabataeans' most remarkable achievement was their mastery of water management in an <span class="vocab" data-word="arid" data-def="khô cằn, khô hạn">arid</span> landscape. Petra receives only about 150 millimetres of rainfall annually, almost all of it falling in a few brief winter storms, yet the city supported a substantial population and even irrigated gardens. Nabataean engineers constructed an elaborate system of dams, cisterns, and ceramic pipes that captured every available drop of water during the brief rainy season and stored it for use throughout the year. They also built channels to divert the sudden floods that could otherwise sweep through the Siq. Some of these waterworks remained in use until modern times, and recent archaeological work continues to reveal the sophistication of their hydraulic engineering.</p>

      <p><span class="para-num">E</span> Petra's famous facades, carved directly into the cliff face, show a remarkable <span class="vocab" data-word="fusion" data-def="sự kết hợp, hòa trộn">fusion</span> of architectural traditions. Greek influences are evident in the columns and pediments, while Egyptian motifs appear in the decoration. Native Arab styles are also present, and some elements show influence from as far away as India, reflecting the range of cultures the Nabataeans encountered through trade. The most famous monument, known to modern visitors as Al-Khazneh (The Treasury), was probably a royal tomb but acquired its current name from a legend that pirates had hidden treasure in its upper chambers — a story for which there is no archaeological support. Other monuments, including theatres, temples, and a vast monastery known as Ad-Deir, are scattered throughout the site, many of them reachable only after a long climb.</p>

      <p><span class="para-num">F</span> Petra's decline began with the Roman <span class="vocab" data-word="annexation" data-def="sự sáp nhập (lãnh thổ)">annexation</span> of the Nabataean kingdom in 106 CE. The Romans built roads that bypassed Petra and shifted trade toward other routes, gradually reducing its commercial importance. A devastating earthquake in 363 CE damaged many buildings and, crucially, disrupted the water systems on which the city depended. Christianity spread to Petra during the Byzantine period, and several churches were established in former pagan buildings. But by the time of the Islamic conquests of the seventh century, Petra was largely deserted. Local Bedouin people continued to live in some of the rock-cut structures for generations, but the city as a commercial and political centre had ceased to exist.</p>

      <p><span class="para-num">G</span> Modern archaeology continues to reveal new aspects of Petra. Less than fifteen percent of the ancient city has been formally excavated, and new discoveries are made regularly. Recent satellite imagery has identified buried structures that may indicate even greater complexity than previously suspected, including a large ceremonial platform unknown to earlier researchers. The site faces serious challenges from natural erosion, occasional flash floods, and the impact of mass tourism, which wears away the soft sandstone and strains the surrounding environment. Conservation work, often involving international partnerships, attempts to balance access for visitors with preservation for future generations. The full story of this remarkable city is still being uncovered, more than two thousand years after its founders shaped its first monuments.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Yawning is among the most universal of human behaviours. People yawn dozens of times each day; <span class="vocab" data-word="foetuses" data-def="bào thai">foetuses</span> yawn in the womb; people yawn upon waking and before sleeping, when bored, when tired, and sometimes apparently for no reason at all. It crosses every boundary of age and culture, and we share it with creatures as different from us as fish and birds. Yet despite this universality, the biological function of yawning remains surprisingly poorly understood. Different theories have been proposed to explain why we yawn, but none has yet gained complete scientific acceptance.</p>

        <p><span class="para-num">B</span> The most popular folk explanation for yawning — that we yawn to bring oxygen to the brain or <span class="vocab" data-word="expel" data-def="tống ra, thải ra">expel</span> carbon dioxide — has been thoroughly investigated and largely rejected by researchers. Studies in which subjects breathed pure oxygen showed that the rate of yawning did not change, contradicting the prediction that oxygen-deficient blood should trigger yawning. Nor did breathing air rich in carbon dioxide produce the increase in yawning the theory would predict. Modern research has therefore had to look elsewhere for explanations of this puzzling behaviour, with multiple competing theories attracting various degrees of evidence.</p>

        <p><span class="para-num">C</span> One leading theory, proposed by the American researcher Andrew Gallup, suggests that yawning helps cool the brain. The mechanical actions involved in yawning — the deep <span class="vocab" data-word="inhalation" data-def="sự hít vào">inhalation</span>, the stretching of facial muscles, the brief change in blood pressure — could plausibly cool the blood flowing to the brain, helping to maintain the optimal temperature for cognitive function. Studies have shown that people yawn more often when <span class="vocab" data-word="ambient" data-def="xung quanh, môi trường">ambient</span> temperatures are within a moderate range that allows yawning to cool the brain effectively, but yawn less when temperatures are very high or very low. This finding supports the cooling hypothesis, though it has not been universally accepted, and critics note that a correlation does not by itself establish the mechanism.</p>

        <p><span class="para-num">D</span> The contagious nature of yawning has fascinated researchers and led to important findings about social cognition. People who see, hear, or even read about others yawning often feel a strong urge to yawn themselves. This contagion effect has been documented in chimpanzees, dogs, and several other social species, suggesting that it represents an <span class="vocab" data-word="evolutionarily" data-def="về mặt tiến hóa">evolutionarily</span> ancient feature of social mammals. Studies have found that contagious yawning is more likely between socially close individuals — family members and close friends — than between strangers, suggesting that it may relate in some way to empathy or social bonding rather than to any simple reflex.</p>

        <p><span class="para-num">E</span> Some research has linked contagious yawning to broader empathy abilities. Children typically do not show contagious yawning until around the age of four, the same age at which various aspects of empathy begin to develop in a recognisable form. People diagnosed with certain conditions affecting social cognition, including autism spectrum disorders, sometimes show reduced contagious yawning compared with others. These observations have suggested that contagious yawning might serve as a measurable indicator of empathy or social cognitive abilities, though the relationship remains debated and the evidence is far from conclusive.</p>

        <p><span class="para-num">F</span> Researchers have found significant variation in yawning frequency and duration between species. Animals with larger brains relative to their body size generally yawn longer and more often than animals with smaller relative brains. The differences are striking — adult humans typically yawn for around six seconds, while mice yawn for only about one second. The pattern suggests that whatever yawning does, larger and more complex brains may require more of it. This finding is broadly consistent with theories that yawning serves a function related to brain maintenance or <span class="vocab" data-word="arousal" data-def="sự kích thích, hưng phấn">arousal</span> rather than to the lungs.</p>

        <p><span class="para-num">G</span> Despite considerable research, key questions about yawning remain unresolved. Whether the cooling hypothesis fully explains yawning, whether contagious yawning genuinely relates to empathy, and what role yawning plays in the transitions between sleep and wakefulness — all these questions continue to be investigated. Yawning may seem like a trivial behaviour, but it touches on important questions about how brains function, how social species coordinate their behaviour, and how seemingly simple actions can serve multiple biological purposes at once. The next time you yawn — and others around you join in — you take part in one of the more mysterious universal behaviours in human life.</p>`,
    ...
    passages: [
      {
        ...
        content: `<p><span class="para-num">A</span> Stories are everywhere in human life. We read novels for pleasure, watch films for entertainment, share gossip with our friends, and tell our children fairy tales before they sleep. We use stories to explain why we are late to work, to persuade strangers to vote for our preferred candidates, and to make sense of our own lives. Some psychologists argue that we even dream in narrative form. So <span class="vocab" data-word="pervasive" data-def="phổ biến khắp nơi">pervasive</span> is storytelling that it can be difficult to recognise just how strange this behaviour really is. No other species appears to engage in anything comparable, yet humans of every culture and time period have produced narratives in abundance.</p>

        <p><span class="para-num">B</span> The universality of storytelling has led many researchers to suspect that it serves crucial biological functions. The literary scholar Jonathan Gottschall has documented striking similarities in stories across vastly different cultures. From the traditional folk tales of Africa to modern Hollywood films, certain narrative patterns recur with remarkable consistency: <span class="vocab" data-word="protagonists" data-def="nhân vật chính">protagonists</span> struggle against difficulties, conflicts emerge and are resolved, and characters undergo meaningful transformations. These shared patterns suggest that stories may exploit fundamental features of how the human mind works — features that themselves evolved for specific purposes.</p>

        <p><span class="para-num">C</span> One leading theory holds that storytelling evolved as a form of mental <span class="vocab" data-word="rehearsal" data-def="sự diễn tập">rehearsal</span>. Stories allow us to imagine ourselves in situations we have not actually experienced and to consider how we might respond to challenges before they arise in reality. A child who hears stories about resisting strangers may be better prepared to handle dangerous encounters. An adult who follows a fictional character through a marital crisis may develop insights useful for their own relationships. This theory would explain why we are drawn most strongly to stories that involve emotional intensity and difficult choices — precisely the situations in which mental rehearsal would be most valuable.</p>

        <p><span class="para-num">D</span> A related theory emphasises the social functions of storytelling. Human beings live in larger and more complex groups than almost any other primates, requiring sophisticated abilities to track relationships, predict behaviour, and maintain cooperation. Stories may provide a kind of laboratory for developing these social skills safely. By following the experiences of fictional characters, we practise reading minds, understanding motivations, and predicting actions. Brain-imaging research has shown that following a narrative engages many of the same brain regions involved in real social interaction, lending strong support to this view.</p>

        <p><span class="para-num">E</span> Stories also play important roles in transmitting cultural knowledge across generations. Long before writing existed, human groups preserved information about hunting techniques, medicinal plants, historical events, and ethical principles through oral traditions. The narrative form helped this information remain memorable and meaningful when it might otherwise have been forgotten. Many <span class="vocab" data-word="indigenous" data-def="bản địa">indigenous</span> cultures developed elaborate storytelling systems that encoded complex environmental and practical knowledge in seemingly simple tales. Australian Aboriginal songlines, for example, preserve detailed geographical information across vast territories through narrative, encoding the location of water sources and landmarks in song.</p>

        <p><span class="para-num">F</span> The effectiveness of stories as tools of persuasion has long been recognised. Research consistently shows that information presented in narrative form is more memorable and more emotionally impactful than the same information presented as bare facts. This effectiveness has obvious advantages — making important lessons easier to remember and to learn — but it also raises serious concerns. Skilled storytellers can use narrative techniques to spread misinformation, manipulate emotions, and bypass careful reasoning. Political <span class="vocab" data-word="propaganda" data-def="tuyên truyền">propaganda</span>, advertising campaigns, and modern fake news all exploit the unique power of stories to shape belief and behaviour.</p>

        <p><span class="para-num">G</span> Digital technology is transforming both how stories are told and how they affect us. Streaming services now deliver more storytelling content than any individual could watch in a lifetime. Video games allow audiences to participate in stories rather than merely witnessing them, raising new questions about how <span class="vocab" data-word="interactive" data-def="tương tác">interactive</span> narratives affect cognitive and emotional development. Social media platforms have made everyone a storyteller, with billions of personal narratives shared daily across the world. Whether these technological changes will enhance or diminish the ancient power of storytelling to connect human beings and transmit understanding remains to be seen.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Animal migration is among the most extraordinary <span class="vocab" data-word="phenomena" data-def="các hiện tượng">phenomena</span> in the natural world. Each year, countless creatures undertake journeys of breathtaking distance and complexity, often travelling thousands of kilometres between distant locations with remarkable precision. The monarch butterfly migrates from Canada to Mexico, the Arctic tern flies from pole to pole, and humpback whales swim from polar feeding grounds to tropical breeding areas. These journeys involve navigation challenges that have puzzled scientists for centuries and that continue to reveal new mysteries even with the most modern research methods.</p>

        <p><span class="para-num">B</span> The basic question driving migration research is straightforward: how do animals know where to go, and how to get there? For animals that learn their migration routes from older members of their species, the answer involves a form of cultural <span class="vocab" data-word="transmission" data-def="sự truyền tải">transmission</span> similar to that found in human societies. Young whales accompany their mothers along migration routes for years before travelling alone. Older elephants are believed to lead their family groups along traditional pathways during long-distance movements. These social mechanisms work well when stable populations preserve the necessary knowledge across the generations.</p>

        <p><span class="para-num">C</span> Many migratory species, however, demonstrate navigation abilities that cannot be explained by learning at all. Young salmon return to the very streams where they were born after spending years at sea, even though no older fish guides them. European eels travel from rivers across Europe to the Sargasso Sea — a journey their grandparents made but which they themselves have never experienced. Most strikingly, monarch butterflies complete their entire migration cycle across multiple generations, with no individual butterfly experiencing more than one leg of the journey. The information required for these migrations must somehow be encoded genetically rather than learned.</p>

        <p><span class="para-num">D</span> The sensory cues used in animal navigation are remarkably diverse. Many birds detect the Earth's magnetic field through specialised molecules in their eyes that may respond quantum-mechanically to magnetic forces. Sea turtles use the magnetic field in combination with chemical cues to find the specific beaches where they were born. Some migratory salmon appear to remember the chemical signatures of their <span class="vocab" data-word="natal" data-def="nơi sinh, thuộc lúc sinh">natal</span> streams and recognise them even after years away. Sun position, star patterns, <span class="vocab" data-word="polarised" data-def="phân cực">polarised</span> light from the sky, and even the sound of distant ocean waves have all been shown to play roles in the navigation systems of different species.</p>

        <p><span class="para-num">E</span> Modern tracking technology has revolutionised migration research. Tiny GPS devices and radio transmitters can now be attached to animals as small as butterflies, providing detailed information about routes, speeds, and rest stops that was simply impossible to obtain through traditional observation. Recent studies using such methods have revealed a number of surprising findings: many species follow far more complex routes than previously suspected, with intermediate stopover sites that prove essential to the success of their journeys. The loss of even a single stopover habitat can disrupt an entire migration pattern.</p>

        <p><span class="para-num">F</span> Climate change poses unprecedented challenges to migratory species. The seasonal cues that trigger migration — temperature changes, daylight patterns, food availability — are shifting in ways that often disrupt traditional timing. Birds arriving at their breeding grounds may find that the insects they depend on have already peaked and declined. Sea creatures may find that ocean currents have shifted, making their traditional routes less efficient. Some species have adjusted their behaviour with remarkable speed, while others appear unable to adapt quickly enough. The long-term consequences for global <span class="vocab" data-word="biodiversity" data-def="đa dạng sinh học">biodiversity</span> may be severe.</p>

        <p><span class="para-num">G</span> Human activities present other significant threats. Light pollution disorients night-migrating birds and sea turtles, drawing them off course. Wind farms placed in migration <span class="vocab" data-word="corridors" data-def="hành lang (di chuyển)">corridors</span> can kill substantial numbers of birds and bats. Highway expansion blocks the traditional movement patterns of large mammals. The loss of habitat throughout migration routes — particularly the wetlands and forests that serve as stopover sites — creates impossible conditions for many species. Effective conservation requires international cooperation across entire migration ranges, a coordination challenge that humanity has only partially solved despite decades of effort.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> The transition from small, mobile groups of hunter-gatherers to large settled societies with cities, governments, and complex <span class="vocab" data-word="divisions" data-def="sự phân chia">divisions</span> of labour was perhaps the most significant transformation in all of human history. For most of our species' existence, we lived in groups of a few dozen people, moving regularly to follow food sources across the landscape. Then, beginning about ten thousand years ago, our ancestors began the radical experiment of staying in one place, producing food deliberately rather than gathering it, and gradually building the institutions that would eventually become civilisation. How and why this happened remains one of the most actively debated questions in archaeology.</p>

        <p><span class="para-num">B</span> The traditional account, developed in the nineteenth century and dominant for most of the twentieth, presented civilisation as a clear, <span class="vocab" data-word="linear" data-def="tuyến tính">linear</span> progression. Hunter-gatherer life was characterised as short, harsh, and uncertain. Agriculture, it was argued, provided more reliable food supplies, allowing populations to grow and societies to become larger and more complex. Cities and writing eventually followed, and from these foundations modern civilisation gradually developed. In this view, the transition to civilisation was self-evidently beneficial — an obvious improvement that any rational people would naturally embrace once it became possible.</p>

        <p><span class="para-num">C</span> Recent research has dramatically complicated this comfortable picture. Skeletal evidence from early agricultural communities consistently shows that the first farmers were shorter, less healthy, and shorter-lived than the hunter-gatherers they replaced. The wide diversity of foods available to hunter-gatherers gave way to a dependence on a small number of staple crops, often producing serious nutritional <span class="vocab" data-word="deficiencies" data-def="sự thiếu hụt">deficiencies</span>. Diseases that depended on dense human populations and close contact with domesticated animals — such as influenza, measles, and tuberculosis — emerged for the first time in the new agricultural settlements. By many measures, the lives of early farmers were actually worse than those of the hunter-gatherers who had preceded them.</p>

        <p><span class="para-num">D</span> If agriculture made life harder, why did it spread so widely? Several theories have been proposed. Population pressure may have forced people into agriculture even when they would have preferred their previous way of life — and once early farmers existed, their higher fertility rates allowed them to outcompete neighbouring hunter-gatherer groups for territory. Climate change at the end of the last ice age may have created conditions that favoured agricultural lifestyles in some regions. The development of small-scale gardening as a supplement to hunting and gathering may have led gradually to a dependence on cultivation, without any single moment of decisive change. Most likely, multiple factors operated together rather than any single cause.</p>

        <p><span class="para-num">E</span> The development of cities followed agriculture by several thousand years and presented even greater puzzles. The first cities — Uruk, Memphis, Mohenjo-Daro, and others — emerged in different regions independently between about 4000 and 2000 BCE. These were places where tens of thousands of people lived together in unprecedented densities, with elaborate social <span class="vocab" data-word="hierarchies" data-def="hệ thống thứ bậc">hierarchies</span>, organised religion, monumental architecture, and writing systems. Why did people accept the disease, conflict, and inequality that came with urban life, when the relatively healthy and <span class="vocab" data-word="egalitarian" data-def="bình đẳng">egalitarian</span> life of the village remained available as an alternative?</p>

        <p><span class="para-num">F</span> One recent theory, developed by the anthropologists David Graeber and David Wengrow, directly challenges the assumption that civilisation required hierarchical authority. Their evidence suggests that many early urban societies experimented with various forms of social organisation — including notably more egalitarian arrangements — before settling into the pyramidal hierarchies that dominated later history. Civilisations that we have traditionally interpreted as inevitably <span class="vocab" data-word="authoritarian" data-def="độc đoán, chuyên quyền">authoritarian</span> may actually have been the product of specific historical choices that could have gone differently. This research suggests that the conventional story of civilisation's development is not just incomplete but, in important respects, positively misleading.</p>

        <p><span class="para-num">G</span> Understanding the origins of civilisation has implications that reach well beyond academic interest. Modern societies face urgent questions about how to organise themselves in the face of climate change, technological disruption, and political polarisation. If we believe that civilisation always required hierarchy and inequality, we may be inclined to accept these features as simply necessary. If, however, our ancestors experimented with diverse social arrangements and made specific choices along the way, then the range of futures available to us may be far broader than we have assumed. The past, properly understood, may be more than a record of how we got here — it may also be a guide to where we might go next.</p>`,
  ...
  'cam10-t3': {
    ...
    topic: 'Biology · History · Earth Science',
    difficulty: 'Medium',
    passages: [
      { label: 'Reading Passage 1', title: 'How Birds Learn to Sing', content: `<p><span class="para-num">A</span> The dawn chorus of birdsong is one of nature's most familiar sounds, yet the way songbirds acquire their songs represents one of the most fascinating learning processes in the animal kingdom. While many animal sounds — the meow of a cat, the bark of a dog, the croak of a frog — are largely <span class="vocab" data-word="innate" data-def="bẩm sinh">innate</span> and require no learning, the songs of most birds must be carefully learned, with young birds gradually acquiring the complex sequences of notes that characterise their species. A young songbird raised in silence will never sing properly, no matter how healthy it is. This learning process has long fascinated researchers because of its striking parallels with how human children acquire spoken language.</p>

      <p><span class="para-num">B</span> Birds belong to one of only a few animal groups in which true vocal learning has been documented. Humans, songbirds, parrots, hummingbirds, certain whales and dolphins, bats, and elephants all appear to learn at least some of their <span class="vocab" data-word="vocalisations" data-def="sự phát âm, tiếng kêu">vocalisations</span> rather than producing them entirely instinctively. The fact that this capacity has evolved separately multiple times in such different lineages — among mammals and birds, terrestrial and marine species — suggests that vocal learning provides important benefits in certain ecological contexts. Most animal species, by contrast, are born already "knowing" the calls they will use throughout their lives.</p>

      <p><span class="para-num">C</span> The classic experiments on birdsong learning were conducted by the American researcher Peter Marler from the 1950s onward. Marler <span class="vocab" data-word="isolated" data-def="bị cô lập">isolated</span> young white-crowned sparrows from adult birds during the critical period when they would normally have heard their species' song. These isolated birds grew up to produce only crude, simplified versions of the normal song — they had the innate ability to vocalise but lacked the model needed to develop full species-typical songs. Birds exposed to recordings of the proper song during early development, however, learned to sing normally. This established that song development required specific auditory input during a critical sensitive period, much as human language learning depends on hearing speech in childhood.</p>

      <p><span class="para-num">D</span> Different species follow different patterns of song learning. Some species, like the white-crowned sparrow, have a single sensitive period in their first year and produce songs that remain essentially unchanged thereafter. Others, like the canary, continue to modify their songs throughout life, sometimes incorporating new elements year after year. The most extreme cases are birds like the mockingbird, which can continue learning new songs from many different sources for many years, and may have <span class="vocab" data-word="repertoires" data-def="vốn (bài hát), kho tiết mục">repertoires</span> of over 200 different song types. These differences appear to reflect differences in how the brain processes and stores auditory information.</p>

      <p><span class="para-num">E</span> Like human children learning to speak, young songbirds go through a babbling phase. Before they can produce the precise song characteristic of their species, they produce what researchers call subsong — sequences of random sounds that gradually become more structured over time. As learning progresses, the subsong develops into plastic song, which contains the basic elements of the adult song but in variable order. Eventually, with continued practice, the bird produces a stable <span class="vocab" data-word="crystallised" data-def="đã định hình, kết tinh">crystallised</span> song that closely matches the model it heard during its sensitive period. This developmental sequence shows remarkable parallels with how children move from babbling to fluent, grammatical speech.</p>

      <p><span class="para-num">F</span> The function of birdsong varies but generally involves either territorial defence, mate attraction, or both. Male birds typically use song to advertise their occupation of a particular area, warning rival males to stay away. The quality of a song also serves as a signal to potential mates about the singer's health, age, and experience — important factors in choosing a partner. Some species require remarkable vocal abilities to attract mates: the male sedge warbler, for example, may sing songs with as many as 75 different syllable types, and females prefer males with larger repertoires. These mating preferences create strong evolutionary pressure for ever more complex vocal learning.</p>

      <p><span class="para-num">G</span> Research on birdsong continues to advance our understanding of vocal learning more generally. The neural circuits and genetic mechanisms underlying birdsong show many similarities with those involved in human language. Studies of birds that develop song abnormally — perhaps because of brain <span class="vocab" data-word="lesions" data-def="tổn thương (não)">lesions</span> or genetic mutations — have shed light on the brain structures and processes essential for vocal learning. Some researchers hope that birdsong research may eventually contribute to understanding human speech disorders, including stuttering and aphasia. The seemingly simple songs filling our gardens each morning, it turns out, may have much to teach us about the most distinctively human of capacities.</p>`, vi: `<p><strong>Đoạn A:</strong> Tiếng chim hót bình minh quen thuộc, nhưng cách chim học hát là một quá trình học hỏi hấp dẫn, có sự song song với cách trẻ em học ngôn ngữ.</p>
      <p><strong>Đoạn B:</strong> Học phát âm thực sự chỉ có ở vài nhóm: người, chim hót, vẹt, chim ruồi, cá voi/heo, dơi, voi.</p>
      <p><strong>Đoạn C:</strong> Thí nghiệm của Peter Marler (1950s): chim sẻ bị cô lập chỉ hát phiên bản thô — thiếu hình mẫu. Cần đầu vào thính giác trong giai đoạn nhạy cảm.</p>
      <p><strong>Đoạn D:</strong> Mỗi loài học khác: chim sẻ một giai đoạn; chim hoàng yến sửa cả đời; mockingbird hơn 200 loại bài.</p>
      <p><strong>Đoạn E:</strong> subsong (âm ngẫu nhiên) → plastic song → crystallised song.</p>
      <p><strong>Đoạn F:</strong> Chức năng: bảo vệ lãnh thổ và/hoặc thu hút bạn tình. Con cái thích con đực có vốn bài lớn hơn.</p>
      <p><strong>Đoạn G:</strong> Mạch thần kinh tương đồng ngôn ngữ người; có thể giúp hiểu rối loạn nói.</p>` },
      { label: 'Reading Passage 2', title: 'The History of Maps', content: `<p><span class="para-num">A</span> Maps are almost as old as civilisation itself. Long before accurate measurement was possible, people scratched representations of their surroundings into clay, bark, or stone. The art of map-making, or <span class="vocab" data-word="cartography" data-def="ngành vẽ bản đồ, bản đồ học">cartography</span>, has always been about far more than navigation: a map expresses how a culture understands and orders the world around it. One of the oldest surviving maps, a Babylonian clay tablet from around 600 BCE, places Babylon at the centre of a flat, circular world surrounded by ocean — a layout that reveals as much about belief as about geography.</p>

      <p><span class="para-num">B</span> For much of history, maps freely mixed factual geography with religious and mythical belief. The great European world maps of the Middle Ages, known as mappae mundi, typically placed Jerusalem at the centre and the east at the top, and filled their margins with monsters, paradise, and biblical scenes. Such maps were never intended to help travellers find their way; they were meant to illustrate a spiritual vision of creation. Useful as objects of contemplation, they would have been almost worthless to anyone attempting an actual journey.</p>

      <p><span class="para-num">C</span> A more scientific approach to mapping had in fact existed in the ancient world. In the second century CE, the Greek scholar Ptolemy produced a great work of geography that introduced the idea of locating places using a grid of latitude and longitude. His methods were largely lost to Europe for a thousand years, preserved instead by Arab scholars, before being rediscovered during the Renaissance. The reappearance of Ptolemy's grid transformed European map-making, providing a mathematical framework on which accurate maps could at last be built.</p>

      <p><span class="para-num">D</span> The great age of sea exploration created urgent demand for maps that worked. Sailors needed charts on which a constant compass bearing appeared as a straight line, so that a course could be plotted with a ruler. In 1569 the Flemish mapmaker Gerardus Mercator devised a <span class="vocab" data-word="projection" data-def="phép chiếu (bản đồ)">projection</span> that achieved exactly this. The Mercator projection became indispensable for navigation, but it came at a cost: it badly <span class="vocab" data-word="distorts" data-def="làm méo, bóp méo">distorts</span> the relative size of land masses, making regions near the poles, such as Greenland, appear far larger than they truly are.</p>

      <p><span class="para-num">E</span> Even with good projections, one problem long defeated mapmakers: measuring longitude, a place's east-west position. Latitude could be found easily from the sun or stars, but longitude required knowing the exact time at a fixed reference point, which no clock could keep accurately at sea. The solution came in the eighteenth century, when the English clockmaker John Harrison built a marine chronometer that kept precise time despite the motion of a ship. With accurate time available, longitude could finally be calculated, and the accuracy of maps improved dramatically.</p>

      <p><span class="para-num">F</span> Maps have always been instruments of power as well as knowledge. Rulers used them to claim ownership of territory, and colonial powers drew borders across distant continents, often as <span class="vocab" data-word="arbitrary" data-def="tùy tiện, võ đoán">arbitrary</span> straight lines that ignored the peoples living there. National mapping projects, such as Britain's Ordnance Survey, were originally military undertakings. To map a place is, in a sense, to assert control over it, which is why governments have so often guarded their best maps as state secrets.</p>

      <p><span class="para-num">G</span> In the digital age, mapping has been transformed once again. Satellites and the global positioning system allow any smartphone to show its user's exact location, and online services let ordinary people create and share maps of their own. Yet a map remains, as it always was, a <span class="vocab" data-word="selective" data-def="có chọn lọc">selective</span> <span class="vocab" data-word="representation" data-def="sự thể hiện, biểu diễn">representation</span> rather than a neutral picture of reality. Every map involves choices about what to include and what to leave out, what to emphasise and what to ignore. The technology has changed beyond recognition, but the fundamental truth that no map is ever entirely innocent remains exactly the same.</p>`, vi: `<p><strong>Đoạn A:</strong> Bản đồ cổ gần như civilization. Cartography thể hiện cách văn hóa hiểu thế giới. Bản đồ Babylon (~600 TCN) đặt Babylon ở trung tâm.</p>
      <p><strong>Đoạn B:</strong> Bản đồ Trung cổ (mappae mundi) trộn địa lý với tín ngưỡng. KHÔNG nhằm định hướng đi lại.</p>
      <p><strong>Đoạn C:</strong> Ptolemy (thế kỷ 2 CN) đưa ra lưới kinh vĩ độ. Học giả Ả Rập gìn giữ, tái khám phá thời Phục Hưng.</p>
      <p><strong>Đoạn D:</strong> Mercator (1569) tạo phép chiếu vẽ hướng la bàn thành đường thẳng — nhưng bóp méo kích thước (Greenland).</p>
      <p><strong>Đoạn E:</strong> Vấn đề kinh độ cần thời gian chính xác. John Harrison (thế kỷ 18) chế marine chronometer → giải quyết.</p>
      <p><strong>Đoạn F:</strong> Bản đồ là công cụ quyền lực: tuyên bố lãnh thổ, biên giới thuộc địa tùy tiện. Ordnance Survey vốn là quân sự.</p>
      <p><strong>Đoạn G:</strong> Thời số: vệ tinh, GPS. Nhưng bản đồ luôn là sự thể hiện có chọn lọc, không trung lập.</p>` },
      { label: 'Reading Passage 3', title: 'Volcanoes: Windows into the Earth', content: `<p><span class="para-num">A</span> Volcanoes are among the most powerful and dramatic forces on Earth, capable of both immense destruction and remarkable creation. There are roughly 1,500 volcanoes considered active on land today, and a great many more hidden beneath the oceans. Throughout history, volcanoes have inspired both fear and fascination, destroying cities and reshaping landscapes, yet also building new land and enriching the soils on which civilisations have depended. Understanding how and why they erupt has become one of the central tasks of modern earth science.</p>

      <p><span class="para-num">B</span> Most volcanoes form as a result of plate <span class="vocab" data-word="tectonics" data-def="kiến tạo mảng">tectonics</span> — the slow movement of the great plates that make up the Earth's surface. Where plates pull apart or collide, molten rock from deep within the Earth can rise to the surface, which is why the majority of volcanoes are found along plate boundaries, particularly around the so-called Ring of Fire encircling the Pacific Ocean. A smaller number, however, occur far from any boundary, above isolated plumes of rising heat known as hotspots; the volcanoes of Hawaii are the most famous example of this kind.</p>

      <p><span class="para-num">C</span> Not all eruptions are alike. Some are gentle and <span class="vocab" data-word="effusive" data-def="phun trào hiền hòa">effusive</span>, producing rivers of runny, fast-flowing lava that rarely threaten human life, as is typical in Hawaii. Others are violently explosive, blasting rock and ash high into the atmosphere with devastating force. The crucial difference lies in the composition of the magma. Thin, runny magma allows gas to escape easily, producing gentle eruptions, whereas thick, <span class="vocab" data-word="viscous" data-def="nhớt, đặc quánh">viscous</span> magma traps gas under enormous pressure until it is released in a sudden explosion, as happened at Mount St Helens and Krakatoa.</p>

      <p><span class="para-num">D</span> Contrary to popular belief, flowing lava is rarely the deadliest volcanic hazard, since it usually moves slowly enough for people to escape. The greatest dangers come from pyroclastic flows — avalanches of superheated gas and rock that race downhill at the speed of a jet aircraft — as well as from falling ash, poisonous gases, and lahars, the destructive mudflows formed when ash mixes with water. In 1985, a relatively small eruption of Nevado del Ruiz in Colombia produced a lahar that buried a town and killed an estimated 23,000 people.</p>

      <p><span class="para-num">E</span> For all their dangers, volcanoes also bring substantial benefits. Volcanic ash breaks down into exceptionally fertile soil, which is why millions of people choose to farm on the slopes of active volcanoes despite the obvious risks. In countries such as Iceland, the heat of volcanic regions is harnessed as <span class="vocab" data-word="geothermal" data-def="địa nhiệt">geothermal</span> energy to generate electricity and heat homes. Volcanoes also create valuable mineral deposits and, occasionally, entirely new land: the island of Surtsey rose out of the sea off Iceland during an eruption in 1963.</p>

      <p><span class="para-num">F</span> Predicting eruptions remains one of the great challenges of volcanology. Scientists monitor volcanoes closely for warning signs, measuring slight swellings in the ground, known as <span class="vocab" data-word="deformation" data-def="sự biến dạng (mặt đất)">deformation</span>, changes in the gases released, and patterns of small earthquakes that often precede an eruption. These methods can frequently detect that a volcano is becoming restless, but forecasting the exact timing and size of an eruption is still extremely difficult. Even so, careful monitoring has saved many lives: the successful evacuation before the huge 1991 eruption of Mount Pinatubo in the Philippines is a celebrated example.</p>

      <p><span class="para-num">G</span> The largest eruptions can affect the entire planet. When Mount Tambora erupted in Indonesia in 1815, it threw so much ash and gas into the upper atmosphere that global temperatures fell, and 1816 became known in Europe and North America as "the year without a summer", bringing failed harvests and famine. Scientists also study so-called <span class="vocab" data-word="supervolcanoes" data-def="siêu núi lửa">supervolcanoes</span>, such as the one beneath Yellowstone in the United States, whose rare but colossal eruptions could have global consequences. Living alongside volcanoes, with all their dangers and gifts, appears to be a permanent feature of the human condition.</p>`, vi: `<p><strong>Đoạn A:</strong> Núi lửa vừa hủy diệt vừa kiến tạo. ~1.500 núi lửa hoạt động trên cạn. Hiểu cơ chế phun trào là nhiệm vụ trung tâm khoa học Trái Đất.</p>
      <p><strong>Đoạn B:</strong> Phần lớn do kiến tạo mảng, ở ranh giới mảng (Vành đai lửa). Một số ở hotspots xa ranh giới (Hawaii).</p>
      <p><strong>Đoạn C:</strong> Hiền hòa (effusive, lava lỏng) vs nổ dữ dội. Khác biệt do thành phần magma: magma nhớt giữ khí → nổ.</p>
      <p><strong>Đoạn D:</strong> Lava hiếm khi nguy hiểm nhất. Nguy hiểm: pyroclastic flows, tro, khí, lahars. Nevado del Ruiz 1985 giết ~23.000.</p>
      <p><strong>Đoạn E:</strong> Lợi ích: đất màu mỡ, địa nhiệt (Iceland), khoáng sản, đất mới (Surtsey 1963).</p>
      <p><strong>Đoạn F:</strong> Dự báo khó: theo dõi biến dạng, khí, động đất nhỏ. Sơ tán thành công Pinatubo 1991.</p>
      <p><strong>Đoạn G:</strong> Phun trào lớn ảnh hưởng toàn cầu: Tambora 1815 → năm không có mùa hè. Siêu núi lửa (Yellowstone).</p>` }
    ],
    questions: [
      [
              {
      ...
      [
        {
          ...
          instruction: 'Reading Passage 2 has seven paragraphs, A-G. Choose the correct heading for each paragraph from the list below.',
          headings: [
            { id: 'i', text: 'Maps as tools of power and ownership' },
            { id: 'ii', text: 'The introduction of a scientific grid' },
            { id: 'iii', text: 'An ancient and universal human activity' },
            { id: 'iv', text: 'Solving the problem of measuring east-west position' },
            { id: 'v', text: 'When maps blended fact and belief' },
            { id: 'vi', text: 'The demands of sea exploration' },
            { id: 'vii', text: 'Mapping in the digital era' },
            { id: 'viii', text: 'How maps are printed and copied' },
            { id: 'ix', text: 'The first maps of the night sky' }
          ],
          items: [
            { q: 'A', answer: 'iii', explain: 'Đoạn A: bản đồ là hoạt động cổ xưa, phổ quát.' },
            { q: 'B', answer: 'v', explain: 'Đoạn B: bản đồ trộn sự thật và tín ngưỡng.' },
            { q: 'C', answer: 'ii', explain: 'Đoạn C: Ptolemy đưa lưới kinh vĩ độ khoa học.' },
            { q: 'D', answer: 'vi', explain: 'Đoạn D: nhu cầu thám hiểm biển (Mercator).' },
            { q: 'E', answer: 'iv', explain: 'Đoạn E: giải quyết vấn đề kinh độ.' },
            { q: 'F', answer: 'i', explain: 'Đoạn F: bản đồ là công cụ quyền lực, sở hữu.' },
            { q: 'G', answer: 'vii', explain: 'Đoạn G: vẽ bản đồ thời số.' }
          ]
        },
        {
          group: 'Questions 21–23',
          ...
          instruction: 'Do the following statements agree with the information given in Reading Passage 2? Write TRUE, FALSE, or NOT GIVEN.',
          items: [
            { q: 'Medieval European world maps were mainly designed to help travellers navigate.', answer: 'FALSE', explain: 'Đoạn B: "Such maps were never intended to help travellers find their way".' },
            { q: 'The Mercator projection makes some regions appear larger than they really are.', answer: 'TRUE', explain: 'Đoạn D: "badly distorts the relative size... Greenland, appear far larger".' },
            { q: "Ptolemy's maps were more accurate than modern satellite maps.", answer: 'NOT GIVEN', explain: 'Không có so sánh độ chính xác Ptolemy với bản đồ vệ tinh.' }
          ]
        },
        {
          group: 'Questions 24–26',
          ...
          instruction: 'Complete the sentences below. Choose NO MORE THAN TWO WORDS AND/OR A NUMBER from the passage for each answer.',
          items: [
            { q: 'The Mercator projection, devised in __________, let sailors plot a course as a straight line.', answer: '1569', explain: 'Đoạn D: "In 1569 the Flemish mapmaker Gerardus Mercator devised a projection".' },
            { q: 'Calculating longitude required knowing the exact __________ at a fixed reference point.', answer: 'time', explain: 'Đoạn E: "longitude required knowing the exact time at a fixed reference point".' },
            { q: 'John Harrison solved the longitude problem by building a marine __________.', answer: 'chronometer', explain: 'Đoạn E: "John Harrison built a marine chronometer".' }
          ]
        }
      ],
      [
        {
          ...
          paragraphs: ['A','B','C','D','E','F','G'],
          items: [
            { q: 'A reference to volcanoes that occur far from plate boundaries.', answer: 'B', explain: 'Đoạn B: hotspots như Hawaii.' },
            { q: 'An explanation of why some eruptions are gentle and others violent.', answer: 'C', explain: 'Đoạn C: do thành phần magma.' },
            { q: 'An example of a successful evacuation that saved lives.', answer: 'F', explain: 'Đoạn F: sơ tán Pinatubo 1991.' },
            { q: 'A description of the most dangerous volcanic hazards.', answer: 'D', explain: 'Đoạn D: pyroclastic flows, tro, khí, lahars.' },
            { q: 'A reference to how a large eruption affected the global climate.', answer: 'G', explain: 'Đoạn G: Tambora 1815.' },
            { q: 'Information about the benefits that volcanoes provide to people.', answer: 'E', explain: 'Đoạn E: đất màu mỡ, địa nhiệt, khoáng sản.' }
          ]
        },
        {
          group: 'Questions 33–36',
          ...
          instruction: 'Choose the correct letter, A, B, C or D.',
          items: [
            { q: 'According to the passage, most volcanoes are located:', options: ['A. at the centres of continents', 'B. along the boundaries between tectonic plates', 'C. only beneath the oceans', 'D. near the poles'], answer: 'B', explain: 'Đoạn B: phần lớn ở ranh giới mảng.' },
            { q: 'Whether an eruption is explosive or gentle is mainly determined by:', options: ['A. the size of the volcano', 'B. the composition of the magma', 'C. the time of year', 'D. the depth of the ocean'], answer: 'B', explain: 'Đoạn C: do thành phần magma.' },
            { q: 'According to the passage, the deadliest volcanic hazards are:', options: ['A. slow-moving lava flows', 'B. pyroclastic flows, ash and mudflows', 'C. minor earthquakes', 'D. rising sea levels'], answer: 'B', explain: 'Đoạn D: pyroclastic flows/tro/lahars.' },
            { q: 'The passage suggests that predicting exactly when a volcano will erupt:', options: ['A. is now completely reliable', 'B. remains difficult despite monitoring', 'C. is impossible by any means', 'D. depends only on past eruptions'], answer: 'B', explain: 'Đoạn F: thời điểm/quy mô vẫn rất khó.' }
          ]
        },
        {
          group: 'Questions 37–40',
          ...
          instruction: 'Complete the sentences below. Choose NO MORE THAN TWO WORDS from the passage for each answer.',
          items: [
            { q: 'Volcanoes far from plate boundaries, such as those in Hawaii, sit above __________.', answer: 'hotspots', explain: 'Đoạn B: "known as hotspots".' },
            { q: 'Fast-moving avalanches of superheated gas and rock are called __________ flows.', answer: 'pyroclastic', explain: 'Đoạn D: "pyroclastic flows".' },
            { q: 'Destructive mudflows formed when ash mixes with water are known as __________.', answer: 'lahars', explain: 'Đoạn D: "lahars, the destructive mudflows".' },
            { q: 'The 1815 Tambora eruption caused what became known as the year without a __________.', answer: 'summer', explain: 'Đoạn G: "the year without a summer".' }
          ]
        }
      ]
    ]
    ...
    passages: [
      {
        ...
        content: `<p><span class="para-num">A</span> Money is so deeply embedded in modern life that we rarely pause to consider how strange it actually is. The pieces of paper, metal coins, and digital numbers that we treat as valuable have no <span class="vocab" data-word="intrinsic" data-def="nội tại, bản chất">intrinsic</span> worth — a banknote is essentially just printed paper, and the digital balance in your bank account has no physical existence at all. Yet through a remarkable collective agreement, these symbols can be exchanged for almost any goods or services available in the modern economy. Understanding how this strange system actually developed reveals a great deal about human cooperation and economic history.</p>

        <p><span class="para-num">B</span> Standard economic textbooks usually explain money's origin through a story about <span class="vocab" data-word="barter" data-def="trao đổi hàng hóa trực tiếp">barter</span>. According to this account, early human societies traded goods directly — exchanging a chicken for a basket of grain, say, or labour for shelter. As economies grew more complex, barter became impractical because of what economists call the "double coincidence of wants" — you need to find someone who has what you want and who simultaneously wants what you have. Money emerged, the story goes, as a universal medium of exchange that neatly solved this problem. Anthropological research, however, has seriously challenged this tidy narrative.</p>

        <p><span class="para-num">C</span> The anthropologist David Graeber argued influentially that the textbook story bears little resemblance to historical reality. After examining records from many <span class="vocab" data-word="premodern" data-def="tiền hiện đại">premodern</span> societies, Graeber concluded that pure barter economies are essentially mythical — they may have existed in small-scale interactions between strangers, but no society has been documented in which large-scale economic life was based on barter. Premodern communities typically used elaborate systems of credit, gift exchange, and social obligation rather than direct barter or money. People remembered who owed what to whom, and balances were settled over time through various social means.</p>

        <p><span class="para-num">D</span> Coins, the most familiar form of money throughout history, were a much later development. The first coins appeared in the kingdom of Lydia, in what is now Turkey, around 600 BCE. They were made of electrum, a natural <span class="vocab" data-word="alloy" data-def="hợp kim">alloy</span> of gold and silver, and were stamped with images by the king to certify their weight and purity. Coins offered significant advantages: they were portable, <span class="vocab" data-word="durable" data-def="bền, lâu dài">durable</span>, and easily counted. The invention spread rapidly through the ancient world, with Greek city-states, the Persian Empire, and eventually Rome adopting and refining the technology. By the time of the Roman Empire, sophisticated monetary systems had developed throughout the Mediterranean world.</p>

        <p><span class="para-num">E</span> Paper money emerged in China during the Tang Dynasty around 800 CE, several centuries before its appearance anywhere else. Initially developed by merchants who deposited heavy strings of copper coins with trusted <span class="vocab" data-word="intermediaries" data-def="trung gian">intermediaries</span>, paper certificates representing these deposits proved far more practical for large transactions. The Chinese government eventually took over the issuing of paper money, and at various periods sophisticated paper-currency systems operated successfully across the empire. When the Italian traveller Marco Polo visited China in the thirteenth century, he was astonished by the universal use of paper money, which seemed almost magical to a European accustomed only to coins.</p>

        <p><span class="para-num">F</span> The concept of paper money took much longer to take root in Europe. Sweden's Stockholms Banco issued the first European banknotes in 1661, but the experiment ended in failure when the bank could not back the notes with sufficient coin reserves. Throughout the eighteenth and nineteenth centuries, paper money remained controversial. The British economist David Ricardo argued strongly for what was called the gold standard, in which paper currency could be exchanged for fixed amounts of gold. This system dominated international trade until it was abandoned during the disruptions of the twentieth-century world wars.</p>

        <p><span class="para-num">G</span> Modern money has moved further from physical objects than ever before. Electronic transactions now account for the vast majority of monetary exchanges, with physical cash playing an increasingly minor role. Cryptocurrencies have introduced money systems that exist entirely as digital information, with no central authority backing their value. Some economists argue that the whole trajectory of monetary history demonstrates the increasingly social and conceptual nature of money — what makes something function as money is collective agreement about its value, not the substance from which it is made. Whether this trend will continue toward fully digital, government-independent monetary systems, or whether cash and central banking will prove more durable than current trends suggest, remains genuinely uncertain.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Few topics in medicine illustrate the complex relationship between drugs, marketing, and public health more clearly than the story of sleeping pills in the twentieth century. What began with promising new <span class="vocab" data-word="pharmaceutical" data-def="thuộc dược phẩm">pharmaceutical</span> compounds offered to relieve <span class="vocab" data-word="insomnia" data-def="chứng mất ngủ">insomnia</span> became, over the following decades, a cautionary tale about how good intentions, scientific limitations, and commercial pressures can combine to produce serious and lasting harm. Although the specific drugs involved changed substantially over the decades, the underlying patterns recurred several times in remarkably similar ways.</p>

        <p><span class="para-num">B</span> The first generation of widely used sleeping pills were the barbiturates, developed in the early twentieth century and marketed enthusiastically as effective treatments for both insomnia and anxiety. Initially they appeared to deliver everything they promised — patients fell asleep quickly and slept longer than they had without medication. By the 1950s, barbiturates had become extremely popular, with manufacturers producing them in enormous quantities. The drugs were prescribed freely for ordinary sleep difficulties and were available in many countries with relatively few restrictions of any kind.</p>

        <p><span class="para-num">C</span> Problems with barbiturates emerged only gradually. Patients developed tolerance — requiring higher and higher doses to achieve the same effects. Physical <span class="vocab" data-word="dependence" data-def="sự phụ thuộc, lệ thuộc">dependence</span> developed rapidly, with patients experiencing severe <span class="vocab" data-word="withdrawal" data-def="triệu chứng cai (thuốc)">withdrawal</span> symptoms if they tried to stop taking the medication. Most dangerously of all, the difference between an effective dose and a fatal one was relatively small, and <span class="vocab" data-word="overdose" data-def="quá liều">overdose</span> became a common cause of both accidental death and suicide. By the 1960s, barbiturate-related fatalities had reached alarming levels. Medical opinion turned strongly against the drugs, and they were largely phased out of routine sleep medicine.</p>

        <p><span class="para-num">D</span> The benzodiazepines, introduced in the 1960s, were enthusiastically welcomed as a much safer alternative. Drugs like diazepam and temazepam appeared to offer the relaxing and sleep-inducing effects of barbiturates without the dangerous overdose potential. For two decades, prescriptions for benzodiazepines grew dramatically across the developed world, and the drugs became among the most-prescribed medications in history. They were widely viewed as essentially harmless aids for managing the stresses of modern life, with relatively little attention paid to their long-term effects.</p>

        <p><span class="para-num">E</span> By the 1980s, concerns about benzodiazepines began to mount. Although the drugs were indeed far safer than barbiturates in terms of acute overdose, problems with dependence emerged as a major issue. Long-term users found it extremely difficult to stop taking the medication, experiencing withdrawal symptoms that could persist for months or even years. Investigations by journalists and patient advocacy groups revealed that the pharmaceutical companies had downplayed the dependence risks in their marketing materials. Lawsuits and regulatory action followed, and benzodiazepine prescriptions began to decline sharply.</p>

        <p><span class="para-num">F</span> A third generation of sleep medications, the so-called "Z-drugs" — zolpidem, zopiclone, and others — emerged in the 1990s and 2000s. These were marketed as offering all the benefits of benzodiazepines with none of the dependence problems. For some years, this seemed to be true, and Z-drug prescriptions grew rapidly. However, by the 2010s, evidence had accumulated showing that Z-drugs caused dependence in many users, just as benzodiazepines had before them. They also produced unusual side effects including sleepwalking, unusual eating during sleep, and even episodes of memory loss. The familiar cycle of enthusiasm followed by <span class="vocab" data-word="disillusionment" data-def="sự vỡ mộng">disillusionment</span> had repeated itself once again.</p>

        <p><span class="para-num">G</span> Modern sleep medicine has grown increasingly sceptical of purely pharmaceutical approaches to insomnia. Current guidelines from major medical organisations now recommend that drugs should be used only briefly and as a last resort. Instead, treatments based on changing sleep behaviour and addressing underlying causes — collectively known as cognitive behavioural therapy for insomnia, or CBT-I — have proven more effective for long-term outcomes than any medication ever tested. Many sleep specialists now describe the past century of pharmaceutical sleep medicine as largely a series of expensive, harmful, and unnecessary experiments. Whether this lesson will be heeded in the next chapter of sleep medicine, or whether new drugs will simply begin the cycle again, remains to be seen.</p>`,
      ...
      },
      {
        label: 'Reading Passage 3',
        title: 'The Future of Work',
        content: `<p><span class="para-num">A</span> Predictions about the future of work have generated intense debate over the past decade. Technological developments — particularly artificial intelligence and automation — promise to transform employment in ways that could be either liberating or deeply <span class="vocab" data-word="destabilising" data-def="gây bất ổn">destabilising</span>. Whether the coming decades will produce widespread prosperity through new forms of work, or massive disruption through job <span class="vocab" data-word="displacement" data-def="sự thay thế, dịch chuyển (việc làm)">displacement</span>, depends on questions that remain genuinely uncertain. Different observers, drawing on exactly the same evidence, frequently reach dramatically different conclusions about what the future actually holds.</p>

        <p><span class="para-num">B</span> The historical record offers some grounds for optimism. Each previous wave of technological transformation — from agricultural mechanisation through the Industrial Revolution to the introduction of computers — produced fears that machines would replace human workers en masse. In each case, those fears ultimately proved exaggerated. New technologies displaced certain jobs but also created new ones, often in considerably larger numbers. The agricultural sector now employs only a tiny fraction of the workforce in developed countries, yet unemployment has not consequently become a permanent crisis. Many economists argue that the same broad pattern will play out with the current wave of technological change.</p>

        <p><span class="para-num">C</span> Other observers warn that current technological developments may be fundamentally different from previous transitions. Earlier waves of automation primarily replaced physical labour, leaving humans dominant in tasks requiring cognitive abilities. Artificial intelligence, however, threatens to <span class="vocab" data-word="automate" data-def="tự động hóa">automate</span> cognitive work as well, potentially eliminating jobs in fields as diverse as legal research, medical diagnosis, software development, and creative writing. If machines can perform both physical and cognitive work, what exactly remains for humans to do? The answer may not be obvious in the way that "factory workers can move into office jobs" was obvious during the twentieth century.</p>

        <p><span class="para-num">D</span> The economist Daron Acemoglu has argued that the impact of technology on workers depends heavily on the specific choices societies make in deploying it. New technologies can be designed either to <span class="vocab" data-word="augment" data-def="tăng cường, bổ trợ">augment</span> human capabilities — making workers more productive — or to replace human workers entirely. Augmentation tends to increase both wages and employment; replacement tends to do the opposite. Whether new AI technologies are deployed in augmentative or replacement modes will depend on tax policy, education systems, labour laws, and many other choices that societies retain considerable power to shape for themselves.</p>

        <p><span class="para-num">E</span> One trend that seems clearly established is the increasing <span class="vocab" data-word="polarisation" data-def="sự phân cực">polarisation</span> of labour markets. High-skill, high-wage jobs requiring complex social skills, creative problem-solving, and adaptive thinking remain in strong demand. Low-wage service jobs requiring physical presence and contextual judgement — childcare, eldercare, food service — have also grown in number. The sharpest decline has been concentrated in middle-skill jobs that involve predictable, routine tasks. The hollowing out of the middle of the labour market has produced increasing inequality and political dissatisfaction across many developed countries.</p>

        <p><span class="para-num">F</span> The future of work depends not just on technology but on how working life itself is structured. The COVID-19 pandemic demonstrated that many jobs can be performed effectively from almost anywhere, fundamentally challenging the traditional assumption that workers must commute to centralised workplaces. This change has produced both winners and losers — workers gaining new flexibility, but urban economies suffering as established commuting patterns change. Discussions of universal basic income, shorter working weeks, and other reforms have moved from fringe topics to serious mainstream policy debates. The future of work is becoming as much a question about how we want to live as about what machines can do.</p>

        <p><span class="para-num">G</span> Perhaps the most important questions about the future of work are not predictive but normative. What role should paid employment play in human life? Should economic security be tied to employment, or should it instead become an <span class="vocab" data-word="unconditional" data-def="vô điều kiện">unconditional</span> aspect of citizenship? How should the productive gains from new technologies be distributed across society? Different answers to these questions point toward dramatically different futures. The technologies will develop in any case, but the social arrangements built around them will be shaped by political choices made over the coming decades. The real question is not just what the future of work will be, but what we want it to be.</p>`,
    ...
    passages: [
      {
        ...
        content: `<p><span class="para-num">A</span> Tropical rainforests cover only about six percent of Earth's land surface yet contain more than half of all the planet's plant and animal species. Walking through one of these forests can be an overwhelming experience: dense vegetation reaching up to fifty metres above the ground, the constant noise of insects and birds, the heavy <span class="vocab" data-word="humidity" data-def="độ ẩm">humidity</span> that makes even slight exertion exhausting. Despite their familiarity from nature documentaries and tourist photography, rainforests harbour many features that surprise first-time visitors. Indeed, many widely held beliefs about them turn out, on closer inspection, to be incorrect.</p>

        <p><span class="para-num">B</span> One common <span class="vocab" data-word="misconception" data-def="quan niệm sai lầm">misconception</span> is that rainforest soils are extraordinarily fertile because of all the dense vegetation they support. The opposite is true. Tropical rainforest soils are typically among the poorest on Earth in terms of nutrient content. The lush vegetation grows not because of rich soils but in spite of them. The constant warmth and heavy rainfall mean that organic material <span class="vocab" data-word="decomposes" data-def="phân hủy">decomposes</span> very rapidly, with nutrients quickly absorbed by living plants before they can accumulate in the soil. When trees are cleared for agriculture, the apparent fertility disappears within just a few years, leaving land that is nearly useless for farming and often abandoned.</p>

        <p><span class="para-num">C</span> Another surprising feature concerns biodiversity distribution. Rainforests are famous for their incredible diversity of life, but this diversity is not distributed evenly throughout the forest. The majority of species live in the <span class="vocab" data-word="canopy" data-def="tán rừng, vòm lá">canopy</span> — the layer of branches and leaves high above the ground — rather than at the lower levels. Insects, birds, mammals, reptiles, and plants all reach their greatest diversity in this aerial environment, bathed in sunlight. The forest floor, in contrast, often appears surprisingly open and dark, because so little sunlight penetrates the dense canopy above. Recent research using techniques like canopy walkways and remote-controlled aircraft has dramatically expanded our understanding of this hidden world.</p>

        <p><span class="para-num">D</span> The role of rainforests in the global climate has often been simplified or misrepresented in popular accounts. Rainforests are sometimes described as "the lungs of the planet", producing the oxygen we breathe. This characterisation is misleading. While rainforests do produce vast amounts of oxygen through photosynthesis, they consume nearly as much through the <span class="vocab" data-word="respiration" data-def="sự hô hấp">respiration</span> of the millions of organisms living within them. The Amazon, the world's largest rainforest, contributes only about six percent of global oxygen production — important but hardly enough to support all human breathing. What rainforests really do for the climate is far more significant: they store enormous quantities of carbon dioxide in their biomass, helping to regulate greenhouse gas levels.</p>

        <p><span class="para-num">E</span> Indigenous peoples have lived in tropical rainforests for thousands of years, in some cases for tens of thousands of years. Far from being passive inhabitants of <span class="vocab" data-word="pristine" data-def="nguyên sơ, hoang sơ">pristine</span> wilderness, these peoples have actively shaped the forests around them. Archaeological evidence increasingly suggests that much of what appears to be untouched rainforest actually reflects historical human management. The Amazon contains vast areas of unusually fertile soil that researchers now believe was created by indigenous peoples thousands of years ago through the systematic addition of charcoal, ash, and organic waste. Many seemingly natural concentrations of useful plants — fruit trees, palms, medicinal herbs — likely represent the legacy of pre-Columbian gardening systems.</p>

        <p><span class="para-num">F</span> The threats facing rainforests are well known but often misunderstood. The primary cause of rainforest destruction is not the direct demand for tropical hardwoods, as many people believe, but agricultural expansion. Most rainforest land is cleared for cattle ranching, soy farming, palm oil production, and similar commodities. The economics of this destruction are complex: once rainforest is cleared, the land typically supports profitable agriculture for only a few years before fertility declines. Yet the short-term profits drive continued clearing, because the long-term costs of land degradation are borne by future generations and the broader environment rather than by the people making the clearing decisions today.</p>

        <p><span class="para-num">G</span> Effective rainforest conservation requires moving beyond simplistic narratives. Approaches that focus solely on protecting "pristine" forests ignore the fact that nearly all remaining rainforests have already been influenced by human activity. Strategies that ignore the needs of local populations often fail in the long term, as economic pressures eventually drive forest clearing despite legal protections. Some of the most successful conservation initiatives now focus on supporting traditional indigenous land management, which has proven remarkably effective at preserving forests over long periods. The future of rainforests will likely depend on developing economic systems that make standing forests more valuable than cleared land — a challenge that has so far proved difficult to solve at the scale required.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> The invention of photography in the early nineteenth century transformed human relationships with images, memory, and visual evidence in ways that continue to unfold today. Before photography, visual <span class="vocab" data-word="representations" data-def="sự biểu diễn, tái hiện">representations</span> of the world depended entirely on artists with the skill and time to produce paintings, drawings, or prints. Most people went through their lives without ever seeing accurate visual representations of distant places, important events, or even their own appearance beyond a mirror's reflection. Photography democratised the visual record in ways that ultimately changed how humans understood the world and themselves.</p>

        <p><span class="para-num">B</span> The fundamental principle behind photography — that certain chemicals change colour when exposed to light — had been known to alchemists since the medieval period. The challenge that frustrated experimenters for centuries was how to capture and preserve images created in this way. The French inventor Joseph Nicéphore Niépce produced what is generally considered the earliest surviving photograph around 1826, an image of the view from his window that required an <span class="vocab" data-word="exposure" data-def="sự phơi sáng">exposure</span> time of several hours. Niépce's collaborator Louis Daguerre developed a more practical method, called the <span class="vocab" data-word="daguerreotype" data-def="ảnh daguerre (kỹ thuật ảnh sớm)">daguerreotype</span>, which was publicly announced in 1839 — the year usually given as the birth of photography.</p>

        <p><span class="para-num">C</span> Early photographic methods had significant limitations that shaped how photography was used in its first decades. Long exposure times — often many minutes — meant that subjects had to remain absolutely still while the image formed. Moving objects could not be captured at all and appeared as ghostly blurs, or simply disappeared from the image altogether. Each daguerreotype was a unique object, like a painting, that could not be copied or distributed widely. Photographic equipment was bulky and expensive, restricting the practice to wealthy hobbyists and professional studios for many years.</p>

        <p><span class="para-num">D</span> The development of negative-positive photography by the English inventor William Henry Fox Talbot in the 1840s solved one major limitation. Talbot's process produced a negative image on paper from which multiple positive copies could be made, allowing photographs to be distributed in ways that daguerreotypes never could. This approach, refined and improved through subsequent decades, became the foundation of all photography until the digital revolution of the late twentieth century. The ability to make multiple prints transformed photography from a curiosity into a genuine medium for mass communication.</p>

        <p><span class="para-num">E</span> Photography revolutionised many human practices over the second half of the nineteenth century. Police forces began using photographs of criminals in the 1860s, establishing the first systematic identification systems. Scientific researchers used photography to record <span class="vocab" data-word="specimens" data-def="mẫu vật">specimens</span>, document expeditions, and capture observations beyond ordinary human visual capacity through telescopes and microscopes. Newspapers eventually incorporated photographs into news coverage, though early printing technologies made this difficult and most newspapers continued to rely on <span class="vocab" data-word="engravings" data-def="tranh khắc">engravings</span> for many decades after photography itself had become common.</p>

        <p><span class="para-num">F</span> The development of smaller, simpler cameras in the late nineteenth century brought photography to ordinary people. George Eastman's Kodak company, founded in the 1880s, sold inexpensive cameras with the memorable slogan "You press the button, we do the rest." Customers took their pictures and then returned the entire camera to Kodak for processing and reloading. This approach made photography accessible to <span class="vocab" data-word="amateur" data-def="nghiệp dư">amateur</span> users for the first time, leading to enormous growth in personal photography that continues today. Family photographs, holiday snapshots, and casual portraits became common features of ordinary life across the world.</p>

        <p><span class="para-num">G</span> Digital photography, beginning seriously in the 1990s and becoming dominant by the 2010s, transformed the medium more dramatically than any previous innovation. Digital cameras, and especially smartphones, made photography virtually free at the moment of use, while the internet enabled instant global sharing of images. Modern humans take approximately one trillion photographs per year, with no clear sense of how this enormous visual archive will be preserved or used in the long run. Whether the explosive growth of casual photography has made individual images more or less significant remains a question to which different observers give very different answers.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> What makes a genius? The question has fascinated thinkers since antiquity, but modern psychology has approached it with new tools and considerable <span class="vocab" data-word="scepticism" data-def="sự hoài nghi">scepticism</span> about the traditional answers. Earlier explanations, emphasising mysterious inborn gifts that set geniuses apart from ordinary people, have largely given way to more complex accounts involving combinations of ability, opportunity, environment, and sustained effort. Yet defining and understanding extraordinary achievement remains one of the most challenging problems in the study of human capacity, and one on which firm conclusions are still hard to reach.</p>

        <p><span class="para-num">B</span> Traditional accounts of genius emphasised mysterious natural <span class="vocab" data-word="endowments" data-def="năng khiếu, tài năng trời cho">endowments</span>. From the Romantic period onward, geniuses were often portrayed as figures touched by divine inspiration or possessed of capacities beyond ordinary understanding. The composer Wolfgang Amadeus Mozart was sometimes described as receiving complete musical compositions from supernatural sources, requiring only to write them down as if taking dictation. Albert Einstein was similarly presented, on occasion, as an inexplicable phenomenon producing revolutionary insights through pure inspiration. Such portrayals, while emotionally compelling, often distort the actual development of the achievements they describe.</p>

        <p><span class="para-num">C</span> Contemporary research consistently reveals that extraordinary achievement requires extraordinary preparation. The psychologist Anders Ericsson's research, popularised through the concept of "deliberate practice", found that world-class performers in many fields had invested approximately ten thousand hours of focused practice before reaching their highest levels. This research, popularised further by Malcolm Gladwell's book "Outliers", has sometimes been oversimplified into the claim that anyone can achieve world-class performance through sufficient practice alone. Ericsson himself emphasised that the picture is more complex — high-quality practice is essential, but so are other factors including initial <span class="vocab" data-word="aptitude" data-def="năng khiếu, khả năng">aptitude</span>, opportunity, and effective coaching.</p>

        <p><span class="para-num">D</span> The development of Mozart provides an instructive case. Far from receiving compositions through supernatural inspiration, the young Mozart studied music intensively under his father, an accomplished musician and teacher, from the age of three. By the time he composed his first significant works around the age of twelve, he had received more focused musical training than virtually any of his contemporaries. His early compositions, while <span class="vocab" data-word="precocious" data-def="phát triển sớm, sớm bộc lộ tài năng">precocious</span> for any child, were relatively conventional and clearly <span class="vocab" data-word="derivative" data-def="vay mượn, thiếu độc đáo">derivative</span> of the works he had studied. The truly original compositions on which his reputation now rests came much later, after additional years of intensive development. The "miracle" of Mozart, properly understood, is no less impressive but also no more mysterious than the cumulative effects of exceptional dedication.</p>

        <p><span class="para-num">E</span> Similar patterns appear in other famous cases. Einstein's revolutionary work in physics emerged not from sudden inspiration but from years of obsessive engagement with physical problems that earlier scientists had set aside as too difficult. He read widely in physics and mathematics, corresponded with the leading scientists of his day, and developed his theories through sustained effort rather than spontaneous brilliance. The pattern of extended preparation followed by breakthrough is characteristic of virtually all major achievements that have been examined in detail by historians and psychologists alike.</p>

        <p><span class="para-num">F</span> Yet the model of deliberate practice does not fully explain extraordinary achievement. Two people with similar amounts of practice typically produce very different results. Genetic studies suggest that natural aptitude — sometimes called "raw talent" — plays a substantial role in determining which individuals can reach the very highest levels of performance. The specific abilities that contribute to excellence vary enormously across fields, from mathematical reasoning to musical pitch perception to athletic coordination. Practice can develop these abilities considerably, but their underlying potential appears to vary substantially between individuals.</p>

        <p><span class="para-num">G</span> Social and historical context also shapes what counts as genius. Cultures define which abilities matter and create, or fail to create, opportunities for exceptional development. Mozart's genius could exist only in a society that valued music, supported musicians, and provided performance opportunities for them. Einstein required not just personal ability but the cultural <span class="vocab" data-word="infrastructure" data-def="cơ sở hạ tầng">infrastructure</span> of early twentieth-century physics. Many potential geniuses throughout history undoubtedly lived in conditions that prevented their abilities from ever developing or being recognised. The relatively few individuals we celebrate as geniuses may represent only a fraction of those whose abilities could have qualified them, had circumstances been different. Genius emerges from the combination of individual capacity and social opportunity, with neither factor sufficient by itself.</p>`,
    ...
    passages: [
      {
        label: 'Reading Passage 1',
        title: 'The Origins of Agriculture',
        content: `<p><span class="para-num">A</span> For approximately 95 percent of human existence, our ancestors lived as hunter-gatherers, obtaining their food directly from wild plants and animals. The transition to agriculture — the deliberate <span class="vocab" data-word="cultivation" data-def="sự canh tác, trồng trọt">cultivation</span> of plants and management of animals — happened relatively recently in human history, beginning around 12,000 years ago, and not in just one place but independently in several different regions of the world. This transition was perhaps the most fundamental change in the human story, transforming nearly every aspect of how people lived, worked, ate, and organised themselves, and setting in motion developments that continue to shape our lives today.</p>

      <p><span class="para-num">B</span> The process of agricultural development was much slower than was once believed. Rather than a sudden discovery, the shift involved thousands of years of gradual experimentation with plants and animals. Early communities probably encouraged useful wild plants by removing competitors and ensuring that water reached them. Over many generations, the plants that responded best to such encouragement became the focus of more intensive management. True <span class="vocab" data-word="domestication" data-def="sự thuần hóa">domestication</span> — in which plants and animals develop genetic characteristics that make them dependent on human care — emerged only after long periods of selective pressure, often without anyone consciously intending the result.</p>

      <p><span class="para-num">C</span> The earliest known agricultural development occurred in the Fertile Crescent, a region stretching from modern Iran through Iraq, Syria, Lebanon, and Israel. Here, by around 10,000 BCE, communities had begun cultivating the wild ancestors of wheat and barley, and managing herds of sheep, goats, and later cattle. The region's natural advantages were considerable: it contained an unusually rich variety of plant species suitable for cultivation, and animals that could be successfully domesticated. The Mediterranean climate, with its wet winters and dry summers, also provided favourable conditions for the earliest agricultural experimentation.</p>

      <p><span class="para-num">D</span> Agriculture also developed independently in at least six other regions of the world. In northern China, communities along the Yellow River began cultivating millet around 8,000 BCE; somewhat later, in the south, rice cultivation emerged. In Mesoamerica, beginning around 7,000 BCE, indigenous peoples gradually domesticated maize from a wild grass called teosinte, in a process that took thousands of years. The Andes mountains saw the development of potato cultivation, while sub-Saharan Africa, New Guinea, and the eastern woodlands of North America also saw independent agricultural development. The independent emergence of agriculture in so many separate regions suggests that something fundamental about human society was driving this transformation, despite the very different specific paths it took in each place.</p>

      <p><span class="para-num">E</span> The reasons for the agricultural transition remain debated among scholars. Earlier explanations emphasised population pressure: as human populations grew, hunter-gatherer lifestyles became inadequate to feed everyone, forcing the development of more intensive food production. More recent research has complicated this picture considerably. Some early agricultural communities appear to have had relatively low populations, and skeletal evidence often shows that early farmers actually had worse nutrition and shorter lives than the hunter-gatherers they replaced. Climate change at the end of the last ice age may have created conditions favourable for agriculture in some regions, but this cannot fully explain the timing in all the areas where agriculture emerged.</p>

      <p><span class="para-num">F</span> The social consequences of agriculture were profound. Hunter-gatherer societies were typically small, mobile, and relatively <span class="vocab" data-word="egalitarian" data-def="bình đẳng">egalitarian</span>. Agricultural societies were larger, more <span class="vocab" data-word="sedentary" data-def="định cư, ít di chuyển">sedentary</span>, and developed elaborate hierarchies. The need to store and protect food crops led to the development of fortifications, military organisation, and ultimately the emergence of cities and states. Property ownership, which had been almost meaningless to mobile peoples, became central to agricultural societies. Many social inequalities that we now sometimes consider natural — including some forms of gender inequality — appear to have intensified or first developed during the agricultural transition.</p>

      <p><span class="para-num">G</span> Agriculture also transformed humans biologically. Diets became less varied as communities came to depend on a small number of <span class="vocab" data-word="staple" data-def="(lương thực) chủ lực">staple</span> crops, leading to changes in dental and skeletal development that are visible in archaeological remains. The close contact between humans and domesticated animals enabled the transfer of diseases like influenza, measles, and smallpox from animal to human populations. Some genetic <span class="vocab" data-word="adaptations" data-def="các thích nghi">adaptations</span> emerged in response, including the ability of adults to digest milk, which appeared independently in several populations after they began keeping cattle. The full consequences of the agricultural revolution are still unfolding ten thousand years later, with most aspects of modern human life — from cities to nutrition to social organisation — ultimately traceable to that ancient transformation.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Coffee is now consumed by an estimated three billion people worldwide every day, making it among the most popular <span class="vocab" data-word="beverages" data-def="đồ uống">beverages</span> ever developed. Yet six hundred years ago, coffee was unknown outside a small region of East Africa, and its rapid spread across the globe represents one of the most successful "product launches" in human history. The story of coffee's journey from an obscure Ethiopian shrub to a global <span class="vocab" data-word="commodity" data-def="hàng hóa">commodity</span> reveals as much about human society, trade, and conquest as it does about the plant itself.</p>

        <p><span class="para-num">B</span> Coffee originated in the Ethiopian highlands, where it grew wild for thousands of years before being cultivated. According to a popular legend, its <span class="vocab" data-word="stimulating" data-def="có tính kích thích">stimulating</span> effects were discovered by a goatherd named Kaldi, who noticed his goats becoming unusually energetic after eating the berries of a particular shrub. The historical record is less certain about exactly when humans began consuming coffee, but archaeological evidence suggests that deliberate cultivation began in Yemen sometime between the thirteenth and fifteenth centuries. The Arab world became the first major coffee-consuming culture, with coffee houses serving as important social centres across Islamic civilisation.</p>

        <p><span class="para-num">C</span> Coffee reached Europe in the seventeenth century, initially viewed with suspicion as an exotic and possibly dangerous foreign substance. Religious authorities even debated whether Christians could legitimately consume what was sometimes called "the Muslim drink". However, coffee's stimulating properties quickly attracted enthusiasts, and the first European coffee houses opened in Venice, Vienna, Paris, and London during the second half of the century. These establishments rapidly became important social institutions where merchants conducted business, intellectuals exchanged ideas, and political debates flourished. Some historians have argued that coffee houses played a crucial role in the development of modern commercial and intellectual culture.</p>

        <p><span class="para-num">D</span> European colonial expansion transformed coffee into a global commodity. The Dutch began cultivating coffee in their colonies in Java (modern Indonesia) during the seventeenth century, breaking the Arab world's <span class="vocab" data-word="monopoly" data-def="thế độc quyền">monopoly</span> on production. French, Spanish, and Portuguese colonisers established coffee plantations in their territories in the Caribbean, Central and South America, and parts of Africa. By the early eighteenth century, Brazil — which would eventually become the world's largest coffee producer — was beginning its long history of coffee cultivation. The labour for these plantations was often supplied by enslaved Africans, creating a dark history that the coffee industry continues to confront.</p>

        <p><span class="para-num">E</span> The economic structure of the coffee industry has historically created tensions between producers and consumers. Coffee is grown almost exclusively in tropical countries, often by small farmers whose incomes depend heavily on global market prices that they cannot influence. Consumption, meanwhile, is concentrated in wealthier nations whose populations pay prices many times higher than what farmers receive. <span class="vocab" data-word="volatile" data-def="biến động, dễ thay đổi">Volatile</span> price fluctuations can devastate producing communities while having minimal effect on consumer markets. The fair-trade movement, which emerged in the 1980s, attempts to address these <span class="vocab" data-word="inequities" data-def="sự bất công, bất bình đẳng">inequities</span> by guaranteeing minimum prices and improved working conditions for coffee farmers, though its impact remains limited compared with total trade volumes.</p>

        <p><span class="para-num">F</span> Climate change presents serious threats to the coffee industry. The two main coffee species — Arabica and Robusta — both require specific climate conditions to thrive. Arabica, which produces higher-quality beans, is particularly sensitive to changes in temperature. Studies suggest that the land suitable for Arabica cultivation may shrink by up to fifty percent by 2050 under projected climate scenarios. Coffee diseases that previously affected only specific regions are spreading as temperatures change, threatening crops in areas that have produced coffee for centuries. Researchers are working to develop more resistant coffee varieties, but the future of the industry remains uncertain.</p>

        <p><span class="para-num">G</span> Modern coffee consumption has been transformed by the "third wave" coffee movement, which began in the late twentieth century and emphasises high-quality beans, careful brewing methods, and detailed attention to origin. Specialty coffee shops now operate in cities around the world, offering coffees from particular farms or regions in much the way that wines are distinguished by their vineyards. This approach has dramatically improved quality at the higher end of the market and increased the prices paid to some producers. Yet the vast majority of coffee continues to be sold as a commodity product, with relatively little of the final price reaching the farmers who grow it. The future of the industry will depend on whether the values of the specialty market can be extended more broadly across global coffee production.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Consciousness — the <span class="vocab" data-word="subjective" data-def="chủ quan">subjective</span> experience of being aware, of feeling sensations, of having thoughts that feel like something from the inside — remains one of the most puzzling <span class="vocab" data-word="phenomena" data-def="các hiện tượng">phenomena</span> in all of nature. Despite remarkable advances in neuroscience, philosophers and scientists continue to debate the most basic questions: What is consciousness? Why do brain processes give rise to subjective experience at all? Could machines ever be conscious? The Australian philosopher David Chalmers has called these questions "the hard problem of consciousness", distinguishing them from the merely "easy problems" of explaining specific cognitive functions like memory or attention.</p>

        <p><span class="para-num">B</span> The hard problem stems from what appears to be an explanatory gap between physical processes and subjective experience. Scientists can describe in ever-increasing detail how neurons fire, how sensory information is processed, how memories are encoded, and many other brain functions. Yet no current scientific theory adequately explains why these physical processes should be accompanied by any inner experience at all. Why should brain activity produce the redness of red, the painfulness of pain, the felt quality of joy? A perfectly functional brain processing information without any accompanying experience seems at least logically possible, raising profound questions about why consciousness exists at all.</p>

        <p><span class="para-num">C</span> Different theoretical approaches attempt to address the consciousness puzzle. The Integrated Information Theory, proposed by the neuroscientist Giulio Tononi, suggests that consciousness corresponds to the integration of information within a physical system — the more integrated the information, the more conscious the system. This theory has the controversial implication that any sufficiently integrated system, including some non-biological ones, might possess some degree of consciousness. The Global Workspace Theory, associated with the cognitive scientist Bernard Baars, proposes instead that consciousness arises when information is "broadcast" across multiple brain regions, becoming available for a wide range of cognitive processes.</p>

        <p><span class="para-num">D</span> Other approaches deny the hard problem altogether. The American philosopher Daniel Dennett has argued that what philosophers call the hard problem is essentially an illusion — that detailed explanations of cognitive functions, taken together, will eventually explain everything that genuinely needs explaining about consciousness. On this view, the apparent mystery of subjective experience reflects our incomplete understanding rather than any genuinely <span class="vocab" data-word="irreducible" data-def="không thể quy giản">irreducible</span> feature of reality. Critics consider Dennett's position too <span class="vocab" data-word="dismissive" data-def="xem nhẹ, gạt bỏ">dismissive</span> of the reality of subjective experience, while his supporters see it as the only scientifically respectable approach to the problem.</p>

        <p><span class="para-num">E</span> The question of animal consciousness carries profound ethical implications. If consciousness arises from particular kinds of brain organisation, then organisms with similar brains likely have similar inner experiences. Mammals possess brain structures similar to those associated with human consciousness, suggesting that they probably experience pain, fear, and pleasure in something like the way humans do. Birds, although their brain organisation differs from that of mammals, show sophisticated cognitive abilities that also suggest consciousness. Even more controversial are questions about the inner lives of insects, fish, and other creatures whose neural systems differ substantially from human brains.</p>

        <p><span class="para-num">F</span> Artificial intelligence raises both practical and philosophical questions about consciousness. Could a sufficiently sophisticated computer ever be conscious? Different theories give very different answers. According to integrated information theory, some digital systems might possess a degree of consciousness if their information integration were sufficient. According to other approaches that emphasise the importance of biological <span class="vocab" data-word="substrates" data-def="nền tảng, chất nền">substrates</span>, machines might process information without any accompanying experience, no matter how sophisticated they become. As AI systems develop increasingly impressive capabilities, these once-abstract philosophical questions are acquiring a new practical urgency.</p>

        <p><span class="para-num">G</span> Whatever the ultimate resolution of these questions, the study of consciousness continues to deepen our understanding of mind and brain. Brain imaging studies have identified neural correlates of conscious states — patterns of brain activity reliably associated with particular conscious experiences. Studies of conditions affecting consciousness, from <span class="vocab" data-word="anaesthesia" data-def="sự gây mê">anaesthesia</span> to brain injury to certain meditative states, have revealed how various brain systems contribute to conscious experience. These findings have not solved the hard problem, but they have refined the question and ruled out many possibilities. The mystery of consciousness — why there is something it is like to be conscious, rather than nothing at all — may remain among the most fascinating unsolved puzzles humans have ever encountered.</p>`,
    ...
    passages: [
      {
        label: 'Reading Passage 1',
        title: 'The Power of Habit',
        content: `<p><span class="para-num">A</span> Habits play a surprisingly large role in human behaviour. Researchers estimate that around 40 percent of the actions people take each day are performed not as conscious decisions but as habits — <span class="vocab" data-word="automatic" data-def="tự động">automatic</span> responses to familiar situations. We typically brush our teeth without consciously deciding to do so, drive familiar routes without thinking about <span class="vocab" data-word="navigation" data-def="sự định hướng, dẫn đường">navigation</span>, and reach for the same snacks during particular activities. The mental efficiency that habits provide is enormous — they free up our limited capacity for conscious thought to focus on novel or important decisions, rather than spending it on the countless small actions of daily life. Yet this efficiency comes with costs that are only now being fully understood.</p>

      <p><span class="para-num">B</span> The neuroscience of habit formation has been extensively studied in recent decades. Habits appear to be stored in a region of the brain called the basal ganglia, separate from the areas involved in conscious decision-making. This separation explains why habits can persist even when we consciously want to change them. Damage to the basal ganglia, whether from disease or injury, can disrupt habits while leaving conscious thinking largely intact, while damage to the areas involved in conscious thinking can leave habits unchanged. In one striking line of evidence, patients with severe memory disorders may forget meeting researchers from one day to the next yet still learn complex motor habits through repeated practice, even though they have no memory of ever having practised.</p>

      <p><span class="para-num">C</span> The classic model of habit formation involves three components, often called the habit loop: a cue triggers the habit, the routine itself is performed, and a reward <span class="vocab" data-word="reinforces" data-def="củng cố, tăng cường">reinforces</span> the connection. Hearing your alarm clock in the morning (cue) might lead you to brush your teeth (routine), producing a feeling of cleanliness and freshness (reward). The reward strengthens the neural connection between cue and routine, making the behaviour more automatic over time. After enough repetitions, the routine begins to occur almost without conscious thought whenever the cue appears, and a habit has been established — for better or for worse.</p>

      <p><span class="para-num">D</span> Understanding the habit loop has important practical applications. Charles Duhigg, whose book on habits became an international bestseller, argues that nearly all habits can be modified by working with rather than against the habit loop. Rather than trying to eliminate cues, which is often impossible in daily life, people can substitute new routines that respond to existing cues and provide similar rewards. Someone who habitually snacks while watching television need not give up watching television altogether; substituting healthier snacks while keeping the same cue and reward structure can effectively change the behaviour without a constant battle of willpower.</p>

      <p><span class="para-num">E</span> Habits can be either powerful tools or significant obstacles, depending on their nature. Beneficial habits — regular exercise, healthy eating, productive work routines — accumulate enormous benefits over time when established successfully, often with little ongoing effort once they are set. Harmful habits — overeating, excessive social media use, substance abuse — can be extraordinarily difficult to break despite genuine intentions to change. The struggle that many people experience with diet, smoking <span class="vocab" data-word="cessation" data-def="sự chấm dứt, ngừng">cessation</span>, and similar challenges often reflects not weakness of will but the genuine neurological power of established habits. Knowledge of how habits form can help both in establishing beneficial habits and in breaking destructive ones.</p>

      <p><span class="para-num">F</span> Research has identified strategies that increase the likelihood of successful habit formation. Starting with small, easily achievable behaviours rather than ambitious changes appears to be more effective, since early success builds momentum and confidence. Making the cue <span class="vocab" data-word="conspicuous" data-def="dễ thấy, nổi bật">conspicuous</span> and the reward immediate strengthens the formation process. Choosing a specific implementation intention — "I will do exercise X at time Y in location Z" — significantly increases follow-through compared with general goals such as "I will exercise more". Habit formation typically requires consistent repetition for weeks or months, with one widely cited study suggesting an average of 66 days, though this varies enormously between individuals and between different types of habit.</p>

      <p><span class="para-num">G</span> Habits also have important implications beyond individual behaviour. Businesses and governments have become increasingly <span class="vocab" data-word="sophisticated" data-def="tinh vi, phức tạp">sophisticated</span> at understanding and influencing habits, sometimes with troubling implications. Casino designs, social media interfaces, and supermarket layouts all incorporate principles of habit formation, engineered to encourage repeated behaviour. The same techniques that can help individuals establish healthy habits can be used by corporations to make products addictive and by political campaigns to manipulate behaviour. Awareness of these techniques is becoming increasingly important for both personal autonomy and informed citizenship. The science of habits, like many powerful tools, can serve human flourishing or undermine it, depending on how it is applied.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Glass is so <span class="vocab" data-word="ubiquitous" data-def="có mặt khắp nơi, phổ biến">ubiquitous</span> in modern life that it can be easy to forget what an extraordinary material it is. Transparent yet solid, easy to shape when hot yet permanent when cooled, glass has properties that no other common material shares. From the windows that admit light into our buildings to the screens of our smartphones, from drinking vessels to optical instruments, glass enables aspects of modern life that would otherwise be impossible. Yet the history of glassmaking spans over four thousand years of technological development, with each generation building on discoveries that often came about by chance rather than by deliberate design.</p>

        <p><span class="para-num">B</span> The earliest known glass objects come from ancient Mesopotamia, dating from around 2,500 BCE. These early glass beads were probably produced as a by-product of metal <span class="vocab" data-word="smelting" data-def="sự nấu chảy (kim loại)">smelting</span>, when sand and ash accidentally fused into a glassy material in the intense heat of furnaces. The first deliberate glassmaking developed in the same region by about 1,500 BCE, with craftsmen learning to produce small decorative objects by pressing <span class="vocab" data-word="molten" data-def="nóng chảy">molten</span> glass into shaped moulds. Ancient Egyptian glass was particularly valued, with multicoloured glass vessels among the prized possessions of pharaohs and a clear sign of considerable wealth.</p>

        <p><span class="para-num">C</span> The most transformative early development in glassmaking was the discovery of glassblowing, which occurred along the eastern Mediterranean coast around 100 BCE. By gathering molten glass on the end of a hollow metal tube and blowing into it, craftsmen could produce vessels of varied shapes far more quickly than the earlier moulding methods allowed. The technique spread rapidly throughout the Roman Empire, where glass production reached impressive levels. Roman glass workshops produced both luxury items and ordinary household vessels for trade across the empire and beyond, with surviving examples found from Britain to India.</p>

        <p><span class="para-num">D</span> During the medieval period, the city of Venice emerged as Europe's <span class="vocab" data-word="preeminent" data-def="vượt trội, hàng đầu">preeminent</span> glassmaking centre. Venetian craftsmen worked on the island of Murano, where glass furnaces were concentrated after 1291 to reduce the risk of fire in the crowded city, and there they developed techniques that remained closely guarded secrets. Murano glass became famous throughout Europe for its quality, clarity, and elaborate decoration, commanding high prices in distant markets. Skilled glassworkers were so valuable that Venetian authorities forbade them from leaving Venice on penalty of death, although some did escape and spread Venetian techniques to other European centres.</p>

        <p><span class="para-num">E</span> The development of plate glass production in seventeenth-century France marked another major advance. The French government, hoping to break Venetian <span class="vocab" data-word="dominance" data-def="sự thống trị, ưu thế">dominance</span>, established the Saint-Gobain factory in 1665. The factory developed techniques for producing large flat sheets of glass suitable for windows and mirrors, something the older methods had struggled to achieve. The Hall of Mirrors at the Palace of Versailles, completed in 1684 with hundreds of large mirrors made by Saint-Gobain, demonstrated French technological achievement to the courts of Europe. This factory still exists today, having been in continuous operation for over 350 years.</p>

        <p><span class="para-num">F</span> The Industrial Revolution transformed glassmaking from a craft into a mass-production industry. The introduction of coal-fired furnaces allowed much higher temperatures than wood-fired ones, improving the quality and consistency of the glass. Mechanical processes for producing bottles, window glass, and other standardised products gradually replaced the slow techniques of individual craftsmen. The price of glass dropped dramatically, making it available to ordinary households for purposes — drinking glasses, window panes, kitchen jars — that had previously been luxuries reserved for the wealthy. This <span class="vocab" data-word="democratisation" data-def="sự phổ cập, dân chủ hóa">democratisation</span> of glass had broad effects on daily life and material culture.</p>

        <p><span class="para-num">G</span> Modern glass technologies have created applications that would have seemed magical to earlier glassmakers. Optical fibres carry the data that supports modern telecommunications across oceans and continents. Specially formulated glass screens display the images on smartphones, televisions, and computers. Bulletproof glass protects vehicles and buildings, while heat-resistant glass withstands conditions that would shatter ordinary material. Glass laboratory equipment enables scientific research that requires absolute purity. Despite the development of plastics and other modern materials, glass remains essential to many technologies. The four-thousand-year history of glassmaking continues to unfold in new directions, with applications that earlier generations could not have imagined.</p>`,
      ...
      },
      {
        ...
        content: `<p><span class="para-num">A</span> Communication is so central to human life that we rarely stop to consider how much of it happens without conscious awareness. While verbal communication — the words we use — receives most analytical attention, researchers studying human interaction have found that non-verbal elements often carry equal or greater weight in conveying meaning. Body <span class="vocab" data-word="posture" data-def="tư thế (cơ thể)">posture</span>, facial expressions, vocal tone, eye contact, and even the spaces we maintain between ourselves and others all contribute to what we communicate, often more powerfully than the words we speak. A message delivered in the wrong tone or with the wrong expression can come to mean the opposite of what its words appear to say.</p>

        <p><span class="para-num">B</span> The American psychologist Albert Mehrabian conducted influential research in the 1960s on what he called the "three Vs" of communication: verbal (the words used), vocal (the way they are spoken), and visual (body language). His research, often <span class="vocab" data-word="oversimplified" data-def="bị đơn giản hóa quá mức">oversimplified</span> in popular presentations, suggested that when verbal content conflicts with vocal tone and body language, listeners typically give more weight to the non-verbal elements. The widely repeated claim that "55 percent of communication is body language" derives from his work but badly distorts its actual findings, which applied only to specific situations involving the expression of feelings and attitudes, not to communication in general.</p>

        <p><span class="para-num">C</span> Facial expressions communicate emotions across cultural boundaries with remarkable consistency. The American psychologist Paul Ekman, in research extending from the 1960s, documented that certain basic emotional expressions — happiness, sadness, anger, fear, surprise, and disgust — are recognised across human cultures, including in isolated populations with no exposure to modern media. This finding strongly suggests that basic emotional expression has evolutionary roots <span class="vocab" data-word="predating" data-def="có trước, đi trước">predating</span> cultural development. Subtle variations in these expressions, however, do show cultural influence, with norms about when and how strongly to display emotions varying considerably between societies.</p>

        <p><span class="para-num">D</span> Eye contact patterns reveal cultural differences clearly. In many Western cultures, sustained eye contact during conversation indicates honesty, attention, and engagement; avoiding eye contact may be interpreted as <span class="vocab" data-word="evasive" data-def="lảng tránh, né tránh">evasive</span> or disrespectful. In contrast, many East Asian, African, and Latin American cultures view sustained direct eye contact as confrontational or rude, particularly in interactions across differences of age or status. These differences can produce serious misunderstandings in cross-cultural interactions, with both parties believing they are communicating respectfully while reading each other's behaviour negatively.</p>

        <p><span class="para-num">E</span> The concept of personal space — the physical distance people maintain during interactions — varies dramatically across cultures. The American anthropologist Edward Hall developed the influential field of "proxemics" in the 1960s, identifying four zones around individuals: intimate, personal, social, and public. These distances vary widely by culture, with Northern Europeans and North Americans typically requiring larger personal space than people from Mediterranean, Middle Eastern, or Latin American cultures. The difference can produce awkward interactions when people from different cultures meet, with one party feeling crowded and the other perceiving coldness or standoffishness.</p>

        <p><span class="para-num">F</span> Voice characteristics carry information beyond the explicit content of speech. Tone, pitch, speaking rate, and emphasis can convey emotion, sincerity, doubt, urgency, or <span class="vocab" data-word="sarcasm" data-def="sự mỉa mai, châm biếm">sarcasm</span> — sometimes directly contradicting the literal meaning of the words. The phrase "I'm fine" can communicate quite different things depending on how it is said. Listeners learn early in life to interpret these subtleties, often without being able to articulate the rules they are applying. Computer systems have made remarkable progress in producing natural-sounding speech, but reading and reproducing these vocal <span class="vocab" data-word="nuances" data-def="sắc thái tinh tế">nuances</span> reliably remains challenging for artificial intelligence.</p>

        <p><span class="para-num">G</span> Modern communication technologies have changed the balance of communicative channels in interesting ways. Email and text messaging strip away most non-verbal cues, leaving only the bare verbal content — sometimes producing misunderstandings about tone or emotional meaning that a face-to-face conversation would avoid. Video calls preserve facial expressions and some body language but reduce the impact of personal space and other physical cues. Emoji and other symbols have developed partly to restore some of the emotional and tonal information lost in text-based communication. Whether these new patterns will reshape how humans understand each other in the long term remains to be seen, but they certainly continue a long human history of developing new ways to convey what we mean to others.</p>`,
  ...
  'cam10-t4': {
    ...
    passages: [
      ...
      <p><span class="para-num">F</span> Recent research has revealed surprising features of dreaming. Although people often report no dreams from a night's sleep, virtually everyone dreams every night — the difference lies in whether the dreams are remembered. Lucid dreaming, in which the dreamer becomes aware of dreaming while still asleep, was once dismissed by scientists but has now been confirmed and studied in laboratory settings. Some people can deliberately <span class="vocab" data-word="induce" data-def="gây ra, tạo ra">induce</span> lucid dreams through practice, and experiments using brain imaging confirm that lucid dreamers can consciously communicate with researchers through eye movements and breathing patterns while remaining in REM sleep.</p>

      <p><span class="para-num">G</span> The cultural significance of dreams varies enormously across societies. Many traditional cultures consider dreams sources of <span class="vocab" data-word="supernatural" data-def="siêu nhiên">supernatural</span> communication or spiritual insight, and elaborate dream interpretation traditions exist in many religions. Modern Western culture has tended to dismiss dreams as either meaningless or as expressions of unconscious psychology to be interpreted by experts. Whether dreams contain meaningful information or are merely biological noise remains genuinely uncertain, but research increasingly suggests that the relationship between dreams and waking thought is more complex than either tradition has supposed. The science of dreaming will likely continue producing surprises for many years to come.</p>`, vi: `<p><strong>Đoạn A:</strong> Con người mơ mỗi đêm, vài lần/đêm. Não tạo ảo giác chi tiết. Từ Aristotle đến Freud đến thần kinh học hiện đại đều tìm hiểu giấc mơ.</p>
      <p><strong>Đoạn B:</strong> Sinh học giấc mơ hiểu từ 1950s (phát hiện REM). REM chiếm ~20% giấc ngủ; cơ lớn bị tê liệt để không diễn lại giấc mơ. 4-6 chu kỳ REM/đêm.</p>
      <p><strong>Đoạn C:</strong> Freud (đầu thế kỷ 20): giấc mơ là ham muốn vô thức được ngụy trang bằng biểu tượng. Bị giới nghiên cứu hiện đại từ bỏ vì không kiểm chứng được.</p>
      <p><strong>Đoạn D:</strong> Giả thuyết activation-synthesis: giấc mơ từ hoạt động ngẫu nhiên, KHÔNG có ý nghĩa vốn có — là sản phẩm phụ sinh học. Đề xuất từ 1970s.</p>
      <p><strong>Đoạn E:</strong> Các vai trò chức năng: threat simulation (luyện phản ứng nguy hiểm an toàn), memory consolidation (củng cố trí nhớ), emotional regulation.</p>
      <p><strong>Đoạn F:</strong> Ai cũng mơ mỗi đêm, chỉ khác ở việc có nhớ không. Mơ tỉnh (lucid) đã được xác nhận trong phòng thí nghiệm; có thể giao tiếp qua chuyển động mắt khi vẫn ở REM.</p>
      <p><strong>Đoạn G:</strong> Văn hóa khác nhau: truyền thống coi giấc mơ là siêu nhiên/tâm linh; phương Tây hiện đại thường bác bỏ. Ý nghĩa giấc mơ vẫn chưa chắc chắn, phức tạp hơn cả hai truyền thống nghĩ.</p>` },
      { label: 'Reading Passage 2', title: 'The Surprising History of Rubber', content: `<p><span class="para-num">A</span> Rubber is so common in modern life that it is easy to overlook. It is in the tyres of every vehicle, the soles of our shoes, the gloves worn by surgeons, and countless other everyday objects. This remarkable material comes from a surprisingly simple source: the milky white sap, known as latex, that flows beneath the bark of certain tropical trees. Long before Europeans encountered it, the peoples of Mesoamerica were using rubber more than three thousand years ago, shaping it into balls for ritual games and using it to waterproof cloth and containers.</p>

      <p><span class="para-num">B</span> In its natural state, however, rubber is far from ideal. Untreated natural rubber is unstable: it turns soft and sticky in hot weather and becomes hard and <span class="vocab" data-word="brittle" data-def="giòn, dễ gãy">brittle</span> in the cold. Early European experimenters were intrigued by the strange <span class="vocab" data-word="elastic" data-def="đàn hồi, co giãn">elastic</span> material but could find few practical uses for something that melted in summer and cracked in winter. For decades, rubber remained little more than a curiosity, and several businesses founded to exploit it collapsed when their products failed in extreme temperatures.</p>

      <p><span class="para-num">C</span> The breakthrough came in 1839, when the American inventor Charles Goodyear discovered, apparently by accident, that heating rubber together with sulfur produced a material that stayed strong and flexible across a wide range of temperatures. This process, later named vulcanization, transformed rubber from a useless curiosity into one of the most important industrial materials in the world. Goodyear, however, gained little from his discovery; tangled in patent disputes and poor business decisions, he died deeply in debt despite the enormous value his invention would later create.</p>

      <p><span class="para-num">D</span> Demand for rubber exploded in the late nineteenth century, first with the popularity of the bicycle and then, decisively, with the invention of the motor car and its rubber tyres. For a time, the wild rubber trees of the Amazon rainforest in Brazil held a near-total <span class="vocab" data-word="monopoly" data-def="thế độc quyền">monopoly</span> on supply, and cities such as Manaus grew fabulously wealthy on the trade. This boom had a brutal human cost, however, as indigenous people were often forced to harvest rubber under conditions of extreme cruelty and virtual slavery.</p>

      <p><span class="para-num">E</span> Brazil's monopoly did not last. In 1876 the Englishman Henry Wickham collected thousands of rubber seeds from the Amazon and shipped them to the Royal Botanic Gardens at Kew in London. Seedlings raised there were sent to British and Dutch colonies in Southeast Asia, where they were grown in orderly <span class="vocab" data-word="plantations" data-def="đồn điền">plantations</span>. Within a few decades, the plantations of Malaya and the Dutch East Indies were producing rubber far more cheaply and efficiently than the wild trees of the Amazon, and the Brazilian boom collapsed almost completely.</p>

      <p><span class="para-num">F</span> A second transformation came with the development of <span class="vocab" data-word="synthetic" data-def="tổng hợp, nhân tạo">synthetic</span> rubber. During the Second World War, Japanese forces cut the Allies off from the rubber plantations of Southeast Asia, creating a desperate shortage. In response, a massive scientific effort produced synthetic rubber made from petroleum, and today the majority of the world's rubber is synthetic. Natural rubber has not disappeared, however; its particular strength and resistance to heat mean that it remains essential for some demanding uses, including the tyres of aircraft.</p>

      <p><span class="para-num">G</span> The rubber industry still faces serious challenges. Almost all natural rubber comes from a single species of tree, grown mostly in Southeast Asia, which leaves the global supply dangerously vulnerable to disease. The expansion of rubber plantations has also contributed to <span class="vocab" data-word="deforestation" data-def="nạn phá rừng">deforestation</span> and the loss of wildlife habitat in tropical regions. Researchers are therefore investigating alternative sources of natural rubber, including the humble dandelion and a desert shrub called guayule, in the hope of making the supply both more secure and more environmentally sustainable.</p>`, vi: `<p><strong>Đoạn A:</strong> Cao su có ở khắp nơi (lốp, giày, găng tay). Từ nhựa mủ (latex) của cây nhiệt đới. Người Trung Mỹ đã dùng cao su hơn 3.000 năm trước.</p>
      <p><strong>Đoạn B:</strong> Cao su tự nhiên không ổn định: dính khi nóng, giòn khi lạnh — gần như vô dụng lúc đầu.</p>
      <p><strong>Đoạn C:</strong> Đột phá 1839: Charles Goodyear tình cờ phát hiện nung cao su với lưu huỳnh (vulcanization) → bền/dẻo. Nhưng ông chết trong nợ nần.</p>
      <p><strong>Đoạn D:</strong> Cuối thế kỷ 19 nhu cầu bùng nổ (xe đạp, ô tô). Amazon (Brazil) gần độc quyền; Manaus giàu lên. Cái giá tàn bạo với người bản địa.</p>
      <p><strong>Đoạn E:</strong> 1876 Henry Wickham mang hạt cao su từ Amazon về Kew (London) → đồn điền Đông Nam Á sản xuất rẻ hơn → bùng nổ Brazil sụp đổ.</p>
      <p><strong>Đoạn F:</strong> Thế chiến 2: Nhật cắt nguồn cao su châu Á → sản xuất cao su tổng hợp từ dầu mỏ. Nay phần lớn là tổng hợp; cao su tự nhiên vẫn cần cho lốp máy bay.</p>
      <p><strong>Đoạn G:</strong> Thách thức: chỉ một loài cây → dễ bị dịch bệnh; phá rừng; đang tìm nguồn thay thế (bồ công anh, guayule).</p>` },
      { label: 'Reading Passage 3', title: 'The Power of Music', content: `<p><span class="para-num">A</span> Music is found in every known human society. No culture has ever been discovered that lacks it entirely, and children respond to music long before they can speak. Yet despite its <span class="vocab" data-word="universal" data-def="phổ quát, có ở mọi nơi">universal</span> presence, the question of why music exists at all has long puzzled scientists. Charles Darwin believed it played a role in attracting mates, while the modern psychologist Steven Pinker famously dismissed music as "auditory cheesecake" — a pleasant but purposeless by-product of abilities that evolved for other reasons. The debate over whether music serves a genuine <span class="vocab" data-word="evolutionary" data-def="thuộc tiến hóa">evolutionary</span> function continues to this day.</p>

      <p><span class="para-num">B</span> Whatever its origins, music has a profound and reliable power to stir human emotion. Even a brief fragment of a melody can evoke joy, sadness, or excitement, often within seconds. Researchers believe this emotional power comes partly from the way music sets up patterns of expectation and then fulfils or surprises them, creating tension and release. Brain studies have shown that the most intensely pleasurable moments in music — the "chills" that can run down the spine — are accompanied by the release of dopamine, the same chemical involved in other powerful rewards such as food.</p>

      <p><span class="para-num">C</span> Music engages the brain in an unusually broad way. There is no single "music centre"; instead, listening to and performing music activates widely <span class="vocab" data-word="distributed" data-def="phân tán, trải rộng">distributed</span> networks involved in hearing, movement, emotion, and memory all at once. This wide distribution helps explain one of the most striking findings in the field: the ability to respond to familiar music often survives in people with advanced <span class="vocab" data-word="dementia" data-def="chứng sa sút trí tuệ">dementia</span>, long after most other memories have faded. A patient who can no longer recognise their own family may still sing every word of a song from their youth.</p>

      <p><span class="para-num">D</span> One leading theory holds that music evolved above all as a force for social bonding. Making music together — singing, drumming, or dancing in time — <span class="vocab" data-word="synchronises" data-def="đồng bộ hóa">synchronises</span> the actions and even the heartbeats of a group, releases bonding chemicals such as endorphins, and builds feelings of trust and belonging. From mothers singing lullabies to soldiers marching to anthems and workers singing together in the fields, music has long served to bind people into <span class="vocab" data-word="cohesive" data-def="gắn kết, cố kết">cohesive</span> groups. Some researchers believe this group-binding power is the very reason music evolved in the first place.</p>

      <p><span class="para-num">E</span> Closely related is the human urge to move in time with a beat, an ability known as entrainment. The impulse to tap a foot or nod along to a rhythm is so natural that we barely notice it, yet it is remarkably rare in the animal kingdom; only a few species, such as certain parrots, appear to share it. Scientists have found that the ability to keep time with music is linked to the capacity for vocal learning, which may explain why it appears in some birds but not in most other animals.</p>

      <p><span class="para-num">F</span> The powerful effects of music on the brain are increasingly being harnessed for medical treatment. In a technique called melodic intonation therapy, stroke patients who have lost the ability to speak can sometimes learn to communicate again by singing words rather than saying them, because singing draws on different brain regions from ordinary speech. Rhythm can help people with Parkinson's disease to walk more steadily, and music is widely used to reduce anxiety and the perception of pain. Such therapies turn music's emotional and neurological power to genuinely practical use.</p>

      <p><span class="para-num">G</span> For all its universality, the specific forms that music takes vary enormously from one culture to another. Scales, rhythms, instruments, and the very meaning of particular sounds differ widely, and music that sounds beautiful in one tradition may seem strange or unpleasant in another. Yet beneath this variety, certain features recur across cultures: lullabies from around the world, for instance, share recognisable qualities that infants everywhere respond to. Why exactly human beings make and love music remains, in the end, an open question — but few would deny the extraordinary hold it has over us.</p>`, vi: `<p><strong>Đoạn A:</strong> Âm nhạc có ở mọi xã hội. Vì sao âm nhạc tồn tại vẫn gây tranh cãi: Darwin (thu hút bạn tình) vs Pinker ("auditory cheesecake" - sản phẩm phụ vô mục đích).</p>
      <p><strong>Đoạn B:</strong> Âm nhạc khơi gợi cảm xúc mạnh (kỳ vọng - giải tỏa). Khoảnh khắc "chills" đi kèm giải phóng dopamine.</p>
      <p><strong>Đoạn C:</strong> Âm nhạc kích hoạt mạng lưới não trải rộng (nghe, vận động, cảm xúc, trí nhớ). Vì sao người sa sút trí tuệ vẫn nhớ bài hát thời trẻ.</p>
      <p><strong>Đoạn D:</strong> Lý thuyết gắn kết xã hội: chơi nhạc cùng nhau đồng bộ hóa, giải phóng endorphin, xây dựng niềm tin. Có thể là lý do âm nhạc tiến hóa.</p>
      <p><strong>Đoạn E:</strong> Bản năng nhún nhảy theo nhịp gọi là entrainment — hiếm ở động vật (chỉ vài loài như vẹt). Liên hệ với khả năng học phát âm.</p>
      <p><strong>Đoạn F:</strong> Ứng dụng y học: melodic intonation therapy giúp bệnh nhân đột quỵ nói lại bằng cách hát; nhịp điệu giúp người Parkinson đi vững; giảm lo âu và đau.</p>
      <p><strong>Đoạn G:</strong> Hình thức âm nhạc khác nhau theo văn hóa, nhưng vài đặc điểm lặp lại (bài hát ru giống nhau khắp nơi). Vì sao ta yêu âm nhạc vẫn là câu hỏi mở.</p>` }
    ],
    questions: [
      [
              {
      ...
      [
        {
          ...
          instruction: 'Reading Passage 2 has seven paragraphs, A-G. Choose the correct heading for each paragraph from the list below.',
          headings: [
            { id: 'i', text: 'The discovery that made rubber useful' },
            { id: 'ii', text: 'An everyday material with ancient origins' },
            { id: 'iii', text: 'The weakness of rubber in its natural state' },
            { id: 'iv', text: 'How one region lost its dominance' },
            { id: 'v', text: 'The rise of a man-made alternative' },
            { id: 'vi', text: 'A boom and its human cost' },
            { id: 'vii', text: 'Present-day challenges and new sources' },
            { id: 'viii', text: 'How rubber is recycled' },
            { id: 'ix', text: 'The chemistry of latex production' }
          ],
          items: [
            { q: 'A', answer: 'ii', explain: 'Đoạn A: vật liệu đời thường nhưng nguồn gốc cổ xưa (Mesoamerica 3.000 năm).' },
            { q: 'B', answer: 'iii', explain: 'Đoạn B: điểm yếu của cao su tự nhiên (dính/giòn).' },
            { q: 'C', answer: 'i', explain: 'Đoạn C: phát minh vulcanization làm cao su hữu dụng.' },
            { q: 'D', answer: 'vi', explain: 'Đoạn D: cơn bùng nổ và cái giá nhân đạo tàn bạo.' },
            { q: 'E', answer: 'iv', explain: 'Đoạn E: Brazil mất vị thế độc quyền.' },
            { q: 'F', answer: 'v', explain: 'Đoạn F: sự trỗi dậy của cao su tổng hợp.' },
            { q: 'G', answer: 'vii', explain: 'Đoạn G: thách thức hiện nay và nguồn thay thế.' }
          ]
        },
        {
          group: 'Questions 21–23',
          ...
          instruction: 'Do the following statements agree with the information given in Reading Passage 2? Write TRUE, FALSE, or NOT GIVEN.',
          items: [
            { q: 'Rubber was used in the Americas long before Europeans encountered it.', answer: 'TRUE', explain: 'Đoạn A: "Long before Europeans encountered it, the peoples of Mesoamerica were using rubber more than three thousand years ago".' },
            { q: 'Charles Goodyear became wealthy as a result of his discovery.', answer: 'FALSE', explain: 'Đoạn C: "he died deeply in debt despite the enormous value his invention would later create".' },
            { q: 'Synthetic rubber is cheaper to produce than natural rubber.', answer: 'NOT GIVEN', explain: 'Đoạn văn không so sánh chi phí sản xuất cao su tổng hợp với cao su tự nhiên.' }
          ]
        },
        {
          group: 'Questions 24–26',
          ...
          instruction: 'Complete the sentences below. Choose NO MORE THAN TWO WORDS AND/OR A NUMBER from the passage for each answer.',
          items: [
            { q: 'Natural rubber comes from a tree\'s milky sap, which is known as __________.', answer: 'latex', explain: 'Đoạn A: "the milky white sap, known as latex".' },
            { q: 'Heating rubber with sulfur to make it stable is a process called __________.', answer: 'vulcanization', explain: 'Đoạn C: "This process, later named vulcanization".' },
            { q: 'In 1876, Henry Wickham shipped rubber __________ from the Amazon to London.', answer: 'seeds', explain: 'Đoạn E: "Henry Wickham collected thousands of rubber seeds from the Amazon and shipped them to... Kew".' }
          ]
        }
      ],
      [
        {
          ...
          paragraphs: ['A','B','C','D','E','F','G'],
          items: [
            { q: 'A reference to a debate about whether music serves an evolutionary purpose.', answer: 'A', explain: 'Đoạn A: Darwin vs Pinker ("auditory cheesecake").' },
            { q: 'An explanation of why music can persist in people with memory loss.', answer: 'C', explain: 'Đoạn C: mạng lưới não trải rộng nên người sa sút trí tuệ vẫn nhớ bài hát.' },
            { q: 'A description of how making music together builds social bonds.', answer: 'D', explain: 'Đoạn D: chơi nhạc cùng nhau đồng bộ hóa, giải phóng endorphin.' },
            { q: 'Information about the use of music to treat medical conditions.', answer: 'F', explain: 'Đoạn F: melodic intonation therapy, Parkinson, giảm đau.' },
            { q: 'A reference to a brain chemical released during the most pleasurable moments of music.', answer: 'B', explain: 'Đoạn B: "chills" đi kèm giải phóng dopamine.' },
            { q: 'A description of the human urge to move in time with a beat.', answer: 'E', explain: 'Đoạn E: entrainment.' }
          ]
        },
        {
          group: 'Questions 33–36',
          ...
          instruction: 'Choose the correct letter, A, B, C or D.',
          items: [
            { q: 'According to the passage, music is found:', options: ['A. only in Western cultures', 'B. in every known human society', 'C. mainly in modern societies', 'D. only where there is spoken language'], answer: 'B', explain: 'Đoạn A: "Music is found in every known human society".' },
            { q: 'Music can survive in people with dementia because it:', options: ['A. is stored in a single brain region', 'B. engages many widely distributed brain networks', 'C. is always learned in early childhood', 'D. carries no emotional content'], answer: 'B', explain: 'Đoạn C: mạng lưới trải rộng.' },
            { q: 'The social bonding theory proposes that music:', options: ['A. is purely an individual pleasure', 'B. evolved to bind groups together', 'C. has no evolutionary function at all', 'D. developed only after language'], answer: 'B', explain: 'Đoạn D: âm nhạc tiến hóa như lực gắn kết xã hội.' },
            { q: 'Moving in time to a beat is:', options: ['A. common in most animals', 'B. unique to humans among all species', 'C. nearly universal in humans but rare in animals', 'D. impossible without musical training'], answer: 'C', explain: 'Đoạn E: phổ biến ở người nhưng hiếm ở động vật (chỉ vài loài như vẹt).' }
          ]
        },
        {
          group: 'Questions 37–40',
          ...
          instruction: 'Complete the sentences below. Choose NO MORE THAN TWO WORDS from the passage for each answer.',
          items: [
            { q: 'The most pleasurable moments in music can trigger the release of __________.', answer: 'dopamine', explain: 'Đoạn B: "the release of dopamine".' },
            { q: 'The human ability to move in time with a beat is called __________.', answer: 'entrainment', explain: 'Đoạn E: "an ability known as entrainment".' },
            { q: 'A therapy that helps stroke patients speak by singing is called melodic __________ therapy.', answer: 'intonation', explain: 'Đoạn F: "a technique called melodic intonation therapy".' },
            { q: 'Steven Pinker dismissed music as "auditory __________".', answer: 'cheesecake', explain: 'Đoạn A: "dismissed music as auditory cheesecake".' }
          ]
        }
      ]
    ]
